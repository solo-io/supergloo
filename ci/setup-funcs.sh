...
function setChartVariables() {
  ...
  export GLOOMESH_IMAGE_REGISTRY=$(cat ${GLOOMESH_VALUES} | grep "registry: " | awk '{print $2}')
  export GLOOMESH_IMAGE_REPOSITORY=$(cat ${GLOOMESH_VALUES} | grep "repository: " | awk '{print $2}')
