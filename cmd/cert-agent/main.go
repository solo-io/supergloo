...
func (opts *bootstrapOpts) addToFlags(flags *pflag.FlagSet) {
	...
	flags.StringVarP(&opts.MasterContext, "context", "c", metav1.NamespaceAll, "if specified read the KubeConfig for the management cluster from this context. Only applies when running out of cluster")
}
