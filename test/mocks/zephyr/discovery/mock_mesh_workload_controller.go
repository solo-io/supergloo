...
// Source: github.com/solo-io/service-mesh-hub/pkg/api/discovery.zephyr.solo.io/v1alpha1/controller (interfaces: MeshWorkloadController,MeshServiceController)
