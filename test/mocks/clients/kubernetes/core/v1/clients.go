...
// Source: github.com/solo-io/service-mesh-hub/pkg/api/kubernetes/core/v1 (interfaces: ServiceClient,PodClient,NamespaceClient,NodeClient,ServiceAccountClient,SecretClient,ConfigMapClient)
...
func (m *MockNamespaceClient) GetNamespace(arg0 context.Context, arg1 types.NamespacedName) (*v1.Namespace, error) {
	m.ctrl.T.Helper()
...
func (m *MockNodeClient) GetNode(arg0 context.Context, arg1 types.NamespacedName) (*v1.Node, error) {
	m.ctrl.T.Helper()
