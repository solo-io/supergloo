...
// Source: github.com/solo-io/external-apis/pkg/api/k8s/core/v1 (interfaces: ServiceClient,PodClient,NamespaceClient,NodeClient,ServiceAccountClient,SecretClient,ConfigMapClient)
