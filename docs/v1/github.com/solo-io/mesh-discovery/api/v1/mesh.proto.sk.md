...
##### Source File: [github.com/solo-io/mesh-discovery/api/v1/mesh.proto](https://github.com/solo-io/mesh-discovery/blob/master/api/v1/mesh.proto)
...
"istio": .meshdiscovery.solo.io.IstioMesh
"awsAppMesh": .meshdiscovery.solo.io.AwsAppMesh
"linkerd": .meshdiscovery.solo.io.LinkerdMesh
"mtlsConfig": .meshdiscovery.solo.io.MtlsConfig
"monitoringConfig": .meshdiscovery.solo.io.MonitoringConfig
"discoveryMetadata": .meshdiscovery.solo.io.DiscoveryMetadata
"smiEnabled": bool
...
| `istio` | [.meshdiscovery.solo.io.IstioMesh](../mesh.proto.sk/#istiomesh) |  Only one of `istio`, or `linkerd` can be set. |  |
| `awsAppMesh` | [.meshdiscovery.solo.io.AwsAppMesh](../mesh.proto.sk/#awsappmesh) |  Only one of `awsAppMesh`, or `linkerd` can be set. |  |
| `linkerd` | [.meshdiscovery.solo.io.LinkerdMesh](../mesh.proto.sk/#linkerdmesh) |  Only one of `linkerd`, or `awsAppMesh` can be set. |  |
| `mtlsConfig` | [.meshdiscovery.solo.io.MtlsConfig](../mesh.proto.sk/#mtlsconfig) | mtls config specifies configuration options for enabling mutual tls between pods in this mesh. |  |
| `monitoringConfig` | [.meshdiscovery.solo.io.MonitoringConfig](../mesh.proto.sk/#monitoringconfig) | configuration for propagating stats and metrics from mesh controllers and sidecars to a centralized datastore such as prometheus. |  |
| `discoveryMetadata` | [.meshdiscovery.solo.io.DiscoveryMetadata](../mesh.proto.sk/#discoverymetadata) | object which represents the data mesh discovery finds about a given mesh. |  |
...
| `mtlsConfig` | [.meshdiscovery.solo.io.MtlsConfig](../mesh.proto.sk/#mtlsconfig) | discovered mtls config of the given mesh. |  |
...
"region": string
"enableAutoInject": bool
"injectionSelector": .meshdiscovery.solo.io.PodSelector
...
| `injectionSelector` | [.meshdiscovery.solo.io.PodSelector](../selector.proto.sk/#podselector) | Pods matching this selector will be injected with the sidecar proxy at creation time. NOTE: the sidecar injector webhook currently supports only the NamespaceSelector and LabelSelector. |  |
