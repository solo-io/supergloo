...
| ----- | ---- | ----- | ----------- |
| istio | [settings.mesh.gloo.solo.io.DiscoverySettings.Istio]({{< ref "github.com.solo-io.gloo-mesh.api.settings.v1alpha2.settings.md#settings.mesh.gloo.solo.io.DiscoverySettings.Istio" >}}) |  | Istio-specific discovery settings |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| gatewayWorkloadLabels | [][settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetector.GatewayWorkloadLabelsEntry]({{< ref "github.com.solo-io.gloo-mesh.api.settings.v1alpha2.settings.md#settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetector.GatewayWorkloadLabelsEntry" >}}) | repeated | The workload labels used during discovery to detect ingress gateways for a mesh. If not specified, will default to `{"istio": "ingressgateway"}`. |
...
| ----- | ---- | ----- | ----------- |
| key | string |  |  |
  | value | [settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetector]({{< ref "github.com.solo-io.gloo-mesh.api.settings.v1alpha2.settings.md#settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetector" >}}) |  |  |
...
| mtls | [networking.mesh.gloo.solo.io.TrafficPolicySpec.MTLS]({{< ref "github.com.solo-io.gloo-mesh.api.networking.v1alpha2.traffic_policy.md#networking.mesh.gloo.solo.io.TrafficPolicySpec.MTLS" >}}) |  | Configure default mTLS settings for TrafficTargets (MTLS declared in TrafficPolicies take precedence) |
  ...
  | discovery | [settings.mesh.gloo.solo.io.DiscoverySettings]({{< ref "github.com.solo-io.gloo-mesh.api.settings.v1alpha2.settings.md#settings.mesh.gloo.solo.io.DiscoverySettings" >}}) |  | Settings specific to the discovery controller. |
