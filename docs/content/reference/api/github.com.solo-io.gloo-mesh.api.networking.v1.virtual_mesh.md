...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| ingressGatewayServiceSelectors | [][common.mesh.gloo.solo.io.IngressGatewayServiceSelector]({{< versioned_link_path fromRoot="/reference/api/github.com.solo-io.gloo-mesh.api.common.v1.selectors#common.mesh.gloo.solo.io.IngressGatewayServiceSelector" >}}) | repeated |  |
