...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| mesh | [MeshResource](#extensions.networking.smh.solo.io.MeshResource) |  | the object for which we are requesting patches |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| patchedResources | [][GeneratedResource](#extensions.networking.smh.solo.io.GeneratedResource) | repeated | a list of generated resources to be inserted into to the snapshot. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| trafficTarget | [TrafficTargetResource](#extensions.networking.smh.solo.io.TrafficTargetResource) |  | the object for which we are requesting patches |
| generatedResources | [][GeneratedResource](#extensions.networking.smh.solo.io.GeneratedResource) | repeated | the pre-patch resources generated by SMH for this object for a given discovery resource. provided to the server to perform modifications. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| workload | [WorkloadResource](#extensions.networking.smh.solo.io.WorkloadResource) |  | the object for which we are requesting patches |
| generatedResources | [][GeneratedResource](#extensions.networking.smh.solo.io.GeneratedResource) | repeated | the pre-patch resources generated by SMH for this object for a given discovery resource. provided to the server to perform modifications. |
