...
<a name="envoy.config.core.v3.CidrRange"></a>
...
| addressPrefix | string |  | IPv4 or IPv6 address, e.g. ``192.0.0.0`` or ``2001:db8::``. |
  | prefixLen | [google.protobuf.UInt32Value]({{< versioned_link_path fromRoot="/reference/api/github.com.solo-io.protoc-gen-ext.external.google.protobuf.wrappers#google.protobuf.UInt32Value" >}}) |  | Length of prefix, e.g. 0, 32. |
...
<a name="envoy.config.core.v3.EnvoyInternalAddress"></a>
...
<a name="envoy.config.core.v3.Pipe"></a>
...
<a name="envoy.config.core.v3.SocketAddress"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| protocol | [envoy.config.core.v3.SocketAddress.Protocol]({{< versioned_link_path fromRoot="/reference/api/envoy.config.core.v3.address#envoy.config.core.v3.SocketAddress.Protocol" >}}) |  |  |
