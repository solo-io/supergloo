...
## Table of Contents
  ...
  - [AccessPolicySpec.HttpMethods](#networking.smh.solo.io.AccessPolicySpec.HttpMethods)
...
| allowedMethods | [AccessPolicySpec.HttpMethods](#networking.smh.solo.io.AccessPolicySpec.HttpMethods) |  | Optional. A list of HTTP methods to allow (e.g., "GET", "POST"). It is ignored in gRPC case because the value is always "POST". If not specified, allows any method. Wrapping it in a nillable message. |
...
<a name="networking.smh.solo.io.AccessPolicySpec.HttpMethods"></a>

### AccessPolicySpec.HttpMethods



| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| allowedMethods | [][HttpMethodValue](#networking.smh.solo.io.HttpMethodValue) | repeated |  |
