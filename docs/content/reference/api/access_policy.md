...
| destinationSelector | [][TrafficTargetSelector](#networking.smh.solo.io.TrafficTargetSelector) | repeated | Requests destined for these pods will have the rule applied. Leave empty to apply to all destination pods in the mesh. |
