...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| workloadLabels | [][discovery.mesh.gloo.solo.io.MeshSpec.Istio.IngressGatewayInfo.WorkloadLabelsEntry]({{< versioned_link_path fromRoot="/reference/api/github.com.solo-io.gloo-mesh.api.discovery.v1.mesh#discovery.mesh.gloo.solo.io.MeshSpec.Istio.IngressGatewayInfo.WorkloadLabelsEntry" >}}) | repeated | DEPRECATED: in favor of `workload_label_sets` which can represent multiple backing workloads. Labels matching the workload backing the gateway. [Defaults to](https://github.com/istio/istio/blob/ab6cc48134a698d7ad218a83390fe27e8098919f/pkg/config/constants/constants.go#L73) `{"istio": "ingressgateway"}`. Can be empty if ingress gateway is exposed through an external load balancer. |
  | workloadLabelSets | [][common.mesh.gloo.solo.io.LabelSet]({{< versioned_link_path fromRoot="/reference/api/github.com.solo-io.gloo-mesh.api.common.v1.labels#common.mesh.gloo.solo.io.LabelSet" >}}) | repeated | A list of label sets matching the workloads backing the gateway. [Defaults to a single label set](https://github.com/istio/istio/blob/ab6cc48134a698d7ad218a83390fe27e8098919f/pkg/config/constants/constants.go#L73) `{"istio": "ingressgateway"}`. Can be empty if ingress gateway is exposed through an external load balancer. |
