...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| port | [istio.networking.v1alpha3.Port](.././istio.io.api.networking.v1alpha3.gateway#istio.networking.v1alpha3.Port) |  | The port associated with the listener. |
  ...
  | captureMode | [istio.networking.v1alpha3.CaptureMode](.././istio.io.api.networking.v1alpha3.sidecar#istio.networking.v1alpha3.CaptureMode) |  | The captureMode option dictates how traffic to the listener is expected to be captured (or not). |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| labels | [][istio.networking.v1alpha3.WorkloadSelector.LabelsEntry](.././istio.io.api.networking.v1alpha3.sidecar#istio.networking.v1alpha3.WorkloadSelector.LabelsEntry) | repeated | One or more labels that indicate a specific set of pods/VMs on which the configuration should be applied. The scope of label search is restricted to the configuration namespace in which the the resource is present. |
