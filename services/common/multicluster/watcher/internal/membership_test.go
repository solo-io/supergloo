...
var _ = Describe("multicluster-watcher", func() {
	...
	var (
		...
		ctx                           context.Context
		mockMeshPlatformCredsHandler  *mock_mc_manager.MockMeshPlatformCredentialsHandler
	...
	BeforeEach(func() {
		...
		mockMeshPlatformCredsHandler = mock_mc_manager.NewMockMeshPlatformCredentialsHandler(ctrl)
