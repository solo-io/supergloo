...
import (
	...
	k8s "github.com/solo-io/service-mesh-hub/services/common/multicluster/manager/k8s_manager"
...
// ClusterAdded mocks base method.
func (m *MockAsyncManagerHandler) ClusterAdded(ctx context.Context, mgr k8s.AsyncManager, clusterName string) error {
	m.ctrl.T.Helper()
...
func (m *MockAsyncManagerInformer) AddHandler(informer k8s.AsyncManagerHandler, name string) error {
	m.ctrl.T.Helper()
...
func (m *MockAsyncManager) Start(opts ...k8s.AsyncManagerStartOptionsFunc) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range opts {
...
func (m *MockAsyncManagerFactory) New(parentCtx context.Context, cfg *rest.Config, opts k8s.AsyncManagerOptions) (k8s.AsyncManager, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "New", parentCtx, cfg, opts)
	ret0, _ := ret[0].(k8s.AsyncManager)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
