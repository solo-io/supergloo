...
func LocalTrafficPolicyEventWatcherProvider(mgr manager.AsyncManager) zephyr_networking_controller.TrafficPolicyEventWatcher {
...
func LocalMeshServiceEventWatcherProvider(mgr manager.AsyncManager) zephyr_discovery_controller.MeshServiceEventWatcher {
	return zephyr_discovery_controller.NewMeshServiceEventWatcher("management-plane-mesh-service-event-watcher", mgr.Manager())
}

func LocalMeshWorkloadEventWatcherProvider(mgr manager.AsyncManager) zephyr_discovery_controller.MeshWorkloadEventWatcher {
