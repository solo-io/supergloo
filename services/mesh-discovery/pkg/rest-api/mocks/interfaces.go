...
// Package mock_rest_watcher is a generated GoMock package.
package mock_rest_watcher
...
func (m *MockRestAPICredsHandler) RestAPIAdded(secret *v1.Secret, apiName string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RestAPIAdded", secret, apiName)
	ret0, _ := ret[0].(error)
	return ret0
}

// RestAPIAdded indicates an expected call of RestAPIAdded.
func (mr *MockRestAPICredsHandlerMockRecorder) RestAPIAdded(secret, apiName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RestAPIAdded", reflect.TypeOf((*MockRestAPICredsHandler)(nil).RestAPIAdded), secret, apiName)
}

// RestAPIRemoved mocks base method.
func (m *MockRestAPICredsHandler) RestAPIRemoved(apiName string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RestAPIRemoved", apiName)
	ret0, _ := ret[0].(error)
	return ret0
}

// RestAPIRemoved indicates an expected call of RestAPIRemoved.
func (mr *MockRestAPICredsHandlerMockRecorder) RestAPIRemoved(apiName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RestAPIRemoved", reflect.TypeOf((*MockRestAPICredsHandler)(nil).RestAPIRemoved), apiName)
}
