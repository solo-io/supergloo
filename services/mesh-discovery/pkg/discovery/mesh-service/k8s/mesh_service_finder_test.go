...
var _ = Describe("Mesh Service Finder", func() {
	...
	var setupMocks = func() mocks {
		...
		serviceEventWatcher.
			...
			DoAndReturn(func(ctx context.Context, serviceEventHandler *k8s.ServiceEventHandler) error {
		...
		meshWorkloadEventWatcher.
			EXPECT().
			AddEventHandler(ctx, gomock.Any()).
			DoAndReturn(func(ctx context.Context, mwEventHandler *k8s.MeshWorkloadEventHandler) error {
