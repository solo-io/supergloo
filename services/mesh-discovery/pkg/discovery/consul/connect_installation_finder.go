...
//go:generate mockgen -destination ./mocks/mock_connect_deployment_finder.go github.com/solo-io/mesh-projects/services/mesh-discovery/pkg/discovery/consul ConsulConnectInstallationFinder
