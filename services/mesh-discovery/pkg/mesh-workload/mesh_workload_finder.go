...
func DefaultMeshWorkloadFinder(
	clusterName string,
	ctx context.Context,
	localMeshWorkloadClient zephyr_core.MeshWorkloadClient,
	localMeshClient zephyr_core.MeshClient,
	client client.Client,
	imageNameParser docker.ImageNameParser) *meshWorkloadFinder {
	return &meshWorkloadFinder{
		clusterName: clusterName,
		ctx:         ctx,
		meshWorkloadScanners: []MeshWorkloadScanner{
			DefaultIstioMeshWorkloadScanner(imageNameParser, client),
		},
...
func NewMeshWorkloadFinder(
	...
	localMeshWorkloadClient zephyr_core.MeshWorkloadClient,
	localMeshClient zephyr_core.MeshClient,
	meshWorkloadScanners []MeshWorkloadScanner) *meshWorkloadFinder {
	return &meshWorkloadFinder{
		clusterName:             clusterName,
		ctx:                     ctx,
