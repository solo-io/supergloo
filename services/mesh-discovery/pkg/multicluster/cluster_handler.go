...
) (k8s_manager.AsyncManagerHandler, error) {
...
func (m *discoveryClusterHandler) ClusterAdded(ctx context.Context, mgr k8s_manager.AsyncManager, clusterName string) error {
...
func (m *discoveryClusterHandler) initializeClusterDependentDeps(mgr k8s_manager.AsyncManager, clusterName string) (*clusterDependentDeps, error) {
