...
//go:generate mockgen -destination ./mocks/mock_connect_deployment_scanner.go github.com/solo-io/mesh-projects/services/mesh-discovery/pkg/mesh/consul ConsulConnectInstallationScanner
