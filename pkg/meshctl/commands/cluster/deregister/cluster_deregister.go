...
func (o *options) addToFlags(set *pflag.FlagSet) {
	...
	set.StringVar(&o.Registration.Namespace, "mgmt-namespace", defaults.DefaultPodNamespace, "namespace of the Gloo Mesh control plane in which the secret for the deregistered cluster will be created")
...
func communityCommand(ctx context.Context, opts *options) *cobra.Command {
	cmd := &cobra.Command{
