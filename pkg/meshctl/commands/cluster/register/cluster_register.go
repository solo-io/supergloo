...
func Command(ctx context.Context) *cobra.Command {
	...
	registrationOpts.addToFlags(cmd.Flags(), &kubeConfigOptions)
...
func (opts *registrationOptions) addToFlags(set *pflag.FlagSet, kubeConfigOptions *utils.MgmtRemoteKubeConfigOptions) {
