...
const GlooMeshEnterpriseHelmRepoIndex = "https://storage.googleapis.com/gloo-mesh-enterprise/gloo-mesh-enterprise/index.yaml"
const GlooMeshEnterpriseHelmRepoName = "gloo-mesh-enterprise"
...
func GetLatestEnterpriseVersion(stableOnly bool) (string, error) {
	return GetLatestHelmChartVersionWithMaxVersion(GlooMeshEnterpriseHelmRepoIndex, GlooMeshEnterpriseHelmRepoName, stableOnly, &versionutils.Version{
		Major: math.MaxInt32,
		Minor: math.MaxInt32,
		Patch: math.MaxInt32,
	})
