...
func (m *MockServiceAccountClient) Update(arg0 *v1.ServiceAccount) (*v1.ServiceAccount, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceAccountClientMockRecorder) Update(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockServiceAccountClient)(nil).Update), arg0)
}
