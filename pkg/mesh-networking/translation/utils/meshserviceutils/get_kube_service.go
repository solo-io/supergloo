...
func FindMeshServiceForKubeService(meshServices v1alpha1.MeshServiceSlice, kubeService ezkube.ResourceId) (*v1alpha1.MeshService, error) {
...
func IsMeshServiceForKubeService(meshService *v1alpha1.MeshService, kubeService ezkube.ResourceId) bool {
