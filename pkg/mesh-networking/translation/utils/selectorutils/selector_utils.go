...
func SelectorMatchesWorkload(selectors []*commonv1alpha2.WorkloadSelector, workload *discoveryv1alpha2.Workload) bool {
	if len(selectors) == 0 {
		return true
	}
...
func IdentityMatchesWorkload(selectors []*commonv1alpha2.IdentitySelector, workload *discoveryv1alpha2.Workload) bool {
	if len(selectors) == 0 {
		return true
	}
...
func SelectorMatchesService(selectors []*commonv1alpha2.DestinationSelector, service *discoveryv1alpha2.Destination) bool {
	if len(selectors) == 0 {
		return true
	}
...
func WorkloadSelectorContainsCluster(selectors []*commonv1alpha2.WorkloadSelector, clusterName string) bool {
	if len(selectors) == 0 {
		return true
	}
