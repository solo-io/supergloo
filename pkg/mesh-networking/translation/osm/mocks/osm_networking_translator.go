...
// Source: ./osm_networking_translator.go

// Package mock_osm is a generated GoMock package.
package mock_osm
...
func (m *MockTranslator) Translate(ctx context.Context, in input.LocalSnapshot, outputs smi.Builder, reporter reporting.Reporter) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Translate", ctx, in, outputs, reporter)
}

// Translate indicates an expected call of Translate
func (mr *MockTranslatorMockRecorder) Translate(ctx, in, outputs, reporter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Translate", reflect.TypeOf((*MockTranslator)(nil).Translate), ctx, in, outputs, reporter)
}
