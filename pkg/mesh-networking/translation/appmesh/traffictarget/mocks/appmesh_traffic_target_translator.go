...
func (m *MockTranslator) Translate(ctx context.Context, in input.Snapshot, trafficTarget *v1alpha2.TrafficTarget, outputs appmesh.Builder, reporter reporting.Reporter) {
	m.ctrl.T.Helper()
