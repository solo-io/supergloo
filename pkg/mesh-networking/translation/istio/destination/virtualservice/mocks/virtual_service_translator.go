...
func (m *MockTranslator) Translate(ctx context.Context, in input.LocalSnapshot, destination *v1.Destination, sourceMeshInstallation *v1.MeshSpec_MeshInstallation, reporter reporting.Reporter) *v1alpha3.VirtualService {
	m.ctrl.T.Helper()
