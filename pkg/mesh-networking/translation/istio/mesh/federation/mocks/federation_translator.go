...
func (m *MockTranslator) Translate(in input.LocalSnapshot, mesh *v1.Mesh, virtualMesh *v1.MeshStatus_AppliedVirtualMesh, outputs istio.Builder, reporter reporting.Reporter) {
	m.ctrl.T.Helper()
