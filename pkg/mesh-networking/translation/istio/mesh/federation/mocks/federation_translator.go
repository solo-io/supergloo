...
func (m *MockTranslator) Translate(in input.LocalSnapshot, mesh *v1alpha2.Mesh, virtualMesh *v1alpha2.MeshStatus_AppliedVirtualMesh, outputs istio.Builder, reporter reporting.Reporter) {
	m.ctrl.T.Helper()
