...
func (m *MockTranslator) Translate(mesh *v1.Mesh, virtualMesh *v1.MeshStatus_AppliedVirtualMesh, istioOutputs istio.Builder, localOutputs local.Builder, reporter reporting.Reporter) {
	m.ctrl.T.Helper()
