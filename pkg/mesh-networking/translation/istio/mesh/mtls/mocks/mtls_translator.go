...
func (m *MockTranslator) Translate(mesh *v1alpha2.Mesh, virtualMesh *v1alpha2.MeshStatus_AppliedVirtualMesh, outputs output.Builder, reporter reporting.Reporter) {
	m.ctrl.T.Helper()
