...
import (
	...
	v1alpha30 "github.com/servicemeshinterface/smi-sdk-go/pkg/apis/split/v1alpha3"
...
func (m *MockTranslator) Translate(ctx context.Context, in input.Snapshot, meshService *v1alpha2.MeshService, reporter reporting.Reporter) (*v1alpha30.TrafficSplit, *v1alpha3.HTTPRouteGroup) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Translate", ctx, in, meshService, reporter)
	ret0, _ := ret[0].(*v1alpha30.TrafficSplit)
