...
// Source: ./traffic_target_translator.go
...
func (m *MockTranslator) Translate(ctx context.Context, in input.Snapshot, meshService *v1alpha20.MeshService, reporter reporting.Reporter) *v1alpha2.TrafficTarget {
	m.ctrl.T.Helper()
