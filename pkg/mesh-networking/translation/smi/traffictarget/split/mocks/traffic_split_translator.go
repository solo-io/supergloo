...
func (m *MockTranslator) Translate(ctx context.Context, in input.LocalSnapshot, trafficTarget *v1alpha20.TrafficTarget, reporter reporting.Reporter) *v1alpha2.TrafficSplit {
	m.ctrl.T.Helper()
