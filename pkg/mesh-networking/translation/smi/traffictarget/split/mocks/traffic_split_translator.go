...
func (m *MockTranslator) Translate(ctx context.Context, in networking.Snapshot, trafficTarget *v1alpha20.TrafficTarget, reporter reporting.Reporter) *v1alpha2.TrafficSplit {
	m.ctrl.T.Helper()
