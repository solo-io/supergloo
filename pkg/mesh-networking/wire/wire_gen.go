...
func InitializeMeshNetworking(ctx context.Context) (MeshNetworkingContext, error) {
	...
	meshNetworkingContext := MeshNetworkingContextProvider(multiClusterDependencies, asyncManagerHandler, trafficPolicyTranslatorLoop, reconciler, meshNetworkingSnapshotContext, acpTranslatorLoop, accessPolicyEnforcerLoop, federationResolver, failoverServiceReconciler)
