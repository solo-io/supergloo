...
import (
	...
	"github.com/solo-io/smh/pkg/mesh-networking/translator/istio/destinationrule/plugin"
...
func (t *translator) initializeDestinationRule(meshService *discoveryv1alpha1.MeshService) *istiov1alpha3.DestinationRule {
	...
	hostname := t.clusterDomains.GetServiceFQDN(meshService.Spec.KubeService.Ref)
