...
func (f *MulticlusterRoleReconcilerFuncs) ReconcileRole(clusterName string, obj *rbac_enterprise_mesh_gloo_solo_io_v1.Role) (reconcile.Result, error) {
...
func NewMulticlusterRoleReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterRoleReconcileLoop {
	return &multiclusterRoleReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &rbac_enterprise_mesh_gloo_solo_io_v1.Role{}, options)}
}
...
func (f *MulticlusterRoleBindingReconcilerFuncs) ReconcileRoleBinding(clusterName string, obj *rbac_enterprise_mesh_gloo_solo_io_v1.RoleBinding) (reconcile.Result, error) {
...
func NewMulticlusterRoleBindingReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterRoleBindingReconcileLoop {
	return &multiclusterRoleBindingReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &rbac_enterprise_mesh_gloo_solo_io_v1.RoleBinding{}, options)}
}
