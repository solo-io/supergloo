...
type RoleSet interface {
	...
	List(filterResource ...func(*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role) bool) []*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role
	// Return the Set as a map of key to resource.
	Map() map[string]*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role
	// Insert a resource into the set.
	Insert(role ...*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role)
...
func NewRoleSet(roleList ...*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role) RoleSet {
	return &roleSet{set: makeGenericRoleSet(roleList)}
}

func NewRoleSetFromList(roleList *rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleList) RoleSet {
	list := make([]*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role, 0, len(roleList.Items))
...
func (s *roleSet) List(filterResource ...func(*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role) bool) []*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role {
	...
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role))
		})
	}
...
func (s *roleSet) Map() map[string]*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role {
	if s == nil {
		return nil
	}
...
func (s *roleSet) Insert(
	roleList ...*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role,
) {
	if s == nil {
...
func (s *roleSet) Find(id ezkube.ResourceId) (*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role, error) {
	if s == nil {
	...
	return obj.(*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role), nil
}
...
type RoleBindingSet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding) bool) []*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding
	// Return the Set as a map of key to resource.
	Map() map[string]*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding
	// Insert a resource into the set.
	Insert(roleBinding ...*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding)
	// Compare the equality of the keys in two sets (not the resources themselves)
...
func NewRoleBindingSet(roleBindingList ...*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding) RoleBindingSet {
	return &roleBindingSet{set: makeGenericRoleBindingSet(roleBindingList)}
}

func NewRoleBindingSetFromList(roleBindingList *rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBindingList) RoleBindingSet {
	list := make([]*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding, 0, len(roleBindingList.Items))
...
func (s *roleBindingSet) List(filterResource ...func(*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding) bool) []*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding {
	...
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding))
		})
	}
...
func (s *roleBindingSet) Map() map[string]*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding {
	if s == nil {
		return nil
	}
...
func (s *roleBindingSet) Insert(
	roleBindingList ...*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *roleBindingSet) Find(id ezkube.ResourceId) (*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding, error) {
	if s == nil {
	...
	return obj.(*rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding), nil
}
