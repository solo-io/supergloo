...
type RoleReconciler interface {
    ReconcileRole(obj *rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role) (reconcile.Result, error)
}
...
type RoleReconcilerFuncs struct {
    OnReconcileRole func(obj *rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role) (reconcile.Result, error)
    OnReconcileRoleDeletion func(req reconcile.Request) error
}

func (f *RoleReconcilerFuncs) ReconcileRole(obj *rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role) (reconcile.Result, error) {
...
type RoleFinalizer interface {
    ...
    FinalizeRole(obj *rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role) error
}
...
func NewRoleReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) RoleReconcileLoop {
    return &roleReconcileLoop{
        ...
        loop: reconcile.NewLoop(name, "", mgr, &rbac_enterprise_mesh_gloo_solo_io_v1alpha1.Role{}, options),
    }
}
...
type RoleBindingReconciler interface {
    ReconcileRoleBinding(obj *rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding) (reconcile.Result, error)
}
...
type RoleBindingReconcilerFuncs struct {
    OnReconcileRoleBinding func(obj *rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding) (reconcile.Result, error)
    OnReconcileRoleBindingDeletion func(req reconcile.Request) error
}

func (f *RoleBindingReconcilerFuncs) ReconcileRoleBinding(obj *rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding) (reconcile.Result, error) {
...
type RoleBindingFinalizer interface {
    ...
    // finalize the object before it is deleted.
    // Watchers created with a finalizing handler will a
    FinalizeRoleBinding(obj *rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding) error
}
...
func NewRoleBindingReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) RoleBindingReconcileLoop {
    return &roleBindingReconcileLoop{
    	// empty cluster indicates this reconciler is built for the local cluster
        loop: reconcile.NewLoop(name, "", mgr, &rbac_enterprise_mesh_gloo_solo_io_v1alpha1.RoleBinding{}, options),
    }
}
