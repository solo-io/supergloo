...
func (m *MockRoleEventHandler) CreateRole(obj *v1alpha1.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockRoleEventHandler) UpdateRole(old, new *v1alpha1.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockRoleEventHandler) DeleteRole(obj *v1alpha1.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockRoleEventHandler) GenericRole(obj *v1alpha1.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockRoleBindingEventHandler) CreateRoleBinding(obj *v1alpha1.RoleBinding) error {
	m.ctrl.T.Helper()
...
func (m *MockRoleBindingEventHandler) UpdateRoleBinding(old, new *v1alpha1.RoleBinding) error {
	m.ctrl.T.Helper()
...
func (m *MockRoleBindingEventHandler) DeleteRoleBinding(obj *v1alpha1.RoleBinding) error {
	m.ctrl.T.Helper()
...
func (m *MockRoleBindingEventHandler) GenericRoleBinding(obj *v1alpha1.RoleBinding) error {
	m.ctrl.T.Helper()
