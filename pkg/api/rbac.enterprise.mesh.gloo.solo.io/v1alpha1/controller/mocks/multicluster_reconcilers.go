...
func (m *MockMulticlusterRoleReconciler) ReconcileRole(clusterName string, obj *v1alpha1.Role) (reconcile.Result, error) {
	m.ctrl.T.Helper()
...
func (m *MockMulticlusterRoleBindingReconciler) ReconcileRoleBinding(clusterName string, obj *v1alpha1.RoleBinding) (reconcile.Result, error) {
	m.ctrl.T.Helper()
