...
type TrafficTargetEventHandler interface {
	CreateTrafficTarget(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error
	UpdateTrafficTarget(old, new *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error
	DeleteTrafficTarget(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error
	GenericTrafficTarget(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error
}

type TrafficTargetEventHandlerFuncs struct {
	OnCreate  func(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error
	OnUpdate  func(old, new *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error
	OnDelete  func(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error
	OnGeneric func(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error
}

func (f *TrafficTargetEventHandlerFuncs) CreateTrafficTarget(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error {
	if f.OnCreate == nil {
		return nil
	}
...
func (f *TrafficTargetEventHandlerFuncs) DeleteTrafficTarget(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error {
	if f.OnDelete == nil {
		return nil
	}
...
func (f *TrafficTargetEventHandlerFuncs) UpdateTrafficTarget(objOld, objNew *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error {
	if f.OnUpdate == nil {
		return nil
	}
...
func (f *TrafficTargetEventHandlerFuncs) GenericTrafficTarget(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error {
	if f.OnGeneric == nil {
		return nil
	}
...
func NewTrafficTargetEventWatcher(name string, mgr manager.Manager) TrafficTargetEventWatcher {
	return &trafficTargetEventWatcher{
		watcher: events.NewWatcher(name, mgr, &discovery_gloomesh_solo_io_v1alpha2.TrafficTarget{}),
	}
}
...
func (h genericTrafficTargetHandler) Create(object runtime.Object) error {
	obj, ok := object.(*discovery_gloomesh_solo_io_v1alpha2.TrafficTarget)
	if !ok {
...
func (h genericTrafficTargetHandler) Update(old, new runtime.Object) error {
	objOld, ok := old.(*discovery_gloomesh_solo_io_v1alpha2.TrafficTarget)
	if !ok {
		return errors.Errorf("internal error: TrafficTarget handler received event for %T", old)
	}
	objNew, ok := new.(*discovery_gloomesh_solo_io_v1alpha2.TrafficTarget)
	if !ok {
...
type WorkloadEventHandler interface {
	CreateWorkload(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) error
	UpdateWorkload(old, new *discovery_gloomesh_solo_io_v1alpha2.Workload) error
	DeleteWorkload(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) error
	GenericWorkload(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) error
}

type WorkloadEventHandlerFuncs struct {
	OnCreate  func(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) error
	OnUpdate  func(old, new *discovery_gloomesh_solo_io_v1alpha2.Workload) error
	OnDelete  func(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) error
	OnGeneric func(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) error
}

func (f *WorkloadEventHandlerFuncs) CreateWorkload(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *WorkloadEventHandlerFuncs) DeleteWorkload(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *WorkloadEventHandlerFuncs) UpdateWorkload(objOld, objNew *discovery_gloomesh_solo_io_v1alpha2.Workload) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *WorkloadEventHandlerFuncs) GenericWorkload(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewWorkloadEventWatcher(name string, mgr manager.Manager) WorkloadEventWatcher {
	return &workloadEventWatcher{
		watcher: events.NewWatcher(name, mgr, &discovery_gloomesh_solo_io_v1alpha2.Workload{}),
	}
}
...
func (h genericWorkloadHandler) Create(object runtime.Object) error {
	obj, ok := object.(*discovery_gloomesh_solo_io_v1alpha2.Workload)
	if !ok {
...
func (h genericWorkloadHandler) Update(old, new runtime.Object) error {
	objOld, ok := old.(*discovery_gloomesh_solo_io_v1alpha2.Workload)
	if !ok {
		return errors.Errorf("internal error: Workload handler received event for %T", old)
	}
	objNew, ok := new.(*discovery_gloomesh_solo_io_v1alpha2.Workload)
	if !ok {
...
type MeshEventHandler interface {
	CreateMesh(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) error
	UpdateMesh(old, new *discovery_gloomesh_solo_io_v1alpha2.Mesh) error
	DeleteMesh(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) error
	GenericMesh(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) error
}

type MeshEventHandlerFuncs struct {
	OnCreate  func(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) error
	OnUpdate  func(old, new *discovery_gloomesh_solo_io_v1alpha2.Mesh) error
	OnDelete  func(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) error
	OnGeneric func(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) error
}

func (f *MeshEventHandlerFuncs) CreateMesh(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *MeshEventHandlerFuncs) DeleteMesh(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *MeshEventHandlerFuncs) UpdateMesh(objOld, objNew *discovery_gloomesh_solo_io_v1alpha2.Mesh) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *MeshEventHandlerFuncs) GenericMesh(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewMeshEventWatcher(name string, mgr manager.Manager) MeshEventWatcher {
	return &meshEventWatcher{
		watcher: events.NewWatcher(name, mgr, &discovery_gloomesh_solo_io_v1alpha2.Mesh{}),
	}
}
...
func (h genericMeshHandler) Create(object runtime.Object) error {
	obj, ok := object.(*discovery_gloomesh_solo_io_v1alpha2.Mesh)
	if !ok {
...
func (h genericMeshHandler) Update(old, new runtime.Object) error {
	objOld, ok := old.(*discovery_gloomesh_solo_io_v1alpha2.Mesh)
	if !ok {
		return errors.Errorf("internal error: Mesh handler received event for %T", old)
	}
	objNew, ok := new.(*discovery_gloomesh_solo_io_v1alpha2.Mesh)
	if !ok {
