...
type TrafficTargetReconciler interface {
	ReconcileTrafficTarget(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) (reconcile.Result, error)
}
...
type TrafficTargetReconcilerFuncs struct {
	OnReconcileTrafficTarget         func(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) (reconcile.Result, error)
	OnReconcileTrafficTargetDeletion func(req reconcile.Request) error
}

func (f *TrafficTargetReconcilerFuncs) ReconcileTrafficTarget(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) (reconcile.Result, error) {
...
type TrafficTargetFinalizer interface {
	...
	FinalizeTrafficTarget(obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) error
}
...
func NewTrafficTargetReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) TrafficTargetReconcileLoop {
	return &trafficTargetReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &discovery_gloomesh_solo_io_v1alpha2.TrafficTarget{}, options),
	}
}
...
type WorkloadReconciler interface {
	ReconcileWorkload(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) (reconcile.Result, error)
}
...
type WorkloadReconcilerFuncs struct {
	OnReconcileWorkload         func(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) (reconcile.Result, error)
	OnReconcileWorkloadDeletion func(req reconcile.Request) error
}

func (f *WorkloadReconcilerFuncs) ReconcileWorkload(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) (reconcile.Result, error) {
...
type WorkloadFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeWorkload(obj *discovery_gloomesh_solo_io_v1alpha2.Workload) error
}
...
func NewWorkloadReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) WorkloadReconcileLoop {
	return &workloadReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &discovery_gloomesh_solo_io_v1alpha2.Workload{}, options),
	}
}
...
type MeshReconciler interface {
	ReconcileMesh(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) (reconcile.Result, error)
}
...
type MeshReconcilerFuncs struct {
	OnReconcileMesh         func(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) (reconcile.Result, error)
	OnReconcileMeshDeletion func(req reconcile.Request) error
}

func (f *MeshReconcilerFuncs) ReconcileMesh(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) (reconcile.Result, error) {
...
type MeshFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeMesh(obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) error
}
...
func NewMeshReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) MeshReconcileLoop {
	return &meshReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &discovery_gloomesh_solo_io_v1alpha2.Mesh{}, options),
	}
}
