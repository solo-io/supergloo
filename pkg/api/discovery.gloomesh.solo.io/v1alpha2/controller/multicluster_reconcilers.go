...
type MulticlusterTrafficTargetReconciler interface {
	ReconcileTrafficTarget(clusterName string, obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) (reconcile.Result, error)
}
...
type MulticlusterTrafficTargetReconcilerFuncs struct {
	OnReconcileTrafficTarget         func(clusterName string, obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) (reconcile.Result, error)
	OnReconcileTrafficTargetDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterTrafficTargetReconcilerFuncs) ReconcileTrafficTarget(clusterName string, obj *discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) (reconcile.Result, error) {
...
func NewMulticlusterTrafficTargetReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterTrafficTargetReconcileLoop {
	return &multiclusterTrafficTargetReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &discovery_gloomesh_solo_io_v1alpha2.TrafficTarget{}, options)}
}
...
type MulticlusterWorkloadReconciler interface {
	ReconcileWorkload(clusterName string, obj *discovery_gloomesh_solo_io_v1alpha2.Workload) (reconcile.Result, error)
}
...
type MulticlusterWorkloadReconcilerFuncs struct {
	OnReconcileWorkload         func(clusterName string, obj *discovery_gloomesh_solo_io_v1alpha2.Workload) (reconcile.Result, error)
	OnReconcileWorkloadDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterWorkloadReconcilerFuncs) ReconcileWorkload(clusterName string, obj *discovery_gloomesh_solo_io_v1alpha2.Workload) (reconcile.Result, error) {
...
func NewMulticlusterWorkloadReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterWorkloadReconcileLoop {
	return &multiclusterWorkloadReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &discovery_gloomesh_solo_io_v1alpha2.Workload{}, options)}
}
...
type MulticlusterMeshReconciler interface {
	ReconcileMesh(clusterName string, obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) (reconcile.Result, error)
}
...
type MulticlusterMeshReconcilerFuncs struct {
	OnReconcileMesh         func(clusterName string, obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) (reconcile.Result, error)
	OnReconcileMeshDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterMeshReconcilerFuncs) ReconcileMesh(clusterName string, obj *discovery_gloomesh_solo_io_v1alpha2.Mesh) (reconcile.Result, error) {
...
func NewMulticlusterMeshReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterMeshReconcileLoop {
	return &multiclusterMeshReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &discovery_gloomesh_solo_io_v1alpha2.Mesh{}, options)}
}
