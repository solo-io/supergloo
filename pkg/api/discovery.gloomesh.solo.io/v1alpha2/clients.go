...
// MulticlusterClientset for the discovery.gloomesh.solo.io/v1alpha2 APIs
...
// clienset for the discovery.gloomesh.solo.io/v1alpha2 APIs
type Clientset interface {
	// clienset for the discovery.gloomesh.solo.io/v1alpha2/v1alpha2 APIs
