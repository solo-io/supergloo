...
func partitionTrafficTargetsByLabel(labelKey string, set discovery_gloomesh_solo_io_v1alpha2_sets.TrafficTargetSet) ([]LabeledTrafficTargetSet, error) {
	setsByLabel := map[string]discovery_gloomesh_solo_io_v1alpha2_sets.TrafficTargetSet{}
	...
	for _, obj := range set.List() {
		...
		if !ok {
			setForValue = discovery_gloomesh_solo_io_v1alpha2_sets.NewTrafficTargetSet()
...
func partitionWorkloadsByLabel(labelKey string, set discovery_gloomesh_solo_io_v1alpha2_sets.WorkloadSet) ([]LabeledWorkloadSet, error) {
	setsByLabel := map[string]discovery_gloomesh_solo_io_v1alpha2_sets.WorkloadSet{}
	...
	for _, obj := range set.List() {
		...
		setForValue, ok := setsByLabel[labelValue]
		if !ok {
			setForValue = discovery_gloomesh_solo_io_v1alpha2_sets.NewWorkloadSet()
			setsByLabel[labelValue] = setForValue
		}
		setForValue.Insert(obj)
	}
...
func partitionMeshesByLabel(labelKey string, set discovery_gloomesh_solo_io_v1alpha2_sets.MeshSet) ([]LabeledMeshSet, error) {
	setsByLabel := map[string]discovery_gloomesh_solo_io_v1alpha2_sets.MeshSet{}
	...
	for _, obj := range set.List() {
		...
		setForValue, ok := setsByLabel[labelValue]
		if !ok {
			setForValue = discovery_gloomesh_solo_io_v1alpha2_sets.NewMeshSet()
			setsByLabel[labelValue] = setForValue
		}
		setForValue.Insert(obj)
	}
...
func (s snapshot) MarshalJSON() ([]byte, error) {
	...
	trafficTargetSet := discovery_gloomesh_solo_io_v1alpha2_sets.NewTrafficTargetSet()
	...
	workloadSet := discovery_gloomesh_solo_io_v1alpha2_sets.NewWorkloadSet()
	for _, set := range s.workloads {
		workloadSet = workloadSet.Union(set.Set())
	}
	snapshotMap["workloads"] = workloadSet.List()
	meshSet := discovery_gloomesh_solo_io_v1alpha2_sets.NewMeshSet()
...
type LabeledTrafficTargetSet interface {
	...
	Set() discovery_gloomesh_solo_io_v1alpha2_sets.TrafficTargetSet
...
func NewLabeledTrafficTargetSet(set discovery_gloomesh_solo_io_v1alpha2_sets.TrafficTargetSet, labels map[string]string) (LabeledTrafficTargetSet, error) {
...
func (l *labeledTrafficTargetSet) Set() discovery_gloomesh_solo_io_v1alpha2_sets.TrafficTargetSet {
	return l.set
}
...
func (l labeledTrafficTargetSet) Generic() output.ResourceList {
	...
	listFunc := func(ctx context.Context, cli client.Client) ([]ezkube.Object, error) {
		var list discovery_gloomesh_solo_io_v1alpha2.TrafficTargetList
...
type LabeledWorkloadSet interface {
	...
	Set() discovery_gloomesh_solo_io_v1alpha2_sets.WorkloadSet
...
func NewLabeledWorkloadSet(set discovery_gloomesh_solo_io_v1alpha2_sets.WorkloadSet, labels map[string]string) (LabeledWorkloadSet, error) {
...
func (l *labeledWorkloadSet) Set() discovery_gloomesh_solo_io_v1alpha2_sets.WorkloadSet {
	return l.set
}
...
func (l labeledWorkloadSet) Generic() output.ResourceList {
	...
	// enable list func for garbage collection
	listFunc := func(ctx context.Context, cli client.Client) ([]ezkube.Object, error) {
		var list discovery_gloomesh_solo_io_v1alpha2.WorkloadList
		if err := cli.List(ctx, &list, client.MatchingLabels(l.labels)); err != nil {
			return nil, err
		}
		var items []ezkube.Object
...
type LabeledMeshSet interface {
	...
	Set() discovery_gloomesh_solo_io_v1alpha2_sets.MeshSet
...
func NewLabeledMeshSet(set discovery_gloomesh_solo_io_v1alpha2_sets.MeshSet, labels map[string]string) (LabeledMeshSet, error) {
...
func (l *labeledMeshSet) Set() discovery_gloomesh_solo_io_v1alpha2_sets.MeshSet {
	return l.set
}
...
func (l labeledMeshSet) Generic() output.ResourceList {
	...
	// enable list func for garbage collection
	listFunc := func(ctx context.Context, cli client.Client) ([]ezkube.Object, error) {
		var list discovery_gloomesh_solo_io_v1alpha2.MeshList
		if err := cli.List(ctx, &list, client.MatchingLabels(l.labels)); err != nil {
			return nil, err
		}
		var items []ezkube.Object
...
type Builder interface {
	...
	AddTrafficTargets(trafficTargets ...*discovery_gloomesh_solo_io_v1alpha2.TrafficTarget)

	// get the collected TrafficTargets
	GetTrafficTargets() discovery_gloomesh_solo_io_v1alpha2_sets.TrafficTargetSet

	// add Workloads to the collected outputs
	AddWorkloads(workloads ...*discovery_gloomesh_solo_io_v1alpha2.Workload)

	// get the collected Workloads
	GetWorkloads() discovery_gloomesh_solo_io_v1alpha2_sets.WorkloadSet

	// add Meshes to the collected outputs
	AddMeshes(meshes ...*discovery_gloomesh_solo_io_v1alpha2.Mesh)

	// get the collected Meshes
	GetMeshes() discovery_gloomesh_solo_io_v1alpha2_sets.MeshSet
...
func (b *builder) AddTrafficTargets(trafficTargets ...*discovery_gloomesh_solo_io_v1alpha2.TrafficTarget) {
...
func (b *builder) AddWorkloads(workloads ...*discovery_gloomesh_solo_io_v1alpha2.Workload) {
...
func (b *builder) AddMeshes(meshes ...*discovery_gloomesh_solo_io_v1alpha2.Mesh) {
...
func (b *builder) GetTrafficTargets() discovery_gloomesh_solo_io_v1alpha2_sets.TrafficTargetSet {
	return b.trafficTargets
}
func (b *builder) GetWorkloads() discovery_gloomesh_solo_io_v1alpha2_sets.WorkloadSet {
	return b.workloads
}
func (b *builder) GetMeshes() discovery_gloomesh_solo_io_v1alpha2_sets.MeshSet {
	return b.meshes
}
