...
func (m *FailoverServiceSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.smh.solo.io.github.com/solo-io/service-mesh-hub/pkg/api/networking.smh.solo.io/v1alpha2.FailoverServiceSpec")); err != nil {
		return 0, err
	}
...
func (m *FailoverServiceStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.smh.solo.io.github.com/solo-io/service-mesh-hub/pkg/api/networking.smh.solo.io/v1alpha2.FailoverServiceStatus")); err != nil {
		return 0, err
	}
...
func (m *FailoverServiceSpec_Port) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.smh.solo.io.github.com/solo-io/service-mesh-hub/pkg/api/networking.smh.solo.io/v1alpha2.FailoverServiceSpec_Port")); err != nil {
		return 0, err
	}
