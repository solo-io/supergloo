...
type multiClusterReconciler interface {
	...
	networking_smh_solo_io_v1alpha1_controllers.MulticlusterAccessControlPolicyReconciler
...
func RegisterMultiClusterReconciler(
	...
	networking_smh_solo_io_v1alpha1_controllers.NewMulticlusterAccessControlPolicyReconcileLoop("AccessControlPolicy", clusters).AddMulticlusterAccessControlPolicyReconciler(ctx, r)
...
func (r *multiClusterReconcilerImpl) ReconcileAccessControlPolicy(clusterName string, obj *networking_smh_solo_io_v1alpha1.AccessControlPolicy) (reconcile.Result, error) {
	contextutils.LoggerFrom(r.ctx).Debugw("reconciling event", "cluster", clusterName, "obj", obj)
	return reconcile.Result{}, r.reconcileFunc()
}
...
type singleClusterReconciler interface {
	...
	networking_smh_solo_io_v1alpha1_controllers.AccessControlPolicyReconciler
...
func RegisterSingleClusterReconciler(
	...
	if err := networking_smh_solo_io_v1alpha1_controllers.NewAccessControlPolicyReconcileLoop("AccessControlPolicy", mgr, reconcile.Options{}).RunAccessControlPolicyReconciler(ctx, r); err != nil {
		return err
	}
...
func (r *singleClusterReconcilerImpl) ReconcileAccessControlPolicy(obj *networking_smh_solo_io_v1alpha1.AccessControlPolicy) (reconcile.Result, error) {
	contextutils.LoggerFrom(r.ctx).Debugw("reconciling event", "obj", obj)
	return reconcile.Result{}, r.reconcileFunc()
}
