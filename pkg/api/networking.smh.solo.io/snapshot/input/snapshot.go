...
type Snapshot interface {
	...
	// return the set of input AccessControlPolicies
	AccessControlPolicies() networking_smh_solo_io_v1alpha1_sets.AccessControlPolicySet
...
func (s snapshot) AccessControlPolicies() networking_smh_solo_io_v1alpha1_sets.AccessControlPolicySet {
	return s.accessControlPolicies
}
...
type multiClusterBuilder struct {
	...
	accessControlPolicies networking_smh_solo_io_v1alpha1.MulticlusterAccessControlPolicyClient
...
func NewMultiClusterBuilder(
	...
	return &multiClusterBuilder{
		...
		accessControlPolicies: networking_smh_solo_io_v1alpha1.NewMulticlusterAccessControlPolicyClient(client),
...
func (b *multiClusterBuilder) BuildSnapshot(ctx context.Context, name string) (Snapshot, error) {
	...
	accessControlPolicies := networking_smh_solo_io_v1alpha1_sets.NewAccessControlPolicySet()
	...
	for _, cluster := range b.clusters.ListClusters() {
		...
		if err := b.insertAccessControlPoliciesFromCluster(ctx, cluster, accessControlPolicies); err != nil {
			errs = multierror.Append(errs, err)
		}
...
func (b *multiClusterBuilder) insertAccessControlPoliciesFromCluster(ctx context.Context, cluster string, accessControlPolicies networking_smh_solo_io_v1alpha1_sets.AccessControlPolicySet) error {
	accessControlPolicyClient, err := b.accessControlPolicies.Cluster(cluster)
	if err != nil {
		return err
	}

	accessControlPolicyList, err := accessControlPolicyClient.ListAccessControlPolicy(ctx)
	if err != nil {
		return err
	}

	for _, item := range accessControlPolicyList.Items {
		item := item               // pike
		item.ClusterName = cluster // set cluster for in-memory processing
		accessControlPolicies.Insert(&item)
	}
...
type singleClusterBuilder struct {
	...
	accessControlPolicies networking_smh_solo_io_v1alpha1.AccessControlPolicyClient
...
func NewSingleClusterBuilder(
	...
	return &singleClusterBuilder{
		...
		accessControlPolicies: networking_smh_solo_io_v1alpha1.NewAccessControlPolicyClient(client),
...
func (b *singleClusterBuilder) BuildSnapshot(ctx context.Context, name string) (Snapshot, error) {
	...
	if err := b.insertAccessControlPolicies(ctx, accessControlPolicies); err != nil {
		errs = multierror.Append(errs, err)
	}
...
func (b *singleClusterBuilder) insertAccessControlPolicies(ctx context.Context, accessControlPolicies networking_smh_solo_io_v1alpha1_sets.AccessControlPolicySet) error {
	accessControlPolicyList, err := b.accessControlPolicies.ListAccessControlPolicy(ctx)
	if err != nil {
		return err
	}
