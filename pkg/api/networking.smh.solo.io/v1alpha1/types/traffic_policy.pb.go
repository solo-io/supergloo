...
type TrafficPolicySpec_OutlierDetection struct {
	...
	Interval *types1.Duration `protobuf:"bytes,2,opt,name=interval,proto3" json:"interval,omitempty"`
	// Minimum ejection duration. Format: 1h/1m/1s/1ms. MUST BE >=1ms. Defaults to 30s.
	BaseEjectionTime     *types1.Duration `protobuf:"bytes,3,opt,name=base_ejection_time,json=baseEjectionTime,proto3" json:"base_ejection_time,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (*TrafficPolicySpec_OutlierDetection) Descriptor() ([]byte, []int) {
	return fileDescriptor_1945d06e716d21bb, []int{0, 11}
}
...
func (m *TrafficPolicySpec_OutlierDetection) GetConsecutiveErrors() int32 {
	if m != nil {
...
func (m *TrafficPolicySpec_OutlierDetection) GetInterval() *types1.Duration {
	if m != nil {
		return m.Interval
	}
	return nil
...
func (m *TrafficPolicySpec_OutlierDetection) GetBaseEjectionTime() *types1.Duration {
	if m != nil {
...
var fileDescriptor_1945d06e716d21bb = []byte{
	...
	,
}
