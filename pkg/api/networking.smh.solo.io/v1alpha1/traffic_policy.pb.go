...
import (
	...
	types1 "github.com/solo-io/service-mesh-hub/pkg/api/core.smh.solo.io/v1alpha1/types"
...
func (*TrafficPolicySpec_MultiDestination_WeightedDestination_KubeDestination) Descriptor() ([]byte, []int) {
	return fileDescriptor_1945d06e716d21bb, []int{0, 1, 0, 0}
}
...
func (m *TrafficPolicySpec_MultiDestination_WeightedDestination_KubeDestination) GetCluster() string {
	if m != nil {
		return m.Cluster
	}
	return ""
...
type TrafficPolicySpec_HttpMethod struct {
	Method               types1.HttpMethodValue `protobuf:"varint,1,opt,name=method,proto3,enum=core.smh.solo.io.HttpMethodValue" json:"method,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *TrafficPolicyStatus) GetState() ValidationState {
	if m != nil {
		return m.State
	}
...
func (m *TrafficPolicyStatus) GetMeshServices() map[string]*ValidationStatus {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]*ValidationStatus)(nil), "networking.smh.solo.io.TrafficPolicyStatus.MeshServicesEntry")
}
...
var fileDescriptor_1945d06e716d21bb = []byte{
	...
	,
}
