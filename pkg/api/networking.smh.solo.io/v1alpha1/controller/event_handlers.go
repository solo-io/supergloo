...
type FailoverServiceEventHandler interface {
	CreateFailoverService(obj *networking_smh_solo_io_v1alpha1.FailoverService) error
	UpdateFailoverService(old, new *networking_smh_solo_io_v1alpha1.FailoverService) error
	DeleteFailoverService(obj *networking_smh_solo_io_v1alpha1.FailoverService) error
	GenericFailoverService(obj *networking_smh_solo_io_v1alpha1.FailoverService) error
}

type FailoverServiceEventHandlerFuncs struct {
	OnCreate  func(obj *networking_smh_solo_io_v1alpha1.FailoverService) error
	OnUpdate  func(old, new *networking_smh_solo_io_v1alpha1.FailoverService) error
	OnDelete  func(obj *networking_smh_solo_io_v1alpha1.FailoverService) error
	OnGeneric func(obj *networking_smh_solo_io_v1alpha1.FailoverService) error
}

func (f *FailoverServiceEventHandlerFuncs) CreateFailoverService(obj *networking_smh_solo_io_v1alpha1.FailoverService) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *FailoverServiceEventHandlerFuncs) DeleteFailoverService(obj *networking_smh_solo_io_v1alpha1.FailoverService) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *FailoverServiceEventHandlerFuncs) UpdateFailoverService(objOld, objNew *networking_smh_solo_io_v1alpha1.FailoverService) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *FailoverServiceEventHandlerFuncs) GenericFailoverService(obj *networking_smh_solo_io_v1alpha1.FailoverService) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewFailoverServiceEventWatcher(name string, mgr manager.Manager) FailoverServiceEventWatcher {
	return &failoverServiceEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_smh_solo_io_v1alpha1.FailoverService{}),
	}
}
...
func (h genericFailoverServiceHandler) Update(old, new runtime.Object) error {
	objOld, ok := old.(*networking_smh_solo_io_v1alpha1.FailoverService)
	if !ok {
		return errors.Errorf("internal error: FailoverService handler received event for %T", old)
	}
	objNew, ok := new.(*networking_smh_solo_io_v1alpha1.FailoverService)
	if !ok {
