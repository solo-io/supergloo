...
// Hash function
func (m *ServiceEntry) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("istio.networking.v1alpha3.github.com/solo-io/mesh-projects/pkg/api/external/istio/networking/v1alpha3.ServiceEntry")); err != nil {
		return 0, err
	}
	...
	err = binary.Write(hasher, binary.LittleEndian, m.GetResolution())
	if err != nil {
		return 0, err
	}
...
// Hash function
func (m *ServiceEntry_Endpoint) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("istio.networking.v1alpha3.github.com/solo-io/mesh-projects/pkg/api/external/istio/networking/v1alpha3.ServiceEntry_Endpoint")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte(m.GetLocality())); err != nil {
		return 0, err
	}
