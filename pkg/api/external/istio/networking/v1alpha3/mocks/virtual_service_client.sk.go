...
// Source: ./pkg/api/external/istio/networking/v1alpha3/virtual_service_client.sk.go
...
func (mr *MockVirtualServiceClientMockRecorder) Read(namespace, name, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Read", reflect.TypeOf((*MockVirtualServiceClient)(nil).Read), namespace, name, opts)
}
...
func (mr *MockVirtualServiceClientMockRecorder) Write(resource, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Write", reflect.TypeOf((*MockVirtualServiceClient)(nil).Write), resource, opts)
}
...
func (mr *MockVirtualServiceClientMockRecorder) Delete(namespace, name, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockVirtualServiceClient)(nil).Delete), namespace, name, opts)
}
...
func (mr *MockVirtualServiceClientMockRecorder) List(namespace, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockVirtualServiceClient)(nil).List), namespace, opts)
}
...
func (mr *MockVirtualServiceClientMockRecorder) Watch(namespace, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Watch", reflect.TypeOf((*MockVirtualServiceClient)(nil).Watch), namespace, opts)
}
