...
func (dst *LoadBalancerSettings_LocalityWeightSetting) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LoadBalancerSettings_LocalityWeightSetting.Merge(dst, src)
}
...
type ConnectionPoolSettings_TCPSettings_TcpKeepalive struct {
	...
	Time *types.Duration `protobuf:"bytes,2,opt,name=time" json:"time,omitempty"`
	// The time duration between keep-alive probes.
	// Default is to use the OS level configuration
	// (unless overridden, Linux defaults to 75s.)
	Interval             *types.Duration `protobuf:"bytes,3,opt,name=interval" json:"interval,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (dst *ConnectionPoolSettings_TCPSettings_TcpKeepalive) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConnectionPoolSettings_TCPSettings_TcpKeepalive.Merge(dst, src)
}
