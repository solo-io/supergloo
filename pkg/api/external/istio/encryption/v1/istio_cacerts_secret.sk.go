...
func (r *IstioCacertsSecret) Hash() uint64 {
...
func (list IstioCacertsSecretList) Each(f func(element *IstioCacertsSecret)) {
	for _, istioCacertsSecret := range list {
		f(istioCacertsSecret)
	}
}

func (list IstioCacertsSecretList) AsInterfaces() []interface{} {
	var asInterfaces []interface{}
	list.Each(func(element *IstioCacertsSecret) {
