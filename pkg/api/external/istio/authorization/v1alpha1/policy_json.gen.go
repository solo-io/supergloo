...
// MarshalJSON is a custom marshaler for MeshPolicy
func (this *MeshPolicy) MarshalJSON() ([]byte, error) {
	str, err := PolicyMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for MeshPolicy
func (this *MeshPolicy) UnmarshalJSON(b []byte) error {
	return PolicyUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}
