...
package v1alpha1 // import "github.com/solo-io/supergloo/pkg/api/external/istio/authorization/v1alpha1"
...
func (dst *MeshPolicy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshPolicy.Merge(dst, src)
}
