...
func (r *RbacConfig) MustHash() uint64 {
...
func (r *RbacConfig) GroupVersionKind() schema.GroupVersionKind {
	return RbacConfigGVK
}
...
func (o *RbacConfig) DeepCopyInto(out *RbacConfig) {
	clone := resources.Clone(o).(*RbacConfig)
	*out = *clone
}

var (
	RbacConfigCrd = crd.NewCrd(
		"rbacconfigs",
		RbacConfigGVK.Group,
...
func init() {
	if err := crd.AddCrd(RbacConfigCrd); err != nil {
		log.Fatalf("could not add crd to global registry")
	}
}

var (
	RbacConfigGVK = schema.GroupVersionKind{
		Version: "v1alpha1",
		Group:   "rbac.istio.io",
		Kind:    "RbacConfig",
	}
