...
func NewRbacEventLoop(emitter RbacEmitter, syncer RbacSyncer) RbacEventLoop {
	...
	go func() {
		...
		for {
			...
			case snapshot, ok := <-watch:
				...
				ctx, span := trace.StartSpan(opts.Ctx, "rbac.istio.io.EventLoopSync")
