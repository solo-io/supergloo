...
import (
	...
	"github.com/solo-io/mesh-projects/pkg/api/core.zephyr.solo.io/v1alpha1/clientset/versioned/scheme"
...
func (c *CoreV1alpha1Client) KubernetesClusters(namespace string) KubernetesClusterInterface {
	return newKubernetesClusters(c, namespace)
}

func (c *CoreV1alpha1Client) Meshes(namespace string) MeshInterface {
	return newMeshes(c, namespace)
}

func (c *CoreV1alpha1Client) MeshGroups(namespace string) MeshGroupInterface {
