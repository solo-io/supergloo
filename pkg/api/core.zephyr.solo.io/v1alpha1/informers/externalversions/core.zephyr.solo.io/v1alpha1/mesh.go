	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha1().Meshes(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha1().Meshes(namespace).Watch(options)
			},
		},
		&corezephyrsoloiov1alpha1.Mesh{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *meshInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corezephyrsoloiov1alpha1.Mesh{}, f.defaultInformer)
}
