...
func (dst *MeshIngress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshIngress.Merge(dst, src)
}
...
type MeshIngress_Gloo struct {
	Gloo *GlooMeshIngress `protobuf:"bytes,1,opt,name=gloo,oneof"`
}
...
func (dst *GlooMeshIngress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GlooMeshIngress.Merge(dst, src)
}
