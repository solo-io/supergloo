...
type RetryPolicy struct {
	...
	IstioRetries *v1alpha3.HTTPRetry `protobuf:"bytes,1,opt,name=istio_retries,json=istioRetries,proto3" json:"istio_retries,omitempty"`
	// this retry policy will be applied to any targeted Istio Mesh Insatnces
	LinkerdRetries       *LinkerdRetryPolicy `protobuf:"bytes,2,opt,name=linkerd_retries,json=linkerdRetries,proto3" json:"linkerd_retries,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *RetryPolicy) GetIstioRetries() *v1alpha3.HTTPRetry {
	if m != nil {
		return m.IstioRetries
	}
	return nil
}

func (m *RetryPolicy) GetLinkerdRetries() *LinkerdRetryPolicy {
	if m != nil {
		return m.LinkerdRetries
	}
	return nil
}
...
type LinkerdRetryPolicy struct {
	// RetryBudget allows fine-grained management of
	// Linkerd retry configuration. If it is not specifed,
	// SuperGloo will use a default retry budget for the target routes & destinations
	RetryBudget          *LinkerdRetryPolicy_RetryBudget `protobuf:"bytes,1,opt,name=retry_budget,json=retryBudget,proto3" json:"retry_budget,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                        `json:"-"`
	XXX_unrecognized     []byte                          `json:"-"`
	XXX_sizecache        int32                           `json:"-"`
}

func (m *LinkerdRetryPolicy) Reset()         { *m = LinkerdRetryPolicy{} }
func (m *LinkerdRetryPolicy) String() string { return proto.CompactTextString(m) }
func (*LinkerdRetryPolicy) ProtoMessage()    {}
func (*LinkerdRetryPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_29316bfaa5f4ba1a, []int{3}
}
func (m *LinkerdRetryPolicy) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_LinkerdRetryPolicy.Unmarshal(m, b)
}
func (m *LinkerdRetryPolicy) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_LinkerdRetryPolicy.Marshal(b, m, deterministic)
}
func (m *LinkerdRetryPolicy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LinkerdRetryPolicy.Merge(m, src)
}
func (m *LinkerdRetryPolicy) XXX_Size() int {
	return xxx_messageInfo_LinkerdRetryPolicy.Size(m)
}
func (m *LinkerdRetryPolicy) XXX_DiscardUnknown() {
	xxx_messageInfo_LinkerdRetryPolicy.DiscardUnknown(m)
}

var xxx_messageInfo_LinkerdRetryPolicy proto.InternalMessageInfo

func (m *LinkerdRetryPolicy) GetRetryBudget() *LinkerdRetryPolicy_RetryBudget {
	if m != nil {
...
type LinkerdRetryPolicy_RetryBudget struct {
...
func (m *LinkerdRetryPolicy_RetryBudget) Reset()         { *m = LinkerdRetryPolicy_RetryBudget{} }
func (m *LinkerdRetryPolicy_RetryBudget) String() string { return proto.CompactTextString(m) }
func (*LinkerdRetryPolicy_RetryBudget) ProtoMessage()    {}
func (*LinkerdRetryPolicy_RetryBudget) Descriptor() ([]byte, []int) {
	return fileDescriptor_29316bfaa5f4ba1a, []int{3, 0}
}
func (m *LinkerdRetryPolicy_RetryBudget) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_LinkerdRetryPolicy_RetryBudget.Unmarshal(m, b)
}
func (m *LinkerdRetryPolicy_RetryBudget) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_LinkerdRetryPolicy_RetryBudget.Marshal(b, m, deterministic)
}
func (m *LinkerdRetryPolicy_RetryBudget) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LinkerdRetryPolicy_RetryBudget.Merge(m, src)
}
func (m *LinkerdRetryPolicy_RetryBudget) XXX_Size() int {
	return xxx_messageInfo_LinkerdRetryPolicy_RetryBudget.Size(m)
}
func (m *LinkerdRetryPolicy_RetryBudget) XXX_DiscardUnknown() {
	xxx_messageInfo_LinkerdRetryPolicy_RetryBudget.DiscardUnknown(m)
}

var xxx_messageInfo_LinkerdRetryPolicy_RetryBudget proto.InternalMessageInfo

func (m *LinkerdRetryPolicy_RetryBudget) GetRetryRatio() float32 {
	if m != nil {
		return m.RetryRatio
	}
	return 0
...
func (m *LinkerdRetryPolicy_RetryBudget) GetMinRetriesPerSecond() uint32 {
	if m != nil {
...
func (m *LinkerdRetryPolicy_RetryBudget) GetTtl() string {
	if m != nil {
		return m.Ttl
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*LinkerdRetryPolicy)(nil), "supergloo.solo.io.LinkerdRetryPolicy")
	proto.RegisterType((*LinkerdRetryPolicy_RetryBudget)(nil), "supergloo.solo.io.LinkerdRetryPolicy.RetryBudget")
...
var fileDescriptor_29316bfaa5f4ba1a = []byte{
	...
	,
}
...
func (this *RetryPolicy) Equal(that interface{}) bool {
	...
	if !this.IstioRetries.Equal(that1.IstioRetries) {
		return false
	}
	if !this.LinkerdRetries.Equal(that1.LinkerdRetries) {
		return false
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return false
...
func (this *LinkerdRetryPolicy) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*LinkerdRetryPolicy)
	if !ok {
		that2, ok := that.(LinkerdRetryPolicy)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *LinkerdRetryPolicy_RetryBudget) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*LinkerdRetryPolicy_RetryBudget)
	if !ok {
		that2, ok := that.(LinkerdRetryPolicy_RetryBudget)
		if ok {
			that1 = &that2
		} else {
			return false
