...
func NewTranslatorEmitter(meshClient MeshClient, upstreamClient gloo_solo_io.UpstreamClient, istioCacertsSecretClient encryption_istio_io.IstioCacertsSecretClient) TranslatorEmitter {
	return NewTranslatorEmitterWithEmit(meshClient, upstreamClient, istioCacertsSecretClient, make(chan struct{}))
}

func NewTranslatorEmitterWithEmit(meshClient MeshClient, upstreamClient gloo_solo_io.UpstreamClient, istioCacertsSecretClient encryption_istio_io.IstioCacertsSecretClient, emit <-chan struct{}) TranslatorEmitter {
