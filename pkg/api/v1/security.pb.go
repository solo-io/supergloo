...
type SecurityRule struct {
	...
	AllowedPaths []string `protobuf:"bytes,4,rep,name=allowed_paths,json=allowedPaths" json:"allowed_paths,omitempty"`
	// Optional. A list of HTTP methods to allow (e.g., "GET", "POST").
	// It is ignored in gRPC case because the value is always "POST".
	// If set to ["*"] or not specified, it allows to any method.
	AllowedMethods       []string `protobuf:"bytes,5,rep,name=allowed_methods,json=allowedMethods" json:"allowed_methods,omitempty"`
...
func (dst *SecurityRule) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SecurityRule.Merge(dst, src)
}
