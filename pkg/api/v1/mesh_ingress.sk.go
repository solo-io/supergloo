...
func (r *MeshIngress) MustHash() uint64 {
...
func (r *MeshIngress) GroupVersionKind() schema.GroupVersionKind {
	return MeshIngressGVK
}
...
func (o *MeshIngress) DeepCopyInto(out *MeshIngress) {
	clone := resources.Clone(o).(*MeshIngress)
	*out = *clone
}

var (
	MeshIngressCrd = crd.NewCrd(
		"meshingresses",
		MeshIngressGVK.Group,
		MeshIngressGVK.Version,
		MeshIngressGVK.Kind,
		"mi",
		false,
		&MeshIngress{})
...
func init() {
	if err := crd.AddCrd(MeshIngressCrd); err != nil {
		log.Fatalf("could not add crd to global registry")
	}
}

var (
	MeshIngressGVK = schema.GroupVersionKind{
		Version: "v1",
