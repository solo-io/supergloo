...
func (dst *PodSelector) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PodSelector.Merge(dst, src)
}
...
type PodSelector_LabelSelector_ struct {
	LabelSelector *PodSelector_LabelSelector `protobuf:"bytes,1,opt,name=label_selector,json=labelSelector,oneof"`
}
type PodSelector_UpstreamSelector_ struct {
	UpstreamSelector *PodSelector_UpstreamSelector `protobuf:"bytes,2,opt,name=upstream_selector,json=upstreamSelector,oneof"`
}
type PodSelector_NamespaceSelector_ struct {
	NamespaceSelector *PodSelector_NamespaceSelector `protobuf:"bytes,3,opt,name=namespace_selector,json=namespaceSelector,oneof"`
}
...
type PodSelector_LabelSelector struct {
	LabelsToMatch        map[string]string `protobuf:"bytes,1,rep,name=labels_to_match,json=labelsToMatch" json:"labels_to_match,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (dst *PodSelector_LabelSelector) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PodSelector_LabelSelector.Merge(dst, src)
}
...
type PodSelector_UpstreamSelector struct {
	...
	Upstreams            []core.ResourceRef `protobuf:"bytes,1,rep,name=upstreams" json:"upstreams"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (dst *PodSelector_UpstreamSelector) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PodSelector_UpstreamSelector.Merge(dst, src)
}
...
func (dst *PodSelector_NamespaceSelector) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PodSelector_NamespaceSelector.Merge(dst, src)
}
