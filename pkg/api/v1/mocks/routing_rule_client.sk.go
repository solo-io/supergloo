...
// Source: ./pkg/api/v1/routing_rule_client.sk.go
...
type MockRoutingRuleClient struct {
	ctrl     *gomock.Controller
	recorder *MockRoutingRuleClientMockRecorder
}
...
func NewMockRoutingRuleClient(ctrl *gomock.Controller) *MockRoutingRuleClient {
	mock := &MockRoutingRuleClient{ctrl: ctrl}
	mock.recorder = &MockRoutingRuleClientMockRecorder{mock}
	return mock
}
...
func (mr *MockRoutingRuleClientMockRecorder) BaseClient() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BaseClient", reflect.TypeOf((*MockRoutingRuleClient)(nil).BaseClient))
}
...
func (mr *MockRoutingRuleClientMockRecorder) Read(namespace, name, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Read", reflect.TypeOf((*MockRoutingRuleClient)(nil).Read), namespace, name, opts)
}
...
func (mr *MockRoutingRuleClientMockRecorder) Write(resource, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Write", reflect.TypeOf((*MockRoutingRuleClient)(nil).Write), resource, opts)
}
...
func (mr *MockRoutingRuleClientMockRecorder) Delete(namespace, name, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockRoutingRuleClient)(nil).Delete), namespace, name, opts)
}
...
func (m *MockRoutingRuleClient) List(namespace string, opts clients.ListOpts) (v1.RoutingRuleList, error) {
	...
	ret0, _ := ret[0].(v1.RoutingRuleList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRoutingRuleClientMockRecorder) List(namespace, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockRoutingRuleClient)(nil).List), namespace, opts)
}
...
func (mr *MockRoutingRuleClientMockRecorder) Watch(namespace, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Watch", reflect.TypeOf((*MockRoutingRuleClient)(nil).Watch), namespace, opts)
}
