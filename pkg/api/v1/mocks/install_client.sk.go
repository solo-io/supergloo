...
// Source: ./pkg/api/v1/install_client.sk.go
...
func (m *MockInstallWatcher) Watch(namespace string, opts clients.WatchOpts) (<-chan v1.InstallList, <-chan error, error) {
	...
	ret0, _ := ret[0].(<-chan v1.InstallList)
...
func (mr *MockInstallClientMockRecorder) BaseClient() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BaseClient", reflect.TypeOf((*MockInstallClient)(nil).BaseClient))
}
...
func (mr *MockInstallClientMockRecorder) Register() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Register", reflect.TypeOf((*MockInstallClient)(nil).Register))
}
...
func (mr *MockInstallClientMockRecorder) Read(namespace, name, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Read", reflect.TypeOf((*MockInstallClient)(nil).Read), namespace, name, opts)
}
...
func (mr *MockInstallClientMockRecorder) Write(resource, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Write", reflect.TypeOf((*MockInstallClient)(nil).Write), resource, opts)
}
...
func (mr *MockInstallClientMockRecorder) Delete(namespace, name, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockInstallClient)(nil).Delete), namespace, name, opts)
}
...
func (mr *MockInstallClientMockRecorder) List(namespace, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockInstallClient)(nil).List), namespace, opts)
}
...
func (mr *MockInstallClientMockRecorder) Watch(namespace, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Watch", reflect.TypeOf((*MockInstallClient)(nil).Watch), namespace, opts)
}
