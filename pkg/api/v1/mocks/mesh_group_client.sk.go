...
// Source: ./pkg/api/v1/mesh_group_client.sk.go
...
type MockMeshGroupWatcher struct {
	...
	recorder *MockMeshGroupWatcherMockRecorder
}
...
func NewMockMeshGroupWatcher(ctrl *gomock.Controller) *MockMeshGroupWatcher {
	mock := &MockMeshGroupWatcher{ctrl: ctrl}
	mock.recorder = &MockMeshGroupWatcherMockRecorder{mock}
	return mock
}
...
func (m *MockMeshGroupWatcher) Watch(namespace string, opts clients.WatchOpts) (<-chan v1.MeshGroupList, <-chan error, error) {
	...
	ret0, _ := ret[0].(<-chan v1.MeshGroupList)
...
func (mr *MockMeshGroupWatcherMockRecorder) Watch(namespace, opts interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Watch", reflect.TypeOf((*MockMeshGroupWatcher)(nil).Watch), namespace, opts)
}
...
func (mr *MockMeshGroupClientMockRecorder) BaseClient() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BaseClient", reflect.TypeOf((*MockMeshGroupClient)(nil).BaseClient))
}
...
func (mr *MockMeshGroupClientMockRecorder) Register() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Register", reflect.TypeOf((*MockMeshGroupClient)(nil).Register))
}
...
func (mr *MockMeshGroupClientMockRecorder) Read(namespace, name, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Read", reflect.TypeOf((*MockMeshGroupClient)(nil).Read), namespace, name, opts)
}
...
func (mr *MockMeshGroupClientMockRecorder) Write(resource, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Write", reflect.TypeOf((*MockMeshGroupClient)(nil).Write), resource, opts)
}
...
func (mr *MockMeshGroupClientMockRecorder) Delete(namespace, name, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockMeshGroupClient)(nil).Delete), namespace, name, opts)
}
...
func (mr *MockMeshGroupClientMockRecorder) List(namespace, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockMeshGroupClient)(nil).List), namespace, opts)
}
...
func (mr *MockMeshGroupClientMockRecorder) Watch(namespace, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Watch", reflect.TypeOf((*MockMeshGroupClient)(nil).Watch), namespace, opts)
}
