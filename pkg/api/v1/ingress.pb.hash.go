...
// Hash function
func (m *MeshIngress) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("zephyr.solo.io.github.com/solo-io/mesh-projects/pkg/api/v1.MeshIngress")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *MeshIngress_GlooIngress) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("zephyr.solo.io.github.com/solo-io/mesh-projects/pkg/api/v1.MeshIngress_GlooIngress")); err != nil {
		return 0, err
	}
