	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1alpha1().AccessControlPolicies(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1alpha1().AccessControlPolicies(namespace).Watch(options)
			},
		},
		&networkingzephyrsoloiov1alpha1.AccessControlPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *accessControlPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkingzephyrsoloiov1alpha1.AccessControlPolicy{}, f.defaultInformer)
}
