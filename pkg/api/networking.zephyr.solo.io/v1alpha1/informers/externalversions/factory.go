...
type SharedInformerFactory interface {
	...
	Networking() networkingzephyrsoloio.Interface
}

func (f *sharedInformerFactory) Networking() networkingzephyrsoloio.Interface {
	return networkingzephyrsoloio.New(f, f.namespace, f.tweakListOptions)
}
