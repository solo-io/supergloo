...
import (
	...
	v1alpha1sets "github.com/solo-io/service-mesh-hub/pkg/api/core.smh.solo.io/v1alpha1/sets"
...
func (m *MockSettingsSet) List() []*v1alpha1.Settings {
	m.ctrl.T.Helper()
...
func (m *MockSettingsSet) Map() map[string]*v1alpha1.Settings {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Map")
	ret0, _ := ret[0].(map[string]*v1alpha1.Settings)
	return ret0
}
...
func (m *MockSettingsSet) Insert(settings ...*v1alpha1.Settings) {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
...
func (m *MockSettingsSet) Equal(settingsSet v1alpha1sets.SettingsSet) bool {
	m.ctrl.T.Helper()
...
func (m *MockSettingsSet) Has(settings *v1alpha1.Settings) bool {
	m.ctrl.T.Helper()
...
func (m *MockSettingsSet) Delete(settings *v1alpha1.Settings) {
	m.ctrl.T.Helper()
...
func (m *MockSettingsSet) Union(set v1alpha1sets.SettingsSet) v1alpha1sets.SettingsSet {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Union", set)
	ret0, _ := ret[0].(v1alpha1sets.SettingsSet)
	return ret0
}
...
func (m *MockSettingsSet) Difference(set v1alpha1sets.SettingsSet) v1alpha1sets.SettingsSet {
	m.ctrl.T.Helper()
...
func (m *MockSettingsSet) Intersection(set v1alpha1sets.SettingsSet) v1alpha1sets.SettingsSet {
	m.ctrl.T.Helper()
...
func (m *MockSettingsSet) Find(id ezkube.ResourceId) (*v1alpha1.Settings, error) {
	m.ctrl.T.Helper()
