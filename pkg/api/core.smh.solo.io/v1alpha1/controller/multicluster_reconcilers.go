...
type MulticlusterSettingsReconciler interface {
	ReconcileSettings(clusterName string, obj *core_smh_solo_io_v1alpha1.Settings) (reconcile.Result, error)
}
...
func NewMulticlusterSettingsReconcileLoop(name string, cw multicluster.ClusterWatcher) MulticlusterSettingsReconcileLoop {
	return &multiclusterSettingsReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &core_smh_solo_io_v1alpha1.Settings{})}
}
