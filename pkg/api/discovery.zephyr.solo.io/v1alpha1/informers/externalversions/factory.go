...
type SharedInformerFactory interface {
	...
	Discovery() discoveryzephyrsoloio.Interface
}

func (f *sharedInformerFactory) Discovery() discoveryzephyrsoloio.Interface {
	return discoveryzephyrsoloio.New(f, f.namespace, f.tweakListOptions)
}
