	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DiscoveryV1alpha1().KubernetesClusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DiscoveryV1alpha1().KubernetesClusters(namespace).Watch(options)
			},
		},
		&discoveryzephyrsoloiov1alpha1.KubernetesCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kubernetesClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&discoveryzephyrsoloiov1alpha1.KubernetesCluster{}, f.defaultInformer)
}
