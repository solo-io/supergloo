...
type MulticlusterKubernetesClusterReconciler interface {
	ReconcileKubernetesCluster(clusterName string, obj *discovery_zephyr_solo_io_v1alpha1.KubernetesCluster) (reconcile.Result, error)
}
...
type MulticlusterKubernetesClusterReconcilerFuncs struct {
	OnReconcileKubernetesCluster         func(clusterName string, obj *discovery_zephyr_solo_io_v1alpha1.KubernetesCluster) (reconcile.Result, error)
	OnReconcileKubernetesClusterDeletion func(clusterName string, req reconcile.Request)
}

func (f *MulticlusterKubernetesClusterReconcilerFuncs) ReconcileKubernetesCluster(clusterName string, obj *discovery_zephyr_solo_io_v1alpha1.KubernetesCluster) (reconcile.Result, error) {
...
func NewMulticlusterKubernetesClusterReconcileLoop(name string, cw multicluster.ClusterWatcher) MulticlusterKubernetesClusterReconcileLoop {
	return &multiclusterKubernetesClusterReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &discovery_zephyr_solo_io_v1alpha1.KubernetesCluster{})}
}
...
type MulticlusterMeshServiceReconciler interface {
	ReconcileMeshService(clusterName string, obj *discovery_zephyr_solo_io_v1alpha1.MeshService) (reconcile.Result, error)
}
...
type MulticlusterMeshServiceReconcilerFuncs struct {
	OnReconcileMeshService         func(clusterName string, obj *discovery_zephyr_solo_io_v1alpha1.MeshService) (reconcile.Result, error)
	OnReconcileMeshServiceDeletion func(clusterName string, req reconcile.Request)
}

func (f *MulticlusterMeshServiceReconcilerFuncs) ReconcileMeshService(clusterName string, obj *discovery_zephyr_solo_io_v1alpha1.MeshService) (reconcile.Result, error) {
...
func NewMulticlusterMeshServiceReconcileLoop(name string, cw multicluster.ClusterWatcher) MulticlusterMeshServiceReconcileLoop {
	return &multiclusterMeshServiceReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &discovery_zephyr_solo_io_v1alpha1.MeshService{})}
}
...
type MulticlusterMeshWorkloadReconciler interface {
	ReconcileMeshWorkload(clusterName string, obj *discovery_zephyr_solo_io_v1alpha1.MeshWorkload) (reconcile.Result, error)
}
...
type MulticlusterMeshWorkloadReconcilerFuncs struct {
	OnReconcileMeshWorkload         func(clusterName string, obj *discovery_zephyr_solo_io_v1alpha1.MeshWorkload) (reconcile.Result, error)
	OnReconcileMeshWorkloadDeletion func(clusterName string, req reconcile.Request)
}

func (f *MulticlusterMeshWorkloadReconcilerFuncs) ReconcileMeshWorkload(clusterName string, obj *discovery_zephyr_solo_io_v1alpha1.MeshWorkload) (reconcile.Result, error) {
...
func NewMulticlusterMeshWorkloadReconcileLoop(name string, cw multicluster.ClusterWatcher) MulticlusterMeshWorkloadReconcileLoop {
	return &multiclusterMeshWorkloadReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &discovery_zephyr_solo_io_v1alpha1.MeshWorkload{})}
}
...
type MulticlusterMeshReconciler interface {
	ReconcileMesh(clusterName string, obj *discovery_zephyr_solo_io_v1alpha1.Mesh) (reconcile.Result, error)
}
...
type MulticlusterMeshReconcilerFuncs struct {
	OnReconcileMesh         func(clusterName string, obj *discovery_zephyr_solo_io_v1alpha1.Mesh) (reconcile.Result, error)
	OnReconcileMeshDeletion func(clusterName string, req reconcile.Request)
}

func (f *MulticlusterMeshReconcilerFuncs) ReconcileMesh(clusterName string, obj *discovery_zephyr_solo_io_v1alpha1.Mesh) (reconcile.Result, error) {
...
func NewMulticlusterMeshReconcileLoop(name string, cw multicluster.ClusterWatcher) MulticlusterMeshReconcileLoop {
	return &multiclusterMeshReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &discovery_zephyr_solo_io_v1alpha1.Mesh{})}
}
