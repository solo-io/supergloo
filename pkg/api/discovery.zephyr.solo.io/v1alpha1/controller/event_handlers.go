...
type KubernetesClusterEventHandler interface {
	CreateKubernetesCluster(obj *discovery_zephyr_solo_io_v1alpha1.KubernetesCluster) error
	UpdateKubernetesCluster(old, new *discovery_zephyr_solo_io_v1alpha1.KubernetesCluster) error
	DeleteKubernetesCluster(obj *discovery_zephyr_solo_io_v1alpha1.KubernetesCluster) error
	GenericKubernetesCluster(obj *discovery_zephyr_solo_io_v1alpha1.KubernetesCluster) error
}
...
func (f *KubernetesClusterEventHandlerFuncs) CreateKubernetesCluster(obj *discovery_zephyr_solo_io_v1alpha1.KubernetesCluster) error {
	if f.OnCreate == nil {
		return nil
	}
...
func (f *KubernetesClusterEventHandlerFuncs) DeleteKubernetesCluster(obj *discovery_zephyr_solo_io_v1alpha1.KubernetesCluster) error {
	if f.OnDelete == nil {
		return nil
	}
...
func (f *KubernetesClusterEventHandlerFuncs) UpdateKubernetesCluster(objOld, objNew *discovery_zephyr_solo_io_v1alpha1.KubernetesCluster) error {
	if f.OnUpdate == nil {
		return nil
	}
...
func (f *KubernetesClusterEventHandlerFuncs) GenericKubernetesCluster(obj *discovery_zephyr_solo_io_v1alpha1.KubernetesCluster) error {
	if f.OnGeneric == nil {
		return nil
	}
...
func NewKubernetesClusterEventWatcher(name string, mgr manager.Manager) KubernetesClusterEventWatcher {
	return &kubernetesClusterEventWatcher{
		watcher: events.NewWatcher(name, mgr, &discovery_zephyr_solo_io_v1alpha1.KubernetesCluster{}),
	}
}
...
type MeshServiceEventHandler interface {
	CreateMeshService(obj *discovery_zephyr_solo_io_v1alpha1.MeshService) error
	UpdateMeshService(old, new *discovery_zephyr_solo_io_v1alpha1.MeshService) error
	DeleteMeshService(obj *discovery_zephyr_solo_io_v1alpha1.MeshService) error
	GenericMeshService(obj *discovery_zephyr_solo_io_v1alpha1.MeshService) error
}
...
func (f *MeshServiceEventHandlerFuncs) CreateMeshService(obj *discovery_zephyr_solo_io_v1alpha1.MeshService) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *MeshServiceEventHandlerFuncs) DeleteMeshService(obj *discovery_zephyr_solo_io_v1alpha1.MeshService) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *MeshServiceEventHandlerFuncs) UpdateMeshService(objOld, objNew *discovery_zephyr_solo_io_v1alpha1.MeshService) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *MeshServiceEventHandlerFuncs) GenericMeshService(obj *discovery_zephyr_solo_io_v1alpha1.MeshService) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewMeshServiceEventWatcher(name string, mgr manager.Manager) MeshServiceEventWatcher {
	return &meshServiceEventWatcher{
		watcher: events.NewWatcher(name, mgr, &discovery_zephyr_solo_io_v1alpha1.MeshService{}),
	}
}
...
type MeshWorkloadEventHandler interface {
	CreateMeshWorkload(obj *discovery_zephyr_solo_io_v1alpha1.MeshWorkload) error
	UpdateMeshWorkload(old, new *discovery_zephyr_solo_io_v1alpha1.MeshWorkload) error
	DeleteMeshWorkload(obj *discovery_zephyr_solo_io_v1alpha1.MeshWorkload) error
	GenericMeshWorkload(obj *discovery_zephyr_solo_io_v1alpha1.MeshWorkload) error
}
...
func (f *MeshWorkloadEventHandlerFuncs) CreateMeshWorkload(obj *discovery_zephyr_solo_io_v1alpha1.MeshWorkload) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *MeshWorkloadEventHandlerFuncs) DeleteMeshWorkload(obj *discovery_zephyr_solo_io_v1alpha1.MeshWorkload) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *MeshWorkloadEventHandlerFuncs) UpdateMeshWorkload(objOld, objNew *discovery_zephyr_solo_io_v1alpha1.MeshWorkload) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *MeshWorkloadEventHandlerFuncs) GenericMeshWorkload(obj *discovery_zephyr_solo_io_v1alpha1.MeshWorkload) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewMeshWorkloadEventWatcher(name string, mgr manager.Manager) MeshWorkloadEventWatcher {
	return &meshWorkloadEventWatcher{
		watcher: events.NewWatcher(name, mgr, &discovery_zephyr_solo_io_v1alpha1.MeshWorkload{}),
	}
}
...
type MeshEventHandler interface {
	CreateMesh(obj *discovery_zephyr_solo_io_v1alpha1.Mesh) error
	UpdateMesh(old, new *discovery_zephyr_solo_io_v1alpha1.Mesh) error
	DeleteMesh(obj *discovery_zephyr_solo_io_v1alpha1.Mesh) error
	GenericMesh(obj *discovery_zephyr_solo_io_v1alpha1.Mesh) error
}
...
func (f *MeshEventHandlerFuncs) CreateMesh(obj *discovery_zephyr_solo_io_v1alpha1.Mesh) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *MeshEventHandlerFuncs) DeleteMesh(obj *discovery_zephyr_solo_io_v1alpha1.Mesh) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *MeshEventHandlerFuncs) UpdateMesh(objOld, objNew *discovery_zephyr_solo_io_v1alpha1.Mesh) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *MeshEventHandlerFuncs) GenericMesh(obj *discovery_zephyr_solo_io_v1alpha1.Mesh) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewMeshEventWatcher(name string, mgr manager.Manager) MeshEventWatcher {
	return &meshEventWatcher{
		watcher: events.NewWatcher(name, mgr, &discovery_zephyr_solo_io_v1alpha1.Mesh{}),
	}
}
