...
import (
	...
	"github.com/solo-io/service-mesh-hub/pkg/api/discovery.zephyr.solo.io/v1alpha1/clientset/versioned/scheme"
...
// DiscoveryV1alpha1Client is used to interact with features provided by the discovery.zephyr.solo.io group.
type DiscoveryV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DiscoveryV1alpha1Client) KubernetesClusters(namespace string) KubernetesClusterInterface {
	return newKubernetesClusters(c, namespace)
}

func (c *DiscoveryV1alpha1Client) Meshes(namespace string) MeshInterface {
	return newMeshes(c, namespace)
}

func (c *DiscoveryV1alpha1Client) MeshServices(namespace string) MeshServiceInterface {
	return newMeshServices(c, namespace)
}

func (c *DiscoveryV1alpha1Client) MeshWorkloads(namespace string) MeshWorkloadInterface {
