...
var meshesResource = schema.GroupVersionResource{Group: "discovery.zephyr.solo.io", Version: "v1alpha1", Resource: "meshes"}

var meshesKind = schema.GroupVersionKind{Group: "discovery.zephyr.solo.io", Version: "v1alpha1", Kind: "Mesh"}
