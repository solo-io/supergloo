...
func KubeResourceWatch(cache cache.KubeCoreCache, listFunc ResourceListFunc, namespace string, opts clients.WatchOpts) (<-chan resources.ResourceList, <-chan error, error) {
