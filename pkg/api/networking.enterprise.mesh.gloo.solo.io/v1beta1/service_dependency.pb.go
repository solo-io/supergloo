...
type ServiceDependencySpec struct {
	...
	// Required. Select the traffic sources (i.e. Workloads) for this network ServiceDependency.
	...
	// Required. Select the traffic targets (i.e. Destination) for this network ServiceDependency.
...
var file_github_com_solo_io_gloo_mesh_api_enterprise_networking_v1beta1_service_dependency_proto_rawDesc = []byte{
	...
	0x6e, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x22, 0xe4, 0x01, 0x0a, 0x17, 0x53,
...
var file_github_com_solo_io_gloo_mesh_api_enterprise_networking_v1beta1_service_dependency_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
