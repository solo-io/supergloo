...
func (x *SelectedBy) GetMatchers() []*Matcher {
	if x != nil {
		return x.Matchers
	}
	return nil
...
func (x *Matcher) Reset() {
	*x = Matcher{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_api_enterprise_networking_v1beta1_route_table_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Matcher) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_enterprise_networking_v1beta1_route_table_proto_rawDescGZIP(), []int{3}
}
...
var file_github_com_solo_io_gloo_mesh_api_enterprise_networking_v1beta1_route_table_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x22, 0xa0, 0x01, 0x0a, 0x0a, 0x53, 0x65, 0x6c, 0x65,
	0x63, 0x74, 0x65, 0x64, 0x42, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x4c, 0x0a, 0x08,
	0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x30,
	...
	0x52, 0x08, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x73, 0x22, 0x31, 0x0a, 0x07, 0x4d, 0x61,
	0x74, 0x63, 0x68, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74,
	0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x42, 0x5a, 0x5a,
...
var file_github_com_solo_io_gloo_mesh_api_enterprise_networking_v1beta1_route_table_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_github_com_solo_io_gloo_mesh_api_enterprise_networking_v1beta1_route_table_proto_goTypes = []interface{}{
	...
	(*Matcher)(nil),          // 3: networking.enterprise.mesh.gloo.solo.io.Matcher
	(*Route)(nil),            // 4: networking.enterprise.mesh.gloo.solo.io.Route
...
var file_github_com_solo_io_gloo_mesh_api_enterprise_networking_v1beta1_route_table_proto_depIdxs = []int32{
	4, // 0: networking.enterprise.mesh.gloo.solo.io.RouteTableSpec.routes:type_name -> networking.enterprise.mesh.gloo.solo.io.Route
	...
	5, // 2: networking.enterprise.mesh.gloo.solo.io.RouteTableStatus.selected_route_tables:type_name -> core.skv2.solo.io.ObjectRef
	3, // 3: networking.enterprise.mesh.gloo.solo.io.SelectedBy.matchers:type_name -> networking.enterprise.mesh.gloo.solo.io.Matcher
...
func file_github_com_solo_io_gloo_mesh_api_enterprise_networking_v1beta1_route_table_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_mesh_api_enterprise_networking_v1beta1_route_table_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
