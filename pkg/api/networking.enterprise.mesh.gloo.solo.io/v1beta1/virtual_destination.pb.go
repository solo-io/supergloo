...
func (x *VirtualDestinationSpec_Port) GetTargetNumber() string {
...
type VirtualDestinationSpec_Port_TargetNumber struct {
	...
	TargetNumber string `protobuf:"bytes,4,opt,name=target_number,json=targetNumber,proto3,oneof"`
}
...
var file_github_com_solo_io_gloo_mesh_api_enterprise_networking_v1beta1_virtual_destination_proto_rawDesc = []byte{
	...
	0x74, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00,
