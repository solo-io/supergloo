...
func (m *MockMulticlusterVirtualDestinationReconciler) ReconcileVirtualDestination(clusterName string, obj *v1alpha1.VirtualDestination) (reconcile.Result, error) {
	m.ctrl.T.Helper()
