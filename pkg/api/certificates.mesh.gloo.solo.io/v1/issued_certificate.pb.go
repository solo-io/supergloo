...
func (IssuedCertificateStatus_State) EnumDescriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_rawDescGZIP(), []int{3, 0}
}
...
type IssuedCertificateSpec struct {
	...
	CertOptions *v11.CommonCertOptions `protobuf:"bytes,6,opt,name=cert_options,json=certOptions,proto3" json:"cert_options,omitempty"`
...
func (x *IssuedCertificateSpec) GetCertOptions() *v11.CommonCertOptions {
	if x != nil {
...
func (x *IssuedCertificateSpec) GetGlooMeshCa() *GlooMeshCA {
...
func (x *IssuedCertificateSpec) GetAgentCa() *AgentCA {
...
type IssuedCertificateSpec_GlooMeshCa struct {
	...
	GlooMeshCa *GlooMeshCA `protobuf:"bytes,7,opt,name=gloo_mesh_ca,json=glooMeshCa,proto3,oneof"`
}

type IssuedCertificateSpec_AgentCa struct {
	// Agent CA options
	AgentCa *AgentCA `protobuf:"bytes,8,opt,name=agent_ca,json=agentCa,proto3,oneof"`
}
...
type GlooMeshCA struct {
	...
	Signer isGlooMeshCA_Signer `protobuf_oneof:"signer"`
}

func (x *GlooMeshCA) Reset() {
	*x = GlooMeshCA{}
	if protoimpl.UnsafeEnabled {
...
func (x *GlooMeshCA) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GlooMeshCA) ProtoMessage() {}

func (x *GlooMeshCA) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GlooMeshCA.ProtoReflect.Descriptor instead.
func (*GlooMeshCA) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_rawDescGZIP(), []int{1}
}

func (m *GlooMeshCA) GetSigner() isGlooMeshCA_Signer {
	if m != nil {
		return m.Signer
	}
	return nil
...
func (x *GlooMeshCA) GetSigningCertificateSecret() *v1.ObjectRef {
	if x, ok := x.GetSigner().(*GlooMeshCA_SigningCertificateSecret); ok {
		return x.SigningCertificateSecret
	}
	return nil
}

type isGlooMeshCA_Signer interface {
	isGlooMeshCA_Signer()
}

type GlooMeshCA_SigningCertificateSecret struct {
...
func (*GlooMeshCA_SigningCertificateSecret) isGlooMeshCA_Signer() {}

// Set of options which represent the certificate authorities the remote cluster can use
// to sign the intermediate certs
type AgentCA struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	...
	// Types that are assignable to Signer:
	//	*AgentCA_VaultCa
	Signer isAgentCA_Signer `protobuf_oneof:"signer"`
}

func (x *AgentCA) Reset() {
	*x = AgentCA{}
	if protoimpl.UnsafeEnabled {
...
func (x *AgentCA) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AgentCA) ProtoMessage() {}

func (x *AgentCA) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AgentCA.ProtoReflect.Descriptor instead.
func (*AgentCA) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_rawDescGZIP(), []int{2}
}

func (m *AgentCA) GetSigner() isAgentCA_Signer {
	if m != nil {
		return m.Signer
	}
	return nil
...
func (x *AgentCA) GetVaultCa() *v11.VaultCA {
	if x, ok := x.GetSigner().(*AgentCA_VaultCa); ok {
		return x.VaultCa
	}
	return nil
}

type isAgentCA_Signer interface {
	isAgentCA_Signer()
}

type AgentCA_VaultCa struct {
	VaultCa *v11.VaultCA `protobuf:"bytes,1,opt,name=vault_ca,json=vaultCa,proto3,oneof"`
}

func (*AgentCA_VaultCa) isAgentCA_Signer() {}
...
func (*IssuedCertificateStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_rawDescGZIP(), []int{3}
}
...
var file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x1a, 0x3d, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x6f, 0x6c, 0x6f, 0x2d, 0x69, 0x6f, 0x2f,
	0x67, 0x6c, 0x6f, 0x6f, 0x2d, 0x6d, 0x65, 0x73, 0x68, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63,
	0x61, 0x74, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2e, 0x67, 0x69, 0x74, 0x68,
	...
	0xc4, 0x04, 0x0a, 0x15, 0x49, 0x73, 0x73, 0x75, 0x65, 0x64, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66,
	0x69, 0x63, 0x61, 0x74, 0x65, 0x53, 0x70, 0x65, 0x63, 0x12, 0x14, 0x0a, 0x05, 0x68, 0x6f, 0x73,
	...
	0x67, 0x12, 0x5a, 0x0a, 0x1a, 0x73, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x5f, 0x63, 0x65, 0x72,
	...
	,
	...
	0x65, 0x72, 0x74, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x0b, 0x63, 0x65, 0x72, 0x74,
	0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x4e, 0x0a, 0x0c, 0x67, 0x6c, 0x6f, 0x6f, 0x5f,
	0x6d, 0x65, 0x73, 0x68, 0x5f, 0x63, 0x61, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e,
	...
	,
	...
	,
	...
	0x72, 0x76, 0x65, 0x64, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14,
	0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x12, 0x53, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x3d, 0x2e, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74,
	0x65, 0x73, 0x2e, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c,
	0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x49, 0x73, 0x73, 0x75, 0x65, 0x64, 0x43, 0x65, 0x72, 0x74, 0x69,
	0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x53, 0x74, 0x61,
	...
	0x0a, 0x06, 0x49, 0x53, 0x53, 0x55, 0x45, 0x44, 0x10, 0x02, 0x12, 0x0c, 0x0a, 0x08, 0x46, 0x49,
	0x4e, 0x49, 0x53, 0x48, 0x45, 0x44, 0x10, 0x03, 0x12, 0x0a, 0x0a, 0x06, 0x46, 0x41, 0x49, 0x4c,
	0x45, 0x44, 0x10, 0x04, 0x42, 0x4c, 0x5a, 0x46, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_goTypes = []interface{}{
	...
	(*GlooMeshCA)(nil),                 // 2: certificates.mesh.gloo.solo.io.GlooMeshCA
	(*AgentCA)(nil),                    // 3: certificates.mesh.gloo.solo.io.AgentCA
	(*IssuedCertificateStatus)(nil),    // 4: certificates.mesh.gloo.solo.io.IssuedCertificateStatus
	(*v1.ObjectRef)(nil),               // 5: core.skv2.solo.io.ObjectRef
	(*v11.CommonCertOptions)(nil),      // 6: common.mesh.gloo.solo.io.CommonCertOptions
	(*v11.VaultCA)(nil),                // 7: common.mesh.gloo.solo.io.VaultCA
}
var file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_depIdxs = []int32{
	...
	6, // 3: certificates.mesh.gloo.solo.io.IssuedCertificateSpec.cert_options:type_name -> common.mesh.gloo.solo.io.CommonCertOptions
	2, // 4: certificates.mesh.gloo.solo.io.IssuedCertificateSpec.gloo_mesh_ca:type_name -> certificates.mesh.gloo.solo.io.GlooMeshCA
	3, // 5: certificates.mesh.gloo.solo.io.IssuedCertificateSpec.agent_ca:type_name -> certificates.mesh.gloo.solo.io.AgentCA
	5, // 6: certificates.mesh.gloo.solo.io.GlooMeshCA.signing_certificate_secret:type_name -> core.skv2.solo.io.ObjectRef
	7, // 7: certificates.mesh.gloo.solo.io.AgentCA.vault_ca:type_name -> common.mesh.gloo.solo.io.VaultCA
...
func file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_init() {
	...
	file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*GlooMeshCA_SigningCertificateSecret)(nil),
	}
