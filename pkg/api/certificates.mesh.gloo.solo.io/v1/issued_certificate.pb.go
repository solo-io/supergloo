...
type IssuedCertificateSpec struct {
	...
	// common cert options for intermediate certificate
	CommonCertOptions *v1.CommonCertOptions `protobuf:"bytes,7,opt,name=common_cert_options,json=commonCertOptions,proto3" json:"common_cert_options,omitempty"`
	// common cert options for intermediate certificate
	StorageMechanism v1.StorageMechanism `protobuf:"varint,8,opt,name=storage_mechanism,json=storageMechanism,proto3,enum=common.mesh.gloo.solo.io.StorageMechanism" json:"storage_mechanism,omitempty"`
	// Types that are assignable to Signer:
	//	*IssuedCertificateSpec_SigningCertificateSecret
	//	*IssuedCertificateSpec_VaultCa
	Signer isIssuedCertificateSpec_Signer `protobuf_oneof:"signer"`
	...
	IssuedCertificateSecret *v11.ObjectRef `protobuf:"bytes,4,opt,name=issued_certificate_secret,json=issuedCertificateSecret,proto3" json:"issued_certificate_secret,omitempty"`
	...
	PodBounceDirective *v11.ObjectRef `protobuf:"bytes,5,opt,name=pod_bounce_directive,json=podBounceDirective,proto3" json:"pod_bounce_directive,omitempty"`
}
...
func (x *IssuedCertificateSpec) GetCommonCertOptions() *v1.CommonCertOptions {
	if x != nil {
		return x.CommonCertOptions
	}
	return nil
}

func (x *IssuedCertificateSpec) GetStorageMechanism() v1.StorageMechanism {
	if x != nil {
		return x.StorageMechanism
	}
	return v1.StorageMechanism_SECRET
}

func (m *IssuedCertificateSpec) GetSigner() isIssuedCertificateSpec_Signer {
	if m != nil {
		return m.Signer
	}
	return nil
...
func (x *IssuedCertificateSpec) GetSigningCertificateSecret() *v11.ObjectRef {
	if x, ok := x.GetSigner().(*IssuedCertificateSpec_SigningCertificateSecret); ok {
		return x.SigningCertificateSecret
	}
	return nil
}

func (x *IssuedCertificateSpec) GetVaultCa() *v1.VaultCA {
	if x, ok := x.GetSigner().(*IssuedCertificateSpec_VaultCa); ok {
		return x.VaultCa
	}
	return nil
}

func (x *IssuedCertificateSpec) GetIssuedCertificateSecret() *v11.ObjectRef {
	if x != nil {
...
func (x *IssuedCertificateSpec) GetPodBounceDirective() *v11.ObjectRef {
	if x != nil {
...
type isIssuedCertificateSpec_Signer interface {
	isIssuedCertificateSpec_Signer()
}

type IssuedCertificateSpec_SigningCertificateSecret struct {
	...
	SigningCertificateSecret *v11.ObjectRef `protobuf:"bytes,3,opt,name=signing_certificate_secret,json=signingCertificateSecret,proto3,oneof"`
}

type IssuedCertificateSpec_VaultCa struct {
	// The vault_ca config which will be used to sign this intermediate cert
	VaultCa *v1.VaultCA `protobuf:"bytes,6,opt,name=vault_ca,json=vaultCa,proto3,oneof"`
}

func (*IssuedCertificateSpec_SigningCertificateSecret) isIssuedCertificateSpec_Signer() {}

func (*IssuedCertificateSpec_VaultCa) isIssuedCertificateSpec_Signer() {}
...
var file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_rawDesc = []byte{
	...
	0xc7, 0x04, 0x0a, 0x15, 0x49, 0x73, 0x73, 0x75, 0x65, 0x64, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66,
	...
	,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x53, 0x0a, 0x05,
	0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x3d, 0x2e, 0x63, 0x65,
	0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x2e, 0x6d, 0x65, 0x73, 0x68, 0x2e,
	0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x49, 0x73, 0x73,
	...
	0x12, 0x0a, 0x0a, 0x06, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x04, 0x42, 0x4c, 0x5a, 0x46,
...
var file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_goTypes = []interface{}{
	...
	(*v1.CommonCertOptions)(nil),       // 3: common.mesh.gloo.solo.io.CommonCertOptions
	(v1.StorageMechanism)(0),           // 4: common.mesh.gloo.solo.io.StorageMechanism
	(*v11.ObjectRef)(nil),              // 5: core.skv2.solo.io.ObjectRef
	(*v1.VaultCA)(nil),                 // 6: common.mesh.gloo.solo.io.VaultCA
}
var file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_depIdxs = []int32{
	3, // 0: certificates.mesh.gloo.solo.io.IssuedCertificateSpec.common_cert_options:type_name -> common.mesh.gloo.solo.io.CommonCertOptions
	4, // 1: certificates.mesh.gloo.solo.io.IssuedCertificateSpec.storage_mechanism:type_name -> common.mesh.gloo.solo.io.StorageMechanism
	5, // 2: certificates.mesh.gloo.solo.io.IssuedCertificateSpec.signing_certificate_secret:type_name -> core.skv2.solo.io.ObjectRef
	6, // 3: certificates.mesh.gloo.solo.io.IssuedCertificateSpec.vault_ca:type_name -> common.mesh.gloo.solo.io.VaultCA
	5, // 4: certificates.mesh.gloo.solo.io.IssuedCertificateSpec.issued_certificate_secret:type_name -> core.skv2.solo.io.ObjectRef
	5, // 5: certificates.mesh.gloo.solo.io.IssuedCertificateSpec.pod_bounce_directive:type_name -> core.skv2.solo.io.ObjectRef
	0, // 6: certificates.mesh.gloo.solo.io.IssuedCertificateStatus.state:type_name -> certificates.mesh.gloo.solo.io.IssuedCertificateStatus.State
...
func file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_init() {
	...
	file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*IssuedCertificateSpec_SigningCertificateSecret)(nil),
		(*IssuedCertificateSpec_VaultCa)(nil),
	}
	type x struct{}
