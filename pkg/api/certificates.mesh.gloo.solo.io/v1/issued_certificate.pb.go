...
type IssuedCertificateSpec struct {
	...
	State CertificateRotationState `protobuf:"varint,9,opt,name=state,proto3,enum=certificates.mesh.gloo.solo.io.CertificateRotationState" json:"state,omitempty"`
}
...
func (x *IssuedCertificateSpec) GetState() CertificateRotationState {
	if x != nil {
		return x.State
	}
...
type IssuedCertificateStatus struct {
	...
	Rotation *IssuedCertificateStatus_Rotation `protobuf:"bytes,4,opt,name=rotation,proto3" json:"rotation,omitempty"`
}
...
func (x *IssuedCertificateStatus) GetRotation() *IssuedCertificateStatus_Rotation {
	if x != nil {
		return x.Rotation
	}
	return nil
...
type IssuedCertificateStatus_Rotation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to DesiredCertificateAuthority:
	//	*IssuedCertificateStatus_Rotation_DesiredGlooMeshCa
	//	*IssuedCertificateStatus_Rotation_DesiredAgentCa
	DesiredCertificateAuthority isIssuedCertificateStatus_Rotation_DesiredCertificateAuthority `protobuf_oneof:"desired_certificate_authority"`
	// The current state of rotation, this value signals to the cert issuer how to
	// construct the intermediary certs which the data-plane clusters receive
...
func (x *IssuedCertificateStatus_Rotation) Reset() {
	*x = IssuedCertificateStatus_Rotation{}
	if protoimpl.UnsafeEnabled {
...
func (x *IssuedCertificateStatus_Rotation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IssuedCertificateStatus_Rotation) ProtoMessage() {}

func (x *IssuedCertificateStatus_Rotation) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IssuedCertificateStatus_Rotation.ProtoReflect.Descriptor instead.
func (*IssuedCertificateStatus_Rotation) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_rawDescGZIP(), []int{2, 0}
}

func (m *IssuedCertificateStatus_Rotation) GetDesiredCertificateAuthority() isIssuedCertificateStatus_Rotation_DesiredCertificateAuthority {
	if m != nil {
...
func (x *IssuedCertificateStatus_Rotation) GetDesiredGlooMeshCa() *RootCertificateAuthority {
	if x, ok := x.GetDesiredCertificateAuthority().(*IssuedCertificateStatus_Rotation_DesiredGlooMeshCa); ok {
		return x.DesiredGlooMeshCa
	}
	return nil
}

func (x *IssuedCertificateStatus_Rotation) GetDesiredAgentCa() *IntermediateCertificateAuthority {
	if x, ok := x.GetDesiredCertificateAuthority().(*IssuedCertificateStatus_Rotation_DesiredAgentCa); ok {
		return x.DesiredAgentCa
	}
	return nil
}

func (x *IssuedCertificateStatus_Rotation) GetState() CertificateRotationState {
	if x != nil {
		return x.State
	}
	return CertificateRotationState_NOT_APPLICABLE
...
type isIssuedCertificateStatus_Rotation_DesiredCertificateAuthority interface {
	isIssuedCertificateStatus_Rotation_DesiredCertificateAuthority()
}

type IssuedCertificateStatus_Rotation_DesiredGlooMeshCa struct {
	// Gloo Mesh CA options
...
type IssuedCertificateStatus_Rotation_DesiredAgentCa struct {
	// Agent CA options
...
func (*IssuedCertificateStatus_Rotation_DesiredGlooMeshCa) isIssuedCertificateStatus_Rotation_DesiredCertificateAuthority() {
}

func (*IssuedCertificateStatus_Rotation_DesiredAgentCa) isIssuedCertificateStatus_Rotation_DesiredCertificateAuthority() {
}
...
var file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xc1, 0x05, 0x0a, 0x15, 0x49, 0x73, 0x73, 0x75, 0x65, 0x64, 0x43, 0x65,
	...
	0x69, 0x74, 0x79, 0x48, 0x00, 0x52, 0x07, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x43, 0x61, 0x12, 0x4e,
	...
	0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x42, 0x17,
	...
	0x65, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0xb7, 0x05, 0x0a, 0x17,
	...
	0x61, 0x74, 0x65, 0x12, 0x5c, 0x0a, 0x08, 0x72, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63,
	...
	0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x52,
	0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x08, 0x72, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x1a, 0xd6, 0x02, 0x0a, 0x08, 0x52, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x6b,
	0x0a, 0x14, 0x64, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x5f, 0x67, 0x6c, 0x6f, 0x6f, 0x5f, 0x6d,
	0x65, 0x73, 0x68, 0x5f, 0x63, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x38, 0x2e, 0x63,
	...
	,
	...
	0x69, 0x63, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61,
	0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x42, 0x1f, 0x0a, 0x1d, 0x64, 0x65, 0x73,
	0x69, 0x72, 0x65, 0x64, 0x5f, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65,
	0x5f, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0x49, 0x0a, 0x05, 0x53, 0x74,
	...
	0x0a, 0x0a, 0x06, 0x49, 0x53, 0x53, 0x55, 0x45, 0x44, 0x10, 0x02, 0x12, 0x0c, 0x0a, 0x08, 0x46,
	0x49, 0x4e, 0x49, 0x53, 0x48, 0x45, 0x44, 0x10, 0x03, 0x12, 0x0a, 0x0a, 0x06, 0x46, 0x41, 0x49,
	0x4c, 0x45, 0x44, 0x10, 0x04, 0x42, 0x4c, 0x5a, 0x46, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_goTypes = []interface{}{
	...
	(*IssuedCertificateStatus_Rotation)(nil), // 4: certificates.mesh.gloo.solo.io.IssuedCertificateStatus.Rotation
...
var file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_depIdxs = []int32{
	...
	8,  // 6: certificates.mesh.gloo.solo.io.IssuedCertificateSpec.state:type_name -> certificates.mesh.gloo.solo.io.CertificateRotationState
	...
	4,  // 9: certificates.mesh.gloo.solo.io.IssuedCertificateStatus.rotation:type_name -> certificates.mesh.gloo.solo.io.IssuedCertificateStatus.Rotation
	2,  // 10: certificates.mesh.gloo.solo.io.IssuedCertificateStatus.Rotation.desired_gloo_mesh_ca:type_name -> certificates.mesh.gloo.solo.io.RootCertificateAuthority
	7,  // 11: certificates.mesh.gloo.solo.io.IssuedCertificateStatus.Rotation.desired_agent_ca:type_name -> certificates.mesh.gloo.solo.io.IntermediateCertificateAuthority
	8,  // 12: certificates.mesh.gloo.solo.io.IssuedCertificateStatus.Rotation.state:type_name -> certificates.mesh.gloo.solo.io.CertificateRotationState
...
func file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IssuedCertificateStatus_Rotation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_solo_io_gloo_mesh_api_certificates_v1_issued_certificate_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*IssuedCertificateStatus_Rotation_DesiredGlooMeshCa)(nil),
		(*IssuedCertificateStatus_Rotation_DesiredAgentCa)(nil),
	}
	type x struct{}
