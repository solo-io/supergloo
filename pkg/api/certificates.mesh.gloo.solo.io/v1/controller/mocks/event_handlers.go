...
// MockCertificateRotationEventHandler is a mock of CertificateRotationEventHandler interface.
type MockCertificateRotationEventHandler struct {
	ctrl     *gomock.Controller
	recorder *MockCertificateRotationEventHandlerMockRecorder
}

// MockCertificateRotationEventHandlerMockRecorder is the mock recorder for MockCertificateRotationEventHandler.
type MockCertificateRotationEventHandlerMockRecorder struct {
	mock *MockCertificateRotationEventHandler
}

// NewMockCertificateRotationEventHandler creates a new mock instance.
func NewMockCertificateRotationEventHandler(ctrl *gomock.Controller) *MockCertificateRotationEventHandler {
	mock := &MockCertificateRotationEventHandler{ctrl: ctrl}
	mock.recorder = &MockCertificateRotationEventHandlerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCertificateRotationEventHandler) EXPECT() *MockCertificateRotationEventHandlerMockRecorder {
	return m.recorder
}

// CreateCertificateRotation mocks base method.
func (m *MockCertificateRotationEventHandler) CreateCertificateRotation(obj *v1.CertificateRotation) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateCertificateRotation", obj)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateCertificateRotation indicates an expected call of CreateCertificateRotation.
func (mr *MockCertificateRotationEventHandlerMockRecorder) CreateCertificateRotation(obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateCertificateRotation", reflect.TypeOf((*MockCertificateRotationEventHandler)(nil).CreateCertificateRotation), obj)
}

// DeleteCertificateRotation mocks base method.
func (m *MockCertificateRotationEventHandler) DeleteCertificateRotation(obj *v1.CertificateRotation) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteCertificateRotation", obj)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteCertificateRotation indicates an expected call of DeleteCertificateRotation.
func (mr *MockCertificateRotationEventHandlerMockRecorder) DeleteCertificateRotation(obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteCertificateRotation", reflect.TypeOf((*MockCertificateRotationEventHandler)(nil).DeleteCertificateRotation), obj)
}

// GenericCertificateRotation mocks base method.
func (m *MockCertificateRotationEventHandler) GenericCertificateRotation(obj *v1.CertificateRotation) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenericCertificateRotation", obj)
	ret0, _ := ret[0].(error)
	return ret0
}

// GenericCertificateRotation indicates an expected call of GenericCertificateRotation.
func (mr *MockCertificateRotationEventHandlerMockRecorder) GenericCertificateRotation(obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenericCertificateRotation", reflect.TypeOf((*MockCertificateRotationEventHandler)(nil).GenericCertificateRotation), obj)
}

// UpdateCertificateRotation mocks base method.
func (m *MockCertificateRotationEventHandler) UpdateCertificateRotation(old, new *v1.CertificateRotation) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateCertificateRotation", old, new)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateCertificateRotation indicates an expected call of UpdateCertificateRotation.
func (mr *MockCertificateRotationEventHandlerMockRecorder) UpdateCertificateRotation(old, new interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateCertificateRotation", reflect.TypeOf((*MockCertificateRotationEventHandler)(nil).UpdateCertificateRotation), old, new)
}

// MockCertificateRotationEventWatcher is a mock of CertificateRotationEventWatcher interface.
type MockCertificateRotationEventWatcher struct {
	ctrl     *gomock.Controller
	recorder *MockCertificateRotationEventWatcherMockRecorder
}

// MockCertificateRotationEventWatcherMockRecorder is the mock recorder for MockCertificateRotationEventWatcher.
type MockCertificateRotationEventWatcherMockRecorder struct {
	mock *MockCertificateRotationEventWatcher
}

// NewMockCertificateRotationEventWatcher creates a new mock instance.
func NewMockCertificateRotationEventWatcher(ctrl *gomock.Controller) *MockCertificateRotationEventWatcher {
	mock := &MockCertificateRotationEventWatcher{ctrl: ctrl}
	mock.recorder = &MockCertificateRotationEventWatcherMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCertificateRotationEventWatcher) EXPECT() *MockCertificateRotationEventWatcherMockRecorder {
	return m.recorder
}

// AddEventHandler mocks base method.
func (m *MockCertificateRotationEventWatcher) AddEventHandler(ctx context.Context, h controller.CertificateRotationEventHandler, predicates ...predicate.Predicate) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, h}
	for _, a := range predicates {
		varargs = append(varargs, a)
...
// AddEventHandler indicates an expected call of AddEventHandler.
func (mr *MockCertificateRotationEventWatcherMockRecorder) AddEventHandler(ctx, h interface{}, predicates ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, h}, predicates...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddEventHandler", reflect.TypeOf((*MockCertificateRotationEventWatcher)(nil).AddEventHandler), varargs...)
}
