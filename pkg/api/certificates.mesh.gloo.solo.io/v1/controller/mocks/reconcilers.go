...
// MockCertificateRotationReconciler is a mock of CertificateRotationReconciler interface.
type MockCertificateRotationReconciler struct {
	ctrl     *gomock.Controller
	recorder *MockCertificateRotationReconcilerMockRecorder
}

// MockCertificateRotationReconcilerMockRecorder is the mock recorder for MockCertificateRotationReconciler.
type MockCertificateRotationReconcilerMockRecorder struct {
	mock *MockCertificateRotationReconciler
}

// NewMockCertificateRotationReconciler creates a new mock instance.
func NewMockCertificateRotationReconciler(ctrl *gomock.Controller) *MockCertificateRotationReconciler {
	mock := &MockCertificateRotationReconciler{ctrl: ctrl}
	mock.recorder = &MockCertificateRotationReconcilerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCertificateRotationReconciler) EXPECT() *MockCertificateRotationReconcilerMockRecorder {
	return m.recorder
}

// ReconcileCertificateRotation mocks base method.
func (m *MockCertificateRotationReconciler) ReconcileCertificateRotation(obj *v1.CertificateRotation) (reconcile.Result, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReconcileCertificateRotation", obj)
	ret0, _ := ret[0].(reconcile.Result)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ReconcileCertificateRotation indicates an expected call of ReconcileCertificateRotation.
func (mr *MockCertificateRotationReconcilerMockRecorder) ReconcileCertificateRotation(obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReconcileCertificateRotation", reflect.TypeOf((*MockCertificateRotationReconciler)(nil).ReconcileCertificateRotation), obj)
}

// MockCertificateRotationDeletionReconciler is a mock of CertificateRotationDeletionReconciler interface.
type MockCertificateRotationDeletionReconciler struct {
	ctrl     *gomock.Controller
	recorder *MockCertificateRotationDeletionReconcilerMockRecorder
}

// MockCertificateRotationDeletionReconcilerMockRecorder is the mock recorder for MockCertificateRotationDeletionReconciler.
type MockCertificateRotationDeletionReconcilerMockRecorder struct {
	mock *MockCertificateRotationDeletionReconciler
}

// NewMockCertificateRotationDeletionReconciler creates a new mock instance.
func NewMockCertificateRotationDeletionReconciler(ctrl *gomock.Controller) *MockCertificateRotationDeletionReconciler {
	mock := &MockCertificateRotationDeletionReconciler{ctrl: ctrl}
	mock.recorder = &MockCertificateRotationDeletionReconcilerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCertificateRotationDeletionReconciler) EXPECT() *MockCertificateRotationDeletionReconcilerMockRecorder {
	return m.recorder
}

// ReconcileCertificateRotationDeletion mocks base method.
func (m *MockCertificateRotationDeletionReconciler) ReconcileCertificateRotationDeletion(req reconcile.Request) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReconcileCertificateRotationDeletion", req)
	ret0, _ := ret[0].(error)
	return ret0
}

// ReconcileCertificateRotationDeletion indicates an expected call of ReconcileCertificateRotationDeletion.
func (mr *MockCertificateRotationDeletionReconcilerMockRecorder) ReconcileCertificateRotationDeletion(req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReconcileCertificateRotationDeletion", reflect.TypeOf((*MockCertificateRotationDeletionReconciler)(nil).ReconcileCertificateRotationDeletion), req)
}

// MockCertificateRotationFinalizer is a mock of CertificateRotationFinalizer interface.
type MockCertificateRotationFinalizer struct {
	ctrl     *gomock.Controller
	recorder *MockCertificateRotationFinalizerMockRecorder
}

// MockCertificateRotationFinalizerMockRecorder is the mock recorder for MockCertificateRotationFinalizer.
type MockCertificateRotationFinalizerMockRecorder struct {
	mock *MockCertificateRotationFinalizer
}

// NewMockCertificateRotationFinalizer creates a new mock instance.
func NewMockCertificateRotationFinalizer(ctrl *gomock.Controller) *MockCertificateRotationFinalizer {
	mock := &MockCertificateRotationFinalizer{ctrl: ctrl}
	mock.recorder = &MockCertificateRotationFinalizerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCertificateRotationFinalizer) EXPECT() *MockCertificateRotationFinalizerMockRecorder {
	return m.recorder
}

// CertificateRotationFinalizerName mocks base method.
func (m *MockCertificateRotationFinalizer) CertificateRotationFinalizerName() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CertificateRotationFinalizerName")
	ret0, _ := ret[0].(string)
	return ret0
}

// CertificateRotationFinalizerName indicates an expected call of CertificateRotationFinalizerName.
func (mr *MockCertificateRotationFinalizerMockRecorder) CertificateRotationFinalizerName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CertificateRotationFinalizerName", reflect.TypeOf((*MockCertificateRotationFinalizer)(nil).CertificateRotationFinalizerName))
}

// FinalizeCertificateRotation mocks base method.
func (m *MockCertificateRotationFinalizer) FinalizeCertificateRotation(obj *v1.CertificateRotation) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FinalizeCertificateRotation", obj)
	ret0, _ := ret[0].(error)
	return ret0
}

// FinalizeCertificateRotation indicates an expected call of FinalizeCertificateRotation.
func (mr *MockCertificateRotationFinalizerMockRecorder) FinalizeCertificateRotation(obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FinalizeCertificateRotation", reflect.TypeOf((*MockCertificateRotationFinalizer)(nil).FinalizeCertificateRotation), obj)
}

// ReconcileCertificateRotation mocks base method.
func (m *MockCertificateRotationFinalizer) ReconcileCertificateRotation(obj *v1.CertificateRotation) (reconcile.Result, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReconcileCertificateRotation", obj)
	ret0, _ := ret[0].(reconcile.Result)
	ret1, _ := ret[1].(error)
...
// ReconcileCertificateRotation indicates an expected call of ReconcileCertificateRotation.
func (mr *MockCertificateRotationFinalizerMockRecorder) ReconcileCertificateRotation(obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReconcileCertificateRotation", reflect.TypeOf((*MockCertificateRotationFinalizer)(nil).ReconcileCertificateRotation), obj)
}

// MockCertificateRotationReconcileLoop is a mock of CertificateRotationReconcileLoop interface.
type MockCertificateRotationReconcileLoop struct {
	ctrl     *gomock.Controller
	recorder *MockCertificateRotationReconcileLoopMockRecorder
}

// MockCertificateRotationReconcileLoopMockRecorder is the mock recorder for MockCertificateRotationReconcileLoop.
type MockCertificateRotationReconcileLoopMockRecorder struct {
	mock *MockCertificateRotationReconcileLoop
}

// NewMockCertificateRotationReconcileLoop creates a new mock instance.
func NewMockCertificateRotationReconcileLoop(ctrl *gomock.Controller) *MockCertificateRotationReconcileLoop {
	mock := &MockCertificateRotationReconcileLoop{ctrl: ctrl}
	mock.recorder = &MockCertificateRotationReconcileLoopMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCertificateRotationReconcileLoop) EXPECT() *MockCertificateRotationReconcileLoopMockRecorder {
	return m.recorder
}

// RunCertificateRotationReconciler mocks base method.
func (m *MockCertificateRotationReconcileLoop) RunCertificateRotationReconciler(ctx context.Context, rec controller.CertificateRotationReconciler, predicates ...predicate.Predicate) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, rec}
	for _, a := range predicates {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "RunCertificateRotationReconciler", varargs...)
	ret0, _ := ret[0].(error)
	return ret0
}

// RunCertificateRotationReconciler indicates an expected call of RunCertificateRotationReconciler.
func (mr *MockCertificateRotationReconcileLoopMockRecorder) RunCertificateRotationReconciler(ctx, rec interface{}, predicates ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, rec}, predicates...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RunCertificateRotationReconciler", reflect.TypeOf((*MockCertificateRotationReconcileLoop)(nil).RunCertificateRotationReconciler), varargs...)
}
