...
// Package mock_issuer is a generated GoMock package.
package mock_issuer
...
import (
	...
	issuer "github.com/solo-io/gloo-mesh/pkg/api/certificates.mesh.gloo.solo.io/issuer/input/issuer"
...
func (m *MockBuilder) BuildSnapshot(ctx context.Context, name string, opts issuer.BuildOptions) (issuer.Snapshot, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BuildSnapshot", ctx, name, opts)
	ret0, _ := ret[0].(issuer.Snapshot)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
