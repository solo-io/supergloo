...
import (
	...
	agent "github.com/solo-io/gloo-mesh/pkg/api/certificates.mesh.gloo.solo.io/agent/input/agent"
...
func (m *MockBuilder) BuildSnapshot(ctx context.Context, name string, opts agent.BuildOptions) (agent.Snapshot, error) {
	m.ctrl.T.Helper()
