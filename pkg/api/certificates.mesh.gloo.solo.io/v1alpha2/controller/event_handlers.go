...
type IssuedCertificateEventHandler interface {
	CreateIssuedCertificate(obj *certificates_mesh_gloo_solo_io_v1alpha2.IssuedCertificate) error
	UpdateIssuedCertificate(old, new *certificates_mesh_gloo_solo_io_v1alpha2.IssuedCertificate) error
	DeleteIssuedCertificate(obj *certificates_mesh_gloo_solo_io_v1alpha2.IssuedCertificate) error
	GenericIssuedCertificate(obj *certificates_mesh_gloo_solo_io_v1alpha2.IssuedCertificate) error
}

type IssuedCertificateEventHandlerFuncs struct {
	OnCreate  func(obj *certificates_mesh_gloo_solo_io_v1alpha2.IssuedCertificate) error
	OnUpdate  func(old, new *certificates_mesh_gloo_solo_io_v1alpha2.IssuedCertificate) error
	OnDelete  func(obj *certificates_mesh_gloo_solo_io_v1alpha2.IssuedCertificate) error
	OnGeneric func(obj *certificates_mesh_gloo_solo_io_v1alpha2.IssuedCertificate) error
}
...
func NewIssuedCertificateEventWatcher(name string, mgr manager.Manager) IssuedCertificateEventWatcher {
	return &issuedCertificateEventWatcher{
		watcher: events.NewWatcher(name, mgr, &certificates_mesh_gloo_solo_io_v1alpha2.IssuedCertificate{}),
	}
}
...
func (h genericIssuedCertificateHandler) Update(old, new runtime.Object) error {
	...
	objNew, ok := new.(*certificates_mesh_gloo_solo_io_v1alpha2.IssuedCertificate)
	if !ok {
...
type CertificateRequestEventHandler interface {
	CreateCertificateRequest(obj *certificates_mesh_gloo_solo_io_v1alpha2.CertificateRequest) error
	UpdateCertificateRequest(old, new *certificates_mesh_gloo_solo_io_v1alpha2.CertificateRequest) error
	DeleteCertificateRequest(obj *certificates_mesh_gloo_solo_io_v1alpha2.CertificateRequest) error
	GenericCertificateRequest(obj *certificates_mesh_gloo_solo_io_v1alpha2.CertificateRequest) error
}

type CertificateRequestEventHandlerFuncs struct {
	OnCreate  func(obj *certificates_mesh_gloo_solo_io_v1alpha2.CertificateRequest) error
	OnUpdate  func(old, new *certificates_mesh_gloo_solo_io_v1alpha2.CertificateRequest) error
	OnDelete  func(obj *certificates_mesh_gloo_solo_io_v1alpha2.CertificateRequest) error
	OnGeneric func(obj *certificates_mesh_gloo_solo_io_v1alpha2.CertificateRequest) error
}
...
func NewCertificateRequestEventWatcher(name string, mgr manager.Manager) CertificateRequestEventWatcher {
	return &certificateRequestEventWatcher{
		watcher: events.NewWatcher(name, mgr, &certificates_mesh_gloo_solo_io_v1alpha2.CertificateRequest{}),
	}
}
...
func (h genericCertificateRequestHandler) Update(old, new runtime.Object) error {
	...
	objNew, ok := new.(*certificates_mesh_gloo_solo_io_v1alpha2.CertificateRequest)
	if !ok {
...
type PodBounceDirectiveEventHandler interface {
	CreatePodBounceDirective(obj *certificates_mesh_gloo_solo_io_v1alpha2.PodBounceDirective) error
	UpdatePodBounceDirective(old, new *certificates_mesh_gloo_solo_io_v1alpha2.PodBounceDirective) error
	DeletePodBounceDirective(obj *certificates_mesh_gloo_solo_io_v1alpha2.PodBounceDirective) error
	GenericPodBounceDirective(obj *certificates_mesh_gloo_solo_io_v1alpha2.PodBounceDirective) error
}

type PodBounceDirectiveEventHandlerFuncs struct {
	OnCreate  func(obj *certificates_mesh_gloo_solo_io_v1alpha2.PodBounceDirective) error
	OnUpdate  func(old, new *certificates_mesh_gloo_solo_io_v1alpha2.PodBounceDirective) error
	OnDelete  func(obj *certificates_mesh_gloo_solo_io_v1alpha2.PodBounceDirective) error
	OnGeneric func(obj *certificates_mesh_gloo_solo_io_v1alpha2.PodBounceDirective) error
}
...
func NewPodBounceDirectiveEventWatcher(name string, mgr manager.Manager) PodBounceDirectiveEventWatcher {
	return &podBounceDirectiveEventWatcher{
		watcher: events.NewWatcher(name, mgr, &certificates_mesh_gloo_solo_io_v1alpha2.PodBounceDirective{}),
	}
}
...
func (h genericPodBounceDirectiveHandler) Update(old, new runtime.Object) error {
	...
	objNew, ok := new.(*certificates_mesh_gloo_solo_io_v1alpha2.PodBounceDirective)
	if !ok {
