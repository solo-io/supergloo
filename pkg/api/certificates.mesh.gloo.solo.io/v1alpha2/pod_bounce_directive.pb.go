...
func (*PodBounceDirectiveStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_certificates_pod_bounce_directive_proto_rawDescGZIP(), []int{1}
}
...
type PodBounceDirectiveSpec_PodSelector struct {
	...
	// Whether to wait for the namespace's istio-ca-root-cert configmap to align with the mesh's new root cert.
	// This is used to ensure that the Istio control plane has propagated new certs before restarting
	// data plane pods.
	WaitForCertUpdate bool `protobuf:"varint,4,opt,name=wait_for_cert_update,json=waitForCertUpdate,proto3" json:"wait_for_cert_update,omitempty"`
	// Wait for the control plane to have synced all root cert configmaps in data plane namespaces before
	// bouncing these pods.
	RootCertSync *PodBounceDirectiveSpec_PodSelector_RootCertSync `protobuf:"bytes,5,opt,name=root_cert_sync,json=rootCertSync,proto3" json:"root_cert_sync,omitempty"`
}

func (x *PodBounceDirectiveSpec_PodSelector) Reset() {
	*x = PodBounceDirectiveSpec_PodSelector{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_api_certificates_pod_bounce_directive_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *PodBounceDirectiveSpec_PodSelector) GetWaitForCertUpdate() bool {
	if x != nil {
		return x.WaitForCertUpdate
	}
	return false
}
...
func (x *PodBounceDirectiveSpec_PodSelector_RootCertSync) Reset() {
	*x = PodBounceDirectiveSpec_PodSelector_RootCertSync{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_api_certificates_pod_bounce_directive_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PodBounceDirectiveSpec_PodSelector_RootCertSync) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_certificates_pod_bounce_directive_proto_rawDescGZIP(), []int{0, 0, 1}
}
...
func (x *PodBounceDirectiveStatus_BouncedPodSet) Reset() {
	*x = PodBounceDirectiveStatus_BouncedPodSet{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_api_certificates_pod_bounce_directive_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PodBounceDirectiveStatus_BouncedPodSet) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_certificates_pod_bounce_directive_proto_rawDescGZIP(), []int{1, 0}
}
...
var file_github_com_solo_io_gloo_mesh_api_certificates_pod_bounce_directive_proto_rawDesc = []byte{
	...
	0xfe, 0x05, 0x0a, 0x16, 0x50, 0x6f, 0x64, 0x42, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x44, 0x69, 0x72,
	...
	0x75, 0x6e, 0x63, 0x65, 0x1a, 0xf9, 0x04, 0x0a, 0x0b, 0x50, 0x6f, 0x64, 0x53, 0x65, 0x6c, 0x65,
	...
	,
...
var file_github_com_solo_io_gloo_mesh_api_certificates_pod_bounce_directive_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
func file_github_com_solo_io_gloo_mesh_api_certificates_pod_bounce_directive_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_mesh_api_certificates_pod_bounce_directive_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_api_certificates_pod_bounce_directive_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_api_certificates_pod_bounce_directive_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
