...
import (
	v1alpha1 "github.com/solo-io/mesh-projects/pkg/api/config.zephyr.solo.io/v1alpha1/clientset/versioned/typed/config.zephyr.solo.io/v1alpha1"
...
func (c *FakeConfigV1alpha1) SecurityRules(namespace string) v1alpha1.SecurityRuleInterface {
