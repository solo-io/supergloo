...
import (
	...
	"github.com/solo-io/mesh-projects/pkg/api/config.zephyr.solo.io/v1alpha1/clientset/versioned/scheme"
...
func (c *ConfigV1alpha1Client) RoutingRules(namespace string) RoutingRuleInterface {
	return newRoutingRules(c, namespace)
}

func (c *ConfigV1alpha1Client) SecurityRules(namespace string) SecurityRuleInterface {
