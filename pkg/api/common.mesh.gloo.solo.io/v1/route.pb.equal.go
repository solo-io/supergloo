...
// Equal function
func (m *Route_RouteAction_Destinations) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*Route_RouteAction_Destinations)
	if !ok {
		that2, ok := that.(Route_RouteAction_Destinations)
		if ok {
			target = &that2
		} else {
			return false
	...
	if h, ok := interface{}(m.GetDestinationOptions()).(equality.Equalizer); ok {
		if !h.Equal(target.GetDestinationOptions()) {
			return false
		}
	} else {
		if !proto.Equal(m.GetDestinationOptions(), target.GetDestinationOptions()) {
			return false
		}
	}
	...
	case *Route_RouteAction_Destinations_Static:
		if _, ok := target.DestinationType.(*Route_RouteAction_Destinations_Static); !ok {
			return false
		}
	...
	case *Route_RouteAction_Destinations_Virtual:
		if _, ok := target.DestinationType.(*Route_RouteAction_Destinations_Virtual); !ok {
			return false
		}
	...
	case *Route_RouteAction_Destinations_Kube:
		if _, ok := target.DestinationType.(*Route_RouteAction_Destinations_Kube); !ok {
			return false
		}
	...
	case *Route_RouteAction_Destinations_ClusterHeader:
		if _, ok := target.DestinationType.(*Route_RouteAction_Destinations_ClusterHeader); !ok {
			return false
		}
...
// Equal function
func (m *Route_RouteAction_Destinations_DestinationOptions) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*Route_RouteAction_Destinations_DestinationOptions)
	if !ok {
		that2, ok := that.(Route_RouteAction_Destinations_DestinationOptions)
		if ok {
			target = &that2
		} else {
			return false
	...
	if strings.Compare(m.GetHeaderModification(), target.GetHeaderModification()) != 0 {
		return false
	}
