...
type XdsConfigReconciler interface {
    ReconcileXdsConfig(obj *xds_enterprise_agent_mesh_gloo_solo_io_v1alpha1.XdsConfig) (reconcile.Result, error)
}
...
type XdsConfigReconcilerFuncs struct {
    OnReconcileXdsConfig func(obj *xds_enterprise_agent_mesh_gloo_solo_io_v1alpha1.XdsConfig) (reconcile.Result, error)
    OnReconcileXdsConfigDeletion func(req reconcile.Request) error
}

func (f *XdsConfigReconcilerFuncs) ReconcileXdsConfig(obj *xds_enterprise_agent_mesh_gloo_solo_io_v1alpha1.XdsConfig) (reconcile.Result, error) {
...
type XdsConfigFinalizer interface {
    ...
    FinalizeXdsConfig(obj *xds_enterprise_agent_mesh_gloo_solo_io_v1alpha1.XdsConfig) error
}
...
func NewXdsConfigReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) XdsConfigReconcileLoop {
    return &xdsConfigReconcileLoop{
        ...
        loop: reconcile.NewLoop(name, "", mgr, &xds_enterprise_agent_mesh_gloo_solo_io_v1alpha1.XdsConfig{}, options),
    }
}
