...
type multiClusterReconciler interface {
	...
	discovery_mesh_gloo_solo_io_v1alpha2_controllers.MulticlusterTrafficTargetReconciler
	discovery_mesh_gloo_solo_io_v1alpha2_controllers.MulticlusterWorkloadReconciler
	discovery_mesh_gloo_solo_io_v1alpha2_controllers.MulticlusterMeshReconciler

	networking_mesh_gloo_solo_io_v1alpha2_controllers.MulticlusterTrafficPolicyReconciler
	networking_mesh_gloo_solo_io_v1alpha2_controllers.MulticlusterAccessPolicyReconciler
...
func RegisterMultiClusterReconciler(
	...
	discovery_mesh_gloo_solo_io_v1alpha2_controllers.NewMulticlusterTrafficTargetReconcileLoop("TrafficTarget", clusters, options.TrafficTargets).AddMulticlusterTrafficTargetReconciler(ctx, r, predicates...)

	discovery_mesh_gloo_solo_io_v1alpha2_controllers.NewMulticlusterWorkloadReconcileLoop("Workload", clusters, options.Workloads).AddMulticlusterWorkloadReconciler(ctx, r, predicates...)

	discovery_mesh_gloo_solo_io_v1alpha2_controllers.NewMulticlusterMeshReconcileLoop("Mesh", clusters, options.Meshes).AddMulticlusterMeshReconciler(ctx, r, predicates...)

	networking_mesh_gloo_solo_io_v1alpha2_controllers.NewMulticlusterTrafficPolicyReconcileLoop("TrafficPolicy", clusters, options.TrafficPolicies).AddMulticlusterTrafficPolicyReconciler(ctx, r, predicates...)

	networking_mesh_gloo_solo_io_v1alpha2_controllers.NewMulticlusterAccessPolicyReconcileLoop("AccessPolicy", clusters, options.AccessPolicies).AddMulticlusterAccessPolicyReconciler(ctx, r, predicates...)
...
type singleClusterReconciler interface {
	...
	discovery_mesh_gloo_solo_io_v1alpha2_controllers.TrafficTargetReconciler
	discovery_mesh_gloo_solo_io_v1alpha2_controllers.WorkloadReconciler
	discovery_mesh_gloo_solo_io_v1alpha2_controllers.MeshReconciler

	networking_mesh_gloo_solo_io_v1alpha2_controllers.TrafficPolicyReconciler
	networking_mesh_gloo_solo_io_v1alpha2_controllers.AccessPolicyReconciler
...
func RegisterSingleClusterReconciler(
	...
	if err := discovery_mesh_gloo_solo_io_v1alpha2_controllers.NewTrafficTargetReconcileLoop("TrafficTarget", mgr, options).RunTrafficTargetReconciler(ctx, r, predicates...); err != nil {
		return nil, err
	}
	if err := discovery_mesh_gloo_solo_io_v1alpha2_controllers.NewWorkloadReconcileLoop("Workload", mgr, options).RunWorkloadReconciler(ctx, r, predicates...); err != nil {
		return nil, err
	}
	if err := discovery_mesh_gloo_solo_io_v1alpha2_controllers.NewMeshReconcileLoop("Mesh", mgr, options).RunMeshReconciler(ctx, r, predicates...); err != nil {
		return nil, err
	}

	if err := networking_mesh_gloo_solo_io_v1alpha2_controllers.NewTrafficPolicyReconcileLoop("TrafficPolicy", mgr, options).RunTrafficPolicyReconciler(ctx, r, predicates...); err != nil {
		return nil, err
	}
	if err := networking_mesh_gloo_solo_io_v1alpha2_controllers.NewAccessPolicyReconcileLoop("AccessPolicy", mgr, options).RunAccessPolicyReconciler(ctx, r, predicates...); err != nil {
		return nil, err
	}
	...
	if err := networking_mesh_gloo_solo_io_v1alpha2_controllers.NewFailoverServiceReconcileLoop("FailoverService", mgr, options).RunFailoverServiceReconciler(ctx, r, predicates...); err != nil {
		return nil, err
	}
