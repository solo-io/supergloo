...
func (m *MockBuilder) BuildSnapshot(ctx context.Context, name string, opts networking.BuildOptions) (networking.Snapshot, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BuildSnapshot", ctx, name, opts)
	ret0, _ := ret[0].(networking.Snapshot)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
