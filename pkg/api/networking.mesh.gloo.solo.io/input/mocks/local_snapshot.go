...
func (m *MockLocalSnapshot) VirtualServices() v1beta2sets.VirtualServiceSet {
	m.ctrl.T.Helper()
...
func (mr *MockLocalSnapshotMockRecorder) VirtualServices() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VirtualServices", reflect.TypeOf((*MockLocalSnapshot)(nil).VirtualServices))
}

// VirtualRouters mocks base method
func (m *MockLocalSnapshot) VirtualRouters() v1beta2sets.VirtualRouterSet {
	m.ctrl.T.Helper()
...
func (mr *MockLocalSnapshotMockRecorder) VirtualRouters() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VirtualRouters", reflect.TypeOf((*MockLocalSnapshot)(nil).VirtualRouters))
}
