...
func (m *MockRemoteSnapshot) AppmeshK8SAwsv1Beta2VirtualServices() v1beta2sets.VirtualServiceSet {
	m.ctrl.T.Helper()
...
func (mr *MockRemoteSnapshotMockRecorder) AppmeshK8SAwsv1Beta2VirtualServices() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AppmeshK8SAwsv1Beta2VirtualServices", reflect.TypeOf((*MockRemoteSnapshot)(nil).AppmeshK8SAwsv1Beta2VirtualServices))
}
...
func (m *MockRemoteSnapshot) AppmeshK8SAwsv1Beta2VirtualRouters() v1beta2sets.VirtualRouterSet {
	m.ctrl.T.Helper()
...
func (mr *MockRemoteSnapshotMockRecorder) AppmeshK8SAwsv1Beta2VirtualRouters() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AppmeshK8SAwsv1Beta2VirtualRouters", reflect.TypeOf((*MockRemoteSnapshot)(nil).AppmeshK8SAwsv1Beta2VirtualRouters))
}
