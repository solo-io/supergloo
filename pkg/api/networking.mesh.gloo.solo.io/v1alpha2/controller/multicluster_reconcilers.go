...
type MulticlusterTrafficPolicyReconcilerFuncs struct {
	OnReconcileTrafficPolicy         func(clusterName string, obj *networking_mesh_gloo_solo_io_v1alpha2.TrafficPolicy) (reconcile.Result, error)
...
func NewMulticlusterTrafficPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterTrafficPolicyReconcileLoop {
	return &multiclusterTrafficPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_mesh_gloo_solo_io_v1alpha2.TrafficPolicy{}, options)}
}
...
type MulticlusterAccessPolicyReconcilerFuncs struct {
	OnReconcileAccessPolicy         func(clusterName string, obj *networking_mesh_gloo_solo_io_v1alpha2.AccessPolicy) (reconcile.Result, error)
...
func NewMulticlusterAccessPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterAccessPolicyReconcileLoop {
	return &multiclusterAccessPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_mesh_gloo_solo_io_v1alpha2.AccessPolicy{}, options)}
}
...
type MulticlusterVirtualMeshReconcilerFuncs struct {
	OnReconcileVirtualMesh         func(clusterName string, obj *networking_mesh_gloo_solo_io_v1alpha2.VirtualMesh) (reconcile.Result, error)
...
func NewMulticlusterVirtualMeshReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterVirtualMeshReconcileLoop {
	return &multiclusterVirtualMeshReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_mesh_gloo_solo_io_v1alpha2.VirtualMesh{}, options)}
}
...
type MulticlusterFailoverServiceReconcilerFuncs struct {
	OnReconcileFailoverService         func(clusterName string, obj *networking_mesh_gloo_solo_io_v1alpha2.FailoverService) (reconcile.Result, error)
...
func NewMulticlusterFailoverServiceReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterFailoverServiceReconcileLoop {
	return &multiclusterFailoverServiceReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_mesh_gloo_solo_io_v1alpha2.FailoverService{}, options)}
}
