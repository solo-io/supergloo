...
func (f *TrafficPolicyReconcilerFuncs) ReconcileTrafficPolicy(obj *networking_mesh_gloo_solo_io_v1.TrafficPolicy) (reconcile.Result, error) {
...
func NewTrafficPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) TrafficPolicyReconcileLoop {
    return &trafficPolicyReconcileLoop{
        ...
        loop: reconcile.NewLoop(name, "", mgr, &networking_mesh_gloo_solo_io_v1.TrafficPolicy{}, options),
    }
}
...
func (f *AccessPolicyReconcilerFuncs) ReconcileAccessPolicy(obj *networking_mesh_gloo_solo_io_v1.AccessPolicy) (reconcile.Result, error) {
...
func NewAccessPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) AccessPolicyReconcileLoop {
    return &accessPolicyReconcileLoop{
    	// empty cluster indicates this reconciler is built for the local cluster
        loop: reconcile.NewLoop(name, "", mgr, &networking_mesh_gloo_solo_io_v1.AccessPolicy{}, options),
    }
}
...
func (f *VirtualMeshReconcilerFuncs) ReconcileVirtualMesh(obj *networking_mesh_gloo_solo_io_v1.VirtualMesh) (reconcile.Result, error) {
...
func NewVirtualMeshReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) VirtualMeshReconcileLoop {
    return &virtualMeshReconcileLoop{
    	// empty cluster indicates this reconciler is built for the local cluster
        loop: reconcile.NewLoop(name, "", mgr, &networking_mesh_gloo_solo_io_v1.VirtualMesh{}, options),
    }
}
