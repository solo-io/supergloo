...
func (f *MulticlusterTrafficPolicyReconcilerFuncs) ReconcileTrafficPolicy(clusterName string, obj *networking_mesh_gloo_solo_io_v1.TrafficPolicy) (reconcile.Result, error) {
...
func NewMulticlusterTrafficPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterTrafficPolicyReconcileLoop {
	return &multiclusterTrafficPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_mesh_gloo_solo_io_v1.TrafficPolicy{}, options)}
}
...
func (f *MulticlusterAccessPolicyReconcilerFuncs) ReconcileAccessPolicy(clusterName string, obj *networking_mesh_gloo_solo_io_v1.AccessPolicy) (reconcile.Result, error) {
...
func NewMulticlusterAccessPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterAccessPolicyReconcileLoop {
	return &multiclusterAccessPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_mesh_gloo_solo_io_v1.AccessPolicy{}, options)}
}
...
func (f *MulticlusterVirtualMeshReconcilerFuncs) ReconcileVirtualMesh(clusterName string, obj *networking_mesh_gloo_solo_io_v1.VirtualMesh) (reconcile.Result, error) {
...
func NewMulticlusterVirtualMeshReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterVirtualMeshReconcileLoop {
	return &multiclusterVirtualMeshReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_mesh_gloo_solo_io_v1.VirtualMesh{}, options)}
}
