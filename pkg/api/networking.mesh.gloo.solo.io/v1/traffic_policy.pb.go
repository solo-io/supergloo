...
type TrafficPolicySpec struct {
	...
	// TrafficPolicies select the same VirtualHost or Route, then the older
	...
	GatewaySelector []*TrafficPolicySpec_GatewaySelector `protobuf:"bytes,5,rep,name=gateway_selector,json=gatewaySelector,proto3" json:"gateway_selector,omitempty"`
...
func (x *TrafficPolicySpec) GetGatewaySelector() []*TrafficPolicySpec_GatewaySelector {
	if x != nil {
...
type TrafficPolicySpec_GatewaySelector struct {
	...
	// Specify the VirtualHosts the TrafficPolicy will apply to.
	// If omitted, all VirtualHosts are selected by default.
	VirtualHosts []*v11.ObjectRef `protobuf:"bytes,1,rep,name=virtual_hosts,json=virtualHosts,proto3" json:"virtual_hosts,omitempty"`
	// Map of labels to match. All labels listed here must be
	// present on a route for that route to be selected.
	//If omitted, all routes on the selected VirtualHosts are selected.
	RouteLabelMatcher map[string]string `protobuf:"bytes,2,rep,name=route_label_matcher,json=routeLabelMatcher,proto3" json:"route_label_matcher,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *TrafficPolicySpec_GatewaySelector) Reset() {
	*x = TrafficPolicySpec_GatewaySelector{}
	if protoimpl.UnsafeEnabled {
...
func (x *TrafficPolicySpec_GatewaySelector) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TrafficPolicySpec_GatewaySelector) ProtoMessage() {}
...
// Deprecated: Use TrafficPolicySpec_GatewaySelector.ProtoReflect.Descriptor instead.
func (*TrafficPolicySpec_GatewaySelector) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_networking_v1_traffic_policy_proto_rawDescGZIP(), []int{0, 1}
}

func (x *TrafficPolicySpec_GatewaySelector) GetVirtualHosts() []*v11.ObjectRef {
	if x != nil {
...
func (x *TrafficPolicySpec_GatewaySelector) GetRouteLabelMatcher() map[string]string {
	if x != nil {
