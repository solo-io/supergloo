...
var file_github_com_solo_io_gloo_mesh_api_networking_v1_virtual_mesh_proto_rawDesc = []byte{
	...
	0x79, 0x22, 0x8d, 0x05, 0x0a, 0x11, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x4d, 0x65, 0x73,
	...
	0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x5c, 0x0a, 0x0a, 0x63,
	0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x3c, 0x2e, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x2e, 0x6d,
	...
	0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x67, 0x0a, 0x0b, 0x4d, 0x65, 0x73,
...
var file_github_com_solo_io_gloo_mesh_api_networking_v1_virtual_mesh_proto_goTypes = []interface{}{
	...
	(v11.CertificateRotationMethod)(0),                // 17: certificates.mesh.gloo.solo.io.CertificateRotationMethod
...
var file_github_com_solo_io_gloo_mesh_api_networking_v1_virtual_mesh_proto_depIdxs = []int32{
	...
	7,  // 14: networking.mesh.gloo.solo.io.VirtualMeshSpec.MTLSConfig.limited:type_name -> networking.mesh.gloo.solo.io.VirtualMeshSpec.MTLSConfig.LimitedTrust
	16, // 15: networking.mesh.gloo.solo.io.VirtualMeshSpec.MTLSConfig.rotation_verification_method:type_name -> certificates.mesh.gloo.solo.io.CertificateRotationVerificationMethod
	17, // 16: networking.mesh.gloo.solo.io.VirtualMeshSpec.MTLSConfig.rotation_method:type_name -> certificates.mesh.gloo.solo.io.CertificateRotationMethod
	18, // 17: networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.east_west_ingress_gateway_selectors:type_name -> common.mesh.gloo.solo.io.IngressGatewaySelector
	8,  // 18: networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.selectors:type_name -> networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.FederationSelector
	19, // 19: networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.permissive:type_name -> google.protobuf.Empty
	20, // 20: networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.tcp_keepalive:type_name -> common.mesh.gloo.solo.io.TCPKeepalive
	21, // 21: networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.FederationSelector.destination_selectors:type_name -> common.mesh.gloo.solo.io.DestinationSelector
	11, // 22: networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.FederationSelector.meshes:type_name -> core.skv2.solo.io.ObjectRef
	22, // 23: networking.mesh.gloo.solo.io.VirtualMeshStatus.MeshesEntry.value:type_name -> networking.mesh.gloo.solo.io.ApprovalStatus
	22, // 24: networking.mesh.gloo.solo.io.VirtualMeshStatus.DestinationsEntry.value:type_name -> networking.mesh.gloo.solo.io.ApprovalStatus
