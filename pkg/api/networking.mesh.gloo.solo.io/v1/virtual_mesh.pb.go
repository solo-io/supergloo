...
type VirtualMeshSpec_Federation struct {
	...
	TcpKeepalive *VirtualMeshSpec_Federation_TCPKeepalive `protobuf:"bytes,5,opt,name=tcp_keepalive,json=tcpKeepalive,proto3" json:"tcp_keepalive,omitempty"`
}
...
func (x *VirtualMeshSpec_Federation) GetTcpKeepalive() *VirtualMeshSpec_Federation_TCPKeepalive {
	if x != nil {
...
// Specify a keepalive rule for all destinations associated with this VirtualMesh
type VirtualMeshSpec_Federation_TCPKeepalive struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *VirtualMeshSpec_Federation_TCPKeepalive) Reset() {
	*x = VirtualMeshSpec_Federation_TCPKeepalive{}
	if protoimpl.UnsafeEnabled {
...
func (x *VirtualMeshSpec_Federation_TCPKeepalive) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VirtualMeshSpec_Federation_TCPKeepalive) ProtoMessage() {}

func (x *VirtualMeshSpec_Federation_TCPKeepalive) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_mesh_api_networking_v1_virtual_mesh_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VirtualMeshSpec_Federation_TCPKeepalive.ProtoReflect.Descriptor instead.
func (*VirtualMeshSpec_Federation_TCPKeepalive) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_networking_v1_virtual_mesh_proto_rawDescGZIP(), []int{0, 1, 1}
}

func (x *VirtualMeshSpec_Federation_TCPKeepalive) GetProbes() uint32 {
	if x != nil {
		return x.Probes
	}
	return 0
...
func (x *VirtualMeshSpec_Federation_TCPKeepalive) GetTime() *duration.Duration {
	if x != nil {
		return x.Time
	}
	return nil
...
func (x *VirtualMeshSpec_Federation_TCPKeepalive) GetInterval() *duration.Duration {
	if x != nil {
		return x.Interval
	}
	return nil
...
var file_github_com_solo_io_gloo_mesh_api_networking_v1_virtual_mesh_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xe9, 0x0a, 0x0a, 0x0f, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x4d, 0x65, 0x73,
	...
	0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x1a, 0xb1, 0x05, 0x0a, 0x0a, 0x46, 0x65, 0x64, 0x65, 0x72,
	...
	0x53, 0x75, 0x66, 0x66, 0x69, 0x78, 0x12, 0x6a, 0x0a, 0x0d, 0x74, 0x63, 0x70, 0x5f, 0x6b, 0x65,
	0x65, 0x70, 0x61, 0x6c, 0x69, 0x76, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x45, 0x2e,
	...
	0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x54, 0x43, 0x50, 0x4b, 0x65, 0x65, 0x70, 0x61,
	0x6c, 0x69, 0x76, 0x65, 0x52, 0x0c, 0x74, 0x63, 0x70, 0x4b, 0x65, 0x65, 0x70, 0x61, 0x6c, 0x69,
	0x76, 0x65, 0x1a, 0xae, 0x01, 0x0a, 0x12, 0x46, 0x65, 0x64, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x68, 0x65, 0x73, 0x1a, 0x8c, 0x01, 0x0a, 0x0c, 0x54, 0x43, 0x50, 0x4b, 0x65, 0x65, 0x70, 0x61,
	...
	0x61, 0x6c, 0x42, 0x06, 0x0a, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x22, 0x41, 0x0a, 0x12, 0x47, 0x6c,
	0x6f, 0x62, 0x61, 0x6c, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	...
	0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0xaf, 0x04, 0x0a, 0x11, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61,
	...
	0x79, 0x52, 0x0c, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a,
...
var file_github_com_solo_io_gloo_mesh_api_networking_v1_virtual_mesh_proto_goTypes = []interface{}{
	...
	(*VirtualMeshSpec_Federation_TCPKeepalive)(nil),       // 9: networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.TCPKeepalive
...
var file_github_com_solo_io_gloo_mesh_api_networking_v1_virtual_mesh_proto_depIdxs = []int32{
	...
	9,  // 16: networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.tcp_keepalive:type_name -> networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.TCPKeepalive
	...
	18, // 19: networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.TCPKeepalive.time:type_name -> google.protobuf.Duration
	18, // 20: networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.TCPKeepalive.interval:type_name -> google.protobuf.Duration
...
func file_github_com_solo_io_gloo_mesh_api_networking_v1_virtual_mesh_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_mesh_api_networking_v1_virtual_mesh_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VirtualMeshSpec_Federation_TCPKeepalive); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
