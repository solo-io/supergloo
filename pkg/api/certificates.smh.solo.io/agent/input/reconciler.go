...
func RegisterMultiClusterReconciler(
	...
	certificates_smh_solo_io_v1alpha2_controllers.NewMulticlusterPodBounceDirectiveReconcileLoop("PodBounceDirective", clusters).AddMulticlusterPodBounceDirectiveReconciler(ctx, r, predicates...)
...
func RegisterSingleClusterReconciler(
	...
	if err := certificates_smh_solo_io_v1alpha2_controllers.NewPodBounceDirectiveReconcileLoop("PodBounceDirective", mgr, reconcile.Options{}).RunPodBounceDirectiveReconciler(ctx, r, predicates...); err != nil {
		return err
	}
