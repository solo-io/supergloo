...
type MulticlusterIssuedCertificateReconciler interface {
	ReconcileIssuedCertificate(clusterName string, obj *certificates_smh_solo_io_v1alpha2.IssuedCertificate) (reconcile.Result, error)
}
...
type MulticlusterIssuedCertificateReconcilerFuncs struct {
	OnReconcileIssuedCertificate         func(clusterName string, obj *certificates_smh_solo_io_v1alpha2.IssuedCertificate) (reconcile.Result, error)
	OnReconcileIssuedCertificateDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterIssuedCertificateReconcilerFuncs) ReconcileIssuedCertificate(clusterName string, obj *certificates_smh_solo_io_v1alpha2.IssuedCertificate) (reconcile.Result, error) {
...
type MulticlusterCertificateRequestReconciler interface {
	ReconcileCertificateRequest(clusterName string, obj *certificates_smh_solo_io_v1alpha2.CertificateRequest) (reconcile.Result, error)
}
...
type MulticlusterCertificateRequestReconcilerFuncs struct {
	OnReconcileCertificateRequest         func(clusterName string, obj *certificates_smh_solo_io_v1alpha2.CertificateRequest) (reconcile.Result, error)
	OnReconcileCertificateRequestDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterCertificateRequestReconcilerFuncs) ReconcileCertificateRequest(clusterName string, obj *certificates_smh_solo_io_v1alpha2.CertificateRequest) (reconcile.Result, error) {
