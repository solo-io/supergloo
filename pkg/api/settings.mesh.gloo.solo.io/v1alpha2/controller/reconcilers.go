...
type SettingsReconciler interface {
	ReconcileSettings(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) (reconcile.Result, error)
}
...
type SettingsReconcilerFuncs struct {
	OnReconcileSettings         func(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) (reconcile.Result, error)
	OnReconcileSettingsDeletion func(req reconcile.Request) error
}

func (f *SettingsReconcilerFuncs) ReconcileSettings(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) (reconcile.Result, error) {
...
type SettingsFinalizer interface {
	...
	FinalizeSettings(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) error
}
...
func NewSettingsReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) SettingsReconcileLoop {
	return &settingsReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &settings_mesh_gloo_solo_io_v1alpha2.Settings{}, options),
	}
}
