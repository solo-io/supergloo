...
type SettingsEventHandler interface {
	CreateSettings(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) error
	UpdateSettings(old, new *settings_mesh_gloo_solo_io_v1alpha2.Settings) error
	DeleteSettings(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) error
	GenericSettings(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) error
}

type SettingsEventHandlerFuncs struct {
	OnCreate  func(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) error
	OnUpdate  func(old, new *settings_mesh_gloo_solo_io_v1alpha2.Settings) error
	OnDelete  func(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) error
	OnGeneric func(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) error
}

func (f *SettingsEventHandlerFuncs) CreateSettings(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) error {
	if f.OnCreate == nil {
		return nil
	}
...
func (f *SettingsEventHandlerFuncs) DeleteSettings(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) error {
	if f.OnDelete == nil {
		return nil
	}
...
func (f *SettingsEventHandlerFuncs) UpdateSettings(objOld, objNew *settings_mesh_gloo_solo_io_v1alpha2.Settings) error {
	if f.OnUpdate == nil {
		return nil
	}
...
func (f *SettingsEventHandlerFuncs) GenericSettings(obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) error {
	if f.OnGeneric == nil {
		return nil
	}
...
func NewSettingsEventWatcher(name string, mgr manager.Manager) SettingsEventWatcher {
	return &settingsEventWatcher{
		watcher: events.NewWatcher(name, mgr, &settings_mesh_gloo_solo_io_v1alpha2.Settings{}),
	}
}
...
func (h genericSettingsHandler) Update(old, new runtime.Object) error {
	...
	objNew, ok := new.(*settings_mesh_gloo_solo_io_v1alpha2.Settings)
	if !ok {
