...
type MulticlusterSettingsReconciler interface {
	ReconcileSettings(clusterName string, obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) (reconcile.Result, error)
}
...
type MulticlusterSettingsReconcilerFuncs struct {
	OnReconcileSettings         func(clusterName string, obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) (reconcile.Result, error)
	OnReconcileSettingsDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterSettingsReconcilerFuncs) ReconcileSettings(clusterName string, obj *settings_mesh_gloo_solo_io_v1alpha2.Settings) (reconcile.Result, error) {
...
func NewMulticlusterSettingsReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterSettingsReconcileLoop {
	return &multiclusterSettingsReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &settings_mesh_gloo_solo_io_v1alpha2.Settings{}, options)}
}
