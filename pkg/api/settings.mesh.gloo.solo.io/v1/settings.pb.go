...
var file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_rawDesc = []byte{
	...
	0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x73, 0x22, 0xfe, 0x01, 0x0a, 0x11, 0x44, 0x61, 0x73, 0x68,
	...
	0x75, 0x74, 0x68, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x1a, 0x8b, 0x01, 0x0a, 0x0a, 0x41,
	...
	0x08, 0x0a, 0x06, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x22, 0x98, 0x01, 0x0a, 0x0e, 0x53, 0x65,
...
var file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_goTypes = []interface{}{
	...
	(v12.ApprovalState)(0),                   // 25: common.mesh.gloo.solo.io.ApprovalState
...
var file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_depIdxs = []int32{
	...
	16, // 8: settings.mesh.gloo.solo.io.SessionConfig.cookie_options:type_name -> settings.mesh.gloo.solo.io.SessionConfig.CookieOptions
	14, // 9: settings.mesh.gloo.solo.io.SessionConfig.cookie:type_name -> settings.mesh.gloo.solo.io.SessionConfig.CookieSession
	15, // 10: settings.mesh.gloo.solo.io.SessionConfig.redis:type_name -> settings.mesh.gloo.solo.io.SessionConfig.RedisSession
	22, // 11: settings.mesh.gloo.solo.io.OidcConfig.client_secret:type_name -> core.skv2.solo.io.ObjectRef
	17, // 12: settings.mesh.gloo.solo.io.OidcConfig.auth_endpoint_query_params:type_name -> settings.mesh.gloo.solo.io.OidcConfig.AuthEndpointQueryParamsEntry
	18, // 13: settings.mesh.gloo.solo.io.OidcConfig.token_endpoint_query_params:type_name -> settings.mesh.gloo.solo.io.OidcConfig.TokenEndpointQueryParamsEntry
	19, // 14: settings.mesh.gloo.solo.io.OidcConfig.header:type_name -> settings.mesh.gloo.solo.io.OidcConfig.HeaderConfig
	20, // 15: settings.mesh.gloo.solo.io.OidcConfig.discovery_override:type_name -> settings.mesh.gloo.solo.io.OidcConfig.DiscoveryOverride
	23, // 16: settings.mesh.gloo.solo.io.OidcConfig.discovery_poll_interval:type_name -> google.protobuf.Duration
	7,  // 17: settings.mesh.gloo.solo.io.OidcConfig.jwks_cache_refresh_policy:type_name -> settings.mesh.gloo.solo.io.JwksOnDemandCacheRefreshPolicy
	24, // 18: settings.mesh.gloo.solo.io.JwksOnDemandCacheRefreshPolicy.never:type_name -> google.protobuf.Empty
	24, // 19: settings.mesh.gloo.solo.io.JwksOnDemandCacheRefreshPolicy.always:type_name -> google.protobuf.Empty
	25, // 20: settings.mesh.gloo.solo.io.SettingsStatus.state:type_name -> common.mesh.gloo.solo.io.ApprovalState
	10, // 21: settings.mesh.gloo.solo.io.DiscoverySettings.Istio.ingress_gateway_detectors:type_name -> settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetectorsEntry
	11, // 22: settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetectorsEntry.value:type_name -> settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetector
	12, // 23: settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetector.gateway_workload_labels:type_name -> settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetector.GatewayWorkloadLabelsEntry
	26, // 24: settings.mesh.gloo.solo.io.DashboardSettings.AuthConfig.name:type_name -> google.protobuf.StringValue
	6,  // 25: settings.mesh.gloo.solo.io.DashboardSettings.AuthConfig.oidc:type_name -> settings.mesh.gloo.solo.io.OidcConfig
	27, // 26: settings.mesh.gloo.solo.io.SessionConfig.CookieOptions.max_age:type_name -> google.protobuf.UInt32Value
	26, // 27: settings.mesh.gloo.solo.io.SessionConfig.CookieOptions.path:type_name -> google.protobuf.StringValue
