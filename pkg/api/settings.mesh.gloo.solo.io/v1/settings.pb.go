...
// Configure system-wide settings and defaults. Settings specified in networking
// policies take precedence over those specified here.
type SettingsSpec struct {
	...
	// Configure Gloo Mesh networking to communicate with one or more external
	// gRPC NetworkingExtensions servers. Updates will be applied by the servers
	// in the order they are listed (servers towards the end of the list take
	// precedence). Note: Extension Servers have full write access to the output
	// objects written by Gloo Mesh.
	...
	// Enable and configure use of Relay mode to communicate with remote
	// clusters. This is an enterprise-only feature.
...
// RelaySettings contains options for configuring Gloo Mesh to use Relay for
// cluster management. Relay provides a way for connecting Gloo Mesh to remote
// Kubernetes Clusters without the need to share credentials and access to
// remote Kube API Servers from the management cluster (the Gloo Mesh
// controllers).
//
...
//
// Architecturally, it includes a Relay-agent which is installed to remote Kube
// clusters at registration time, which then connects directly to the Relay
// Server in the management cluster. to push its discovery data and pull its
// mesh configuration.
//
//
// To configure Gloo Mesh to use Relay, make sure to read the
// [relay installation guide]({{< versioned_link_path
// fromRoot="/guides/setup/install_gloo_mesh" >}}) and [relay cluster
// registration guide]({{< versioned_link_path
// fromRoot="/guides/setup/register_cluster" >}}).
type RelaySettings struct {
	...
	// If relay is enabled, make sure to follow the [relay cluster registration
	// guide]({{< versioned_link_path
	// fromRoot="/guides/setup/register_cluster#relay" >}}) for registering your
	// clusters.
	Enabled bool `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	// Connection info for the Relay Server. Gloo Mesh will fetch discovery
	// resources from this server and push translated outputs to this server.
	// Note: currently this field has no effect as the relay server runs
	// in-process of the networking Pod.
...
type GrpcServer struct {
	...
	// If true Gloo Mesh will automatically attempt to reconnect to the server
	// after encountering network failures.
...
type SettingsStatus struct {
	...
	// Mesh has not processed the most recent version of this resource.
...
type DashboardSettings struct {
	...
	//	*DashboardSettings_None
	//	*DashboardSettings_Oidc
	AuthConfig isDashboardSettings_AuthConfig `protobuf_oneof:"auth_config"`
}
...
func (m *DashboardSettings) GetAuthConfig() isDashboardSettings_AuthConfig {
	if m != nil {
		return m.AuthConfig
	}
	return nil
...
func (x *DashboardSettings) GetNone() *DashboardSettings_NoAuth {
	if x, ok := x.GetAuthConfig().(*DashboardSettings_None); ok {
		return x.None
	}
	return nil
}

func (x *DashboardSettings) GetOidc() *DashboardSettings_OidcConfig {
	if x, ok := x.GetAuthConfig().(*DashboardSettings_Oidc); ok {
		return x.Oidc
	}
	return nil
}

type isDashboardSettings_AuthConfig interface {
	isDashboardSettings_AuthConfig()
}

type DashboardSettings_None struct {
	None *DashboardSettings_NoAuth `protobuf:"bytes,1,opt,name=none,proto3,oneof"`
}

type DashboardSettings_Oidc struct {
	Oidc *DashboardSettings_OidcConfig `protobuf:"bytes,2,opt,name=oidc,proto3,oneof"`
}

func (*DashboardSettings_None) isDashboardSettings_AuthConfig() {}

func (*DashboardSettings_Oidc) isDashboardSettings_AuthConfig() {}
...
type DiscoverySettings_Istio struct {
	...
	// Configure discovery of ingress gateways per cluster. The key to the
	// map is either a Gloo Mesh cluster name or
	// `*` denoting all clusters. If an entry is found for a given cluster,
	// it will be used. Otherwise, the wildcard entry will be used if it
	// exists. Lastly, we will fall back to a set of default values.
...
type DiscoverySettings_Istio_IngressGatewayDetector struct {
	...
	// deployment. If not specified, will default to `{"istio":
	// "ingressgateway"}`.
	...
	// The name of the TLS port used to detect ingress gateways.
	// Kubernetes services must have a port with this name in order to
	// be recognized as an ingress gateway. If not specified, will
	// default to `tls`.
...
func (x *DashboardSettings_SessionConfig) Reset() {
	*x = DashboardSettings_SessionConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type DashboardSettings_OidcConfig struct {
	...
	JwksCacheRefreshPolicy *DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy `protobuf:"bytes,13,opt,name=jwks_cache_refresh_policy,json=jwksCacheRefreshPolicy,proto3" json:"jwks_cache_refresh_policy,omitempty"`
}
...
func (x *DashboardSettings_OidcConfig) GetJwksCacheRefreshPolicy() *DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy {
	if x != nil {
...
func (*DashboardSettings_SessionConfig_CookieSession) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_rawDescGZIP(), []int{5, 0, 0}
}
...
func (*DashboardSettings_SessionConfig_RedisSession) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_rawDescGZIP(), []int{5, 0, 1}
}
...
func (*DashboardSettings_SessionConfig_CookieOptions) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_rawDescGZIP(), []int{5, 0, 2}
}
...
func (x *DashboardSettings_OidcConfig_HeaderConfig) Reset() {
	*x = DashboardSettings_OidcConfig_HeaderConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_msgTypes[18]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DashboardSettings_OidcConfig_HeaderConfig) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_rawDescGZIP(), []int{5, 2, 2}
}
...
func (*DashboardSettings_OidcConfig_DiscoveryOverride) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_rawDescGZIP(), []int{5, 2, 3}
}
...
type DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to Policy:
	//	*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Never
	//	*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Always
	//	*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_MaxIdpReqPerPollingInterval
	Policy isDashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Policy `protobuf_oneof:"policy"`
}

func (x *DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy) Reset() {
	*x = DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy{}
	if protoimpl.UnsafeEnabled {
...
func (x *DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy) ProtoMessage() {}

func (x *DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy.ProtoReflect.Descriptor instead.
func (*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_rawDescGZIP(), []int{5, 2, 4}
}

func (m *DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy) GetPolicy() isDashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Policy {
	if m != nil {
		return m.Policy
	}
	return nil
...
func (x *DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy) GetNever() *empty.Empty {
	if x, ok := x.GetPolicy().(*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Never); ok {
		return x.Never
	}
	return nil
}

func (x *DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy) GetAlways() *empty.Empty {
	if x, ok := x.GetPolicy().(*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Always); ok {
		return x.Always
	}
	return nil
}

func (x *DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy) GetMaxIdpReqPerPollingInterval() uint32 {
	if x, ok := x.GetPolicy().(*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_MaxIdpReqPerPollingInterval); ok {
		return x.MaxIdpReqPerPollingInterval
	}
	return 0
}

type isDashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Policy interface {
	isDashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Policy()
}

type DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Never struct {
...
type DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Always struct {
...
type DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_MaxIdpReqPerPollingInterval struct {
	// If a key is not in the cache, fetch the most recent keys from
...
func (*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Never) isDashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Policy() {
}

func (*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Always) isDashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Policy() {
}

func (*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_MaxIdpReqPerPollingInterval) isDashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Policy() {
}
...
var file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_rawDesc = []byte{
	...
	0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x73, 0x22, 0x98, 0x01, 0x0a, 0x0e, 0x53, 0x65, 0x74, 0x74,
	0x69, 0x6e, 0x67, 0x73, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2f, 0x0a, 0x13, 0x6f, 0x62,
	...
	0x72, 0x73, 0x22, 0xf5, 0x13, 0x0a, 0x11, 0x44, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64,
	0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x4a, 0x0a, 0x04, 0x6e, 0x6f, 0x6e, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67,
	...
	0x74, 0x69, 0x6e, 0x67, 0x73, 0x2e, 0x4e, 0x6f, 0x41, 0x75, 0x74, 0x68, 0x48, 0x00, 0x52, 0x04,
	0x6e, 0x6f, 0x6e, 0x65, 0x12, 0x4e, 0x0a, 0x04, 0x6f, 0x69, 0x64, 0x63, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x38, 0x2e, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x2e, 0x6d, 0x65,
	...
	0x73, 0x2e, 0x4f, 0x69, 0x64, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x00, 0x52, 0x04,
	0x6f, 0x69, 0x64, 0x63, 0x1a, 0xa6, 0x04, 0x0a, 0x0d, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x70, 0x0a, 0x0e, 0x63, 0x6f, 0x6f, 0x6b, 0x69, 0x65,
	...
	,
	...
	0x69, 0x6e, 0x42, 0x09, 0x0a, 0x07, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x1a, 0x08, 0x0a,
	0x06, 0x4e, 0x6f, 0x41, 0x75, 0x74, 0x68, 0x1a, 0x81, 0x0e, 0x0a, 0x0a, 0x4f, 0x69, 0x64, 0x63,
	...
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x66, 0x52, 0x0c, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	...
	0x65, 0x72, 0x55, 0x72, 0x6c, 0x12, 0x92, 0x01, 0x0a, 0x1a, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x65,
	0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x5f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f, 0x70, 0x61,
	0x72, 0x61, 0x6d, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x55, 0x2e, 0x73, 0x65, 0x74,
	0x74, 0x69, 0x6e, 0x67, 0x73, 0x2e, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e,
	...
	0x75, 0x65, 0x72, 0x79, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x95, 0x01, 0x0a, 0x1b, 0x74,
	...
	0x32, 0x56, 0x2e, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x2e, 0x6d, 0x65, 0x73, 0x68,
	...
	0x4f, 0x69, 0x64, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x6d, 0x73, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x70, 0x70, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x70, 0x70, 0x55, 0x72, 0x6c, 0x12, 0x23, 0x0a, 0x0d, 0x63,
	0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x07, 0x20, 0x01,
	...
	,
	...
	0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x12, 0x92, 0x01, 0x0a, 0x19, 0x6a, 0x77, 0x6b, 0x73, 0x5f,
	0x63, 0x61, 0x63, 0x68, 0x65, 0x5f, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x5f, 0x70, 0x6f,
	0x6c, 0x69, 0x63, 0x79, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x57, 0x2e, 0x73, 0x65, 0x74,
	0x74, 0x69, 0x6e, 0x67, 0x73, 0x2e, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e,
	0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x44, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72,
	0x64, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x2e, 0x4f, 0x69, 0x64, 0x63, 0x43, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4a, 0x77, 0x6b, 0x73, 0x4f, 0x6e, 0x44, 0x65, 0x6d, 0x61, 0x6e,
	...
	0x66, 0x72, 0x65, 0x73, 0x68, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x1a, 0x4a, 0x0a, 0x1c, 0x41,
	...
	0x3a, 0x02, 0x38, 0x01, 0x1a, 0x66, 0x0a, 0x0c, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x43, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x12, 0x26, 0x0a, 0x0f, 0x69, 0x64, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x1a, 0xb4, 0x02, 0x0a,
	...
	0x69, 0x6d, 0x73, 0x1a, 0xd5, 0x01, 0x0a, 0x1e, 0x4a, 0x77, 0x6b, 0x73, 0x4f, 0x6e, 0x44, 0x65,
	...
	0x6c, 0x42, 0x08, 0x0a, 0x06, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x42, 0x0d, 0x0a, 0x0b, 0x61,
	0x75, 0x74, 0x68, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x48, 0x5a, 0x42, 0x67, 0x69,
...
var file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_goTypes = []interface{}{
	...
	(*DashboardSettings)(nil),       // 5: settings.mesh.gloo.solo.io.DashboardSettings
	(*DiscoverySettings_Istio)(nil), // 6: settings.mesh.gloo.solo.io.DiscoverySettings.Istio
	nil,                             // 7: settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetectorsEntry
	(*DiscoverySettings_Istio_IngressGatewayDetector)(nil), // 8: settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetector
	nil,                                     // 9: settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetector.GatewayWorkloadLabelsEntry
	(*DashboardSettings_SessionConfig)(nil), // 10: settings.mesh.gloo.solo.io.DashboardSettings.SessionConfig
	(*DashboardSettings_NoAuth)(nil),        // 11: settings.mesh.gloo.solo.io.DashboardSettings.NoAuth
	(*DashboardSettings_OidcConfig)(nil),    // 12: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig
	(*DashboardSettings_SessionConfig_CookieSession)(nil), // 13: settings.mesh.gloo.solo.io.DashboardSettings.SessionConfig.CookieSession
	(*DashboardSettings_SessionConfig_RedisSession)(nil),  // 14: settings.mesh.gloo.solo.io.DashboardSettings.SessionConfig.RedisSession
	(*DashboardSettings_SessionConfig_CookieOptions)(nil), // 15: settings.mesh.gloo.solo.io.DashboardSettings.SessionConfig.CookieOptions
	nil, // 16: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.AuthEndpointQueryParamsEntry
	nil, // 17: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.TokenEndpointQueryParamsEntry
	(*DashboardSettings_OidcConfig_HeaderConfig)(nil),                   // 18: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.HeaderConfig
	(*DashboardSettings_OidcConfig_DiscoveryOverride)(nil),              // 19: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.DiscoveryOverride
	(*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy)(nil), // 20: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.JwksOnDemandCacheRefreshPolicy
	(*v1.TrafficPolicySpec_Policy_MTLS)(nil),                            // 21: networking.mesh.gloo.solo.io.TrafficPolicySpec.Policy.MTLS
	(v11.ApprovalState)(0),                                              // 22: common.mesh.gloo.solo.io.ApprovalState
	(*v12.ObjectRef)(nil),                                               // 23: core.skv2.solo.io.ObjectRef
...
var file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_depIdxs = []int32{
	...
	5,  // 4: settings.mesh.gloo.solo.io.SettingsSpec.dashboard:type_name -> settings.mesh.gloo.solo.io.DashboardSettings
	3,  // 5: settings.mesh.gloo.solo.io.RelaySettings.server:type_name -> settings.mesh.gloo.solo.io.GrpcServer
	6,  // 6: settings.mesh.gloo.solo.io.DiscoverySettings.istio:type_name -> settings.mesh.gloo.solo.io.DiscoverySettings.Istio
	22, // 7: settings.mesh.gloo.solo.io.SettingsStatus.state:type_name -> common.mesh.gloo.solo.io.ApprovalState
	11, // 8: settings.mesh.gloo.solo.io.DashboardSettings.none:type_name -> settings.mesh.gloo.solo.io.DashboardSettings.NoAuth
	12, // 9: settings.mesh.gloo.solo.io.DashboardSettings.oidc:type_name -> settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig
	7,  // 10: settings.mesh.gloo.solo.io.DiscoverySettings.Istio.ingress_gateway_detectors:type_name -> settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetectorsEntry
	8,  // 11: settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetectorsEntry.value:type_name -> settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetector
	9,  // 12: settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetector.gateway_workload_labels:type_name -> settings.mesh.gloo.solo.io.DiscoverySettings.Istio.IngressGatewayDetector.GatewayWorkloadLabelsEntry
	15, // 13: settings.mesh.gloo.solo.io.DashboardSettings.SessionConfig.cookie_options:type_name -> settings.mesh.gloo.solo.io.DashboardSettings.SessionConfig.CookieOptions
	13, // 14: settings.mesh.gloo.solo.io.DashboardSettings.SessionConfig.cookie:type_name -> settings.mesh.gloo.solo.io.DashboardSettings.SessionConfig.CookieSession
	14, // 15: settings.mesh.gloo.solo.io.DashboardSettings.SessionConfig.redis:type_name -> settings.mesh.gloo.solo.io.DashboardSettings.SessionConfig.RedisSession
	23, // 16: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.client_secret:type_name -> core.skv2.solo.io.ObjectRef
	16, // 17: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.auth_endpoint_query_params:type_name -> settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.AuthEndpointQueryParamsEntry
	17, // 18: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.token_endpoint_query_params:type_name -> settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.TokenEndpointQueryParamsEntry
	18, // 19: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.header:type_name -> settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.HeaderConfig
	19, // 20: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.discovery_override:type_name -> settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.DiscoveryOverride
	24, // 21: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.discovery_poll_interval:type_name -> google.protobuf.Duration
	20, // 22: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.jwks_cache_refresh_policy:type_name -> settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.JwksOnDemandCacheRefreshPolicy
	25, // 23: settings.mesh.gloo.solo.io.DashboardSettings.SessionConfig.CookieOptions.max_age:type_name -> google.protobuf.UInt32Value
	26, // 24: settings.mesh.gloo.solo.io.DashboardSettings.SessionConfig.CookieOptions.path:type_name -> google.protobuf.StringValue
	27, // 25: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.JwksOnDemandCacheRefreshPolicy.never:type_name -> google.protobuf.Empty
	27, // 26: settings.mesh.gloo.solo.io.DashboardSettings.OidcConfig.JwksOnDemandCacheRefreshPolicy.always:type_name -> google.protobuf.Empty
...
func file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*DashboardSettings_None)(nil),
		(*DashboardSettings_Oidc)(nil),
	}
	file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_msgTypes[10].OneofWrappers = []interface{}{
		(*DashboardSettings_SessionConfig_Cookie)(nil),
		(*DashboardSettings_SessionConfig_Redis)(nil),
	}
	file_github_com_solo_io_gloo_mesh_api_settings_v1_settings_proto_msgTypes[20].OneofWrappers = []interface{}{
		(*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Never)(nil),
		(*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_Always)(nil),
		(*DashboardSettings_OidcConfig_JwksOnDemandCacheRefreshPolicy_MaxIdpReqPerPollingInterval)(nil),
	}
	type x struct{}
