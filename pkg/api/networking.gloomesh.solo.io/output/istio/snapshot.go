...
func partitionIssuedCertificatesByLabel(labelKey string, set certificates_gloomesh_solo_io_v1alpha2_sets.IssuedCertificateSet) ([]LabeledIssuedCertificateSet, error) {
	setsByLabel := map[string]certificates_gloomesh_solo_io_v1alpha2_sets.IssuedCertificateSet{}
	...
	for _, obj := range set.List() {
		...
		if !ok {
			setForValue = certificates_gloomesh_solo_io_v1alpha2_sets.NewIssuedCertificateSet()
...
func partitionPodBounceDirectivesByLabel(labelKey string, set certificates_gloomesh_solo_io_v1alpha2_sets.PodBounceDirectiveSet) ([]LabeledPodBounceDirectiveSet, error) {
	setsByLabel := map[string]certificates_gloomesh_solo_io_v1alpha2_sets.PodBounceDirectiveSet{}
	...
	for _, obj := range set.List() {
		...
		setForValue, ok := setsByLabel[labelValue]
		if !ok {
			setForValue = certificates_gloomesh_solo_io_v1alpha2_sets.NewPodBounceDirectiveSet()
			setsByLabel[labelValue] = setForValue
		}
		setForValue.Insert(obj)
	}
...
func (s snapshot) MarshalJSON() ([]byte, error) {
	...
	issuedCertificateSet := certificates_gloomesh_solo_io_v1alpha2_sets.NewIssuedCertificateSet()
	...
	podBounceDirectiveSet := certificates_gloomesh_solo_io_v1alpha2_sets.NewPodBounceDirectiveSet()
...
type LabeledIssuedCertificateSet interface {
	...
	Set() certificates_gloomesh_solo_io_v1alpha2_sets.IssuedCertificateSet
...
func NewLabeledIssuedCertificateSet(set certificates_gloomesh_solo_io_v1alpha2_sets.IssuedCertificateSet, labels map[string]string) (LabeledIssuedCertificateSet, error) {
...
func (l *labeledIssuedCertificateSet) Set() certificates_gloomesh_solo_io_v1alpha2_sets.IssuedCertificateSet {
	return l.set
}
...
func (l labeledIssuedCertificateSet) Generic() output.ResourceList {
	...
	listFunc := func(ctx context.Context, cli client.Client) ([]ezkube.Object, error) {
		var list certificates_gloomesh_solo_io_v1alpha2.IssuedCertificateList
...
type LabeledPodBounceDirectiveSet interface {
	...
	Set() certificates_gloomesh_solo_io_v1alpha2_sets.PodBounceDirectiveSet
...
func NewLabeledPodBounceDirectiveSet(set certificates_gloomesh_solo_io_v1alpha2_sets.PodBounceDirectiveSet, labels map[string]string) (LabeledPodBounceDirectiveSet, error) {
...
func (l *labeledPodBounceDirectiveSet) Set() certificates_gloomesh_solo_io_v1alpha2_sets.PodBounceDirectiveSet {
	return l.set
}
...
func (l labeledPodBounceDirectiveSet) Generic() output.ResourceList {
	...
	// enable list func for garbage collection
	listFunc := func(ctx context.Context, cli client.Client) ([]ezkube.Object, error) {
		var list certificates_gloomesh_solo_io_v1alpha2.PodBounceDirectiveList
		if err := cli.List(ctx, &list, client.MatchingLabels(l.labels)); err != nil {
			return nil, err
		}
		var items []ezkube.Object
...
type Builder interface {
	...
	AddIssuedCertificates(issuedCertificates ...*certificates_gloomesh_solo_io_v1alpha2.IssuedCertificate)

	// get the collected IssuedCertificates
	GetIssuedCertificates() certificates_gloomesh_solo_io_v1alpha2_sets.IssuedCertificateSet

	// add PodBounceDirectives to the collected outputs
	AddPodBounceDirectives(podBounceDirectives ...*certificates_gloomesh_solo_io_v1alpha2.PodBounceDirective)

	// get the collected PodBounceDirectives
	GetPodBounceDirectives() certificates_gloomesh_solo_io_v1alpha2_sets.PodBounceDirectiveSet
...
func (b *builder) AddIssuedCertificates(issuedCertificates ...*certificates_gloomesh_solo_io_v1alpha2.IssuedCertificate) {
...
func (b *builder) AddPodBounceDirectives(podBounceDirectives ...*certificates_gloomesh_solo_io_v1alpha2.PodBounceDirective) {
...
func (b *builder) GetIssuedCertificates() certificates_gloomesh_solo_io_v1alpha2_sets.IssuedCertificateSet {
	return b.issuedCertificates
}
func (b *builder) GetPodBounceDirectives() certificates_gloomesh_solo_io_v1alpha2_sets.PodBounceDirectiveSet {
