...
// MulticlusterClientset for the networking.gloomesh.solo.io/v1alpha2 APIs
...
// clienset for the networking.gloomesh.solo.io/v1alpha2 APIs
type Clientset interface {
	// clienset for the networking.gloomesh.solo.io/v1alpha2/v1alpha2 APIs
