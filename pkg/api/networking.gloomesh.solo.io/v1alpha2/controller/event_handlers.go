...
type TrafficPolicyEventHandler interface {
	CreateTrafficPolicy(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error
	UpdateTrafficPolicy(old, new *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error
	DeleteTrafficPolicy(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error
	GenericTrafficPolicy(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error
}

type TrafficPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error
	OnUpdate  func(old, new *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error
	OnDelete  func(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error
	OnGeneric func(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error
}

func (f *TrafficPolicyEventHandlerFuncs) CreateTrafficPolicy(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
...
func (f *TrafficPolicyEventHandlerFuncs) DeleteTrafficPolicy(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
...
func (f *TrafficPolicyEventHandlerFuncs) UpdateTrafficPolicy(objOld, objNew *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
...
func (f *TrafficPolicyEventHandlerFuncs) GenericTrafficPolicy(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
...
func NewTrafficPolicyEventWatcher(name string, mgr manager.Manager) TrafficPolicyEventWatcher {
	return &trafficPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_gloomesh_solo_io_v1alpha2.TrafficPolicy{}),
	}
}
...
func (h genericTrafficPolicyHandler) Create(object runtime.Object) error {
	obj, ok := object.(*networking_gloomesh_solo_io_v1alpha2.TrafficPolicy)
	if !ok {
...
func (h genericTrafficPolicyHandler) Update(old, new runtime.Object) error {
	objOld, ok := old.(*networking_gloomesh_solo_io_v1alpha2.TrafficPolicy)
	if !ok {
		return errors.Errorf("internal error: TrafficPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*networking_gloomesh_solo_io_v1alpha2.TrafficPolicy)
	if !ok {
...
type AccessPolicyEventHandler interface {
	CreateAccessPolicy(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error
	UpdateAccessPolicy(old, new *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error
	DeleteAccessPolicy(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error
	GenericAccessPolicy(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error
}

type AccessPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error
	OnUpdate  func(old, new *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error
	OnDelete  func(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error
	OnGeneric func(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error
}

func (f *AccessPolicyEventHandlerFuncs) CreateAccessPolicy(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *AccessPolicyEventHandlerFuncs) DeleteAccessPolicy(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *AccessPolicyEventHandlerFuncs) UpdateAccessPolicy(objOld, objNew *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *AccessPolicyEventHandlerFuncs) GenericAccessPolicy(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewAccessPolicyEventWatcher(name string, mgr manager.Manager) AccessPolicyEventWatcher {
	return &accessPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_gloomesh_solo_io_v1alpha2.AccessPolicy{}),
	}
}
...
func (h genericAccessPolicyHandler) Create(object runtime.Object) error {
	obj, ok := object.(*networking_gloomesh_solo_io_v1alpha2.AccessPolicy)
	if !ok {
...
func (h genericAccessPolicyHandler) Update(old, new runtime.Object) error {
	objOld, ok := old.(*networking_gloomesh_solo_io_v1alpha2.AccessPolicy)
	if !ok {
		return errors.Errorf("internal error: AccessPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*networking_gloomesh_solo_io_v1alpha2.AccessPolicy)
	if !ok {
...
type VirtualMeshEventHandler interface {
	CreateVirtualMesh(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error
	UpdateVirtualMesh(old, new *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error
	DeleteVirtualMesh(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error
	GenericVirtualMesh(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error
}

type VirtualMeshEventHandlerFuncs struct {
	OnCreate  func(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error
	OnUpdate  func(old, new *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error
	OnDelete  func(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error
	OnGeneric func(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error
}

func (f *VirtualMeshEventHandlerFuncs) CreateVirtualMesh(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *VirtualMeshEventHandlerFuncs) DeleteVirtualMesh(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *VirtualMeshEventHandlerFuncs) UpdateVirtualMesh(objOld, objNew *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *VirtualMeshEventHandlerFuncs) GenericVirtualMesh(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewVirtualMeshEventWatcher(name string, mgr manager.Manager) VirtualMeshEventWatcher {
	return &virtualMeshEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_gloomesh_solo_io_v1alpha2.VirtualMesh{}),
	}
}
...
func (h genericVirtualMeshHandler) Create(object runtime.Object) error {
	obj, ok := object.(*networking_gloomesh_solo_io_v1alpha2.VirtualMesh)
	if !ok {
...
func (h genericVirtualMeshHandler) Update(old, new runtime.Object) error {
	objOld, ok := old.(*networking_gloomesh_solo_io_v1alpha2.VirtualMesh)
	if !ok {
		return errors.Errorf("internal error: VirtualMesh handler received event for %T", old)
	}
	objNew, ok := new.(*networking_gloomesh_solo_io_v1alpha2.VirtualMesh)
	if !ok {
...
type FailoverServiceEventHandler interface {
	CreateFailoverService(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) error
	UpdateFailoverService(old, new *networking_gloomesh_solo_io_v1alpha2.FailoverService) error
	DeleteFailoverService(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) error
	GenericFailoverService(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) error
}

type FailoverServiceEventHandlerFuncs struct {
	OnCreate  func(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) error
	OnUpdate  func(old, new *networking_gloomesh_solo_io_v1alpha2.FailoverService) error
	OnDelete  func(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) error
	OnGeneric func(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) error
}

func (f *FailoverServiceEventHandlerFuncs) CreateFailoverService(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *FailoverServiceEventHandlerFuncs) DeleteFailoverService(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *FailoverServiceEventHandlerFuncs) UpdateFailoverService(objOld, objNew *networking_gloomesh_solo_io_v1alpha2.FailoverService) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *FailoverServiceEventHandlerFuncs) GenericFailoverService(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewFailoverServiceEventWatcher(name string, mgr manager.Manager) FailoverServiceEventWatcher {
	return &failoverServiceEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_gloomesh_solo_io_v1alpha2.FailoverService{}),
	}
}
...
func (h genericFailoverServiceHandler) Create(object runtime.Object) error {
	obj, ok := object.(*networking_gloomesh_solo_io_v1alpha2.FailoverService)
	if !ok {
...
func (h genericFailoverServiceHandler) Update(old, new runtime.Object) error {
	objOld, ok := old.(*networking_gloomesh_solo_io_v1alpha2.FailoverService)
	if !ok {
		return errors.Errorf("internal error: FailoverService handler received event for %T", old)
	}
	objNew, ok := new.(*networking_gloomesh_solo_io_v1alpha2.FailoverService)
	if !ok {
