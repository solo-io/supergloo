...
type MulticlusterTrafficPolicyReconciler interface {
	ReconcileTrafficPolicy(clusterName string, obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) (reconcile.Result, error)
}
...
type MulticlusterTrafficPolicyReconcilerFuncs struct {
	OnReconcileTrafficPolicy         func(clusterName string, obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) (reconcile.Result, error)
	OnReconcileTrafficPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterTrafficPolicyReconcilerFuncs) ReconcileTrafficPolicy(clusterName string, obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) (reconcile.Result, error) {
...
func NewMulticlusterTrafficPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterTrafficPolicyReconcileLoop {
	return &multiclusterTrafficPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_gloomesh_solo_io_v1alpha2.TrafficPolicy{}, options)}
}
...
type MulticlusterAccessPolicyReconciler interface {
	ReconcileAccessPolicy(clusterName string, obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) (reconcile.Result, error)
}
...
type MulticlusterAccessPolicyReconcilerFuncs struct {
	OnReconcileAccessPolicy         func(clusterName string, obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) (reconcile.Result, error)
	OnReconcileAccessPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterAccessPolicyReconcilerFuncs) ReconcileAccessPolicy(clusterName string, obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) (reconcile.Result, error) {
...
func NewMulticlusterAccessPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterAccessPolicyReconcileLoop {
	return &multiclusterAccessPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_gloomesh_solo_io_v1alpha2.AccessPolicy{}, options)}
}
...
type MulticlusterVirtualMeshReconciler interface {
	ReconcileVirtualMesh(clusterName string, obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) (reconcile.Result, error)
}
...
type MulticlusterVirtualMeshReconcilerFuncs struct {
	OnReconcileVirtualMesh         func(clusterName string, obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) (reconcile.Result, error)
	OnReconcileVirtualMeshDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterVirtualMeshReconcilerFuncs) ReconcileVirtualMesh(clusterName string, obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) (reconcile.Result, error) {
...
func NewMulticlusterVirtualMeshReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterVirtualMeshReconcileLoop {
	return &multiclusterVirtualMeshReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_gloomesh_solo_io_v1alpha2.VirtualMesh{}, options)}
}
...
type MulticlusterFailoverServiceReconciler interface {
	ReconcileFailoverService(clusterName string, obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) (reconcile.Result, error)
}
...
type MulticlusterFailoverServiceReconcilerFuncs struct {
	OnReconcileFailoverService         func(clusterName string, obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) (reconcile.Result, error)
	OnReconcileFailoverServiceDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterFailoverServiceReconcilerFuncs) ReconcileFailoverService(clusterName string, obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) (reconcile.Result, error) {
...
func NewMulticlusterFailoverServiceReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterFailoverServiceReconcileLoop {
	return &multiclusterFailoverServiceReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_gloomesh_solo_io_v1alpha2.FailoverService{}, options)}
}
