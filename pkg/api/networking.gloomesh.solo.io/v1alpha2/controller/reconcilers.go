...
type TrafficPolicyReconciler interface {
	ReconcileTrafficPolicy(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) (reconcile.Result, error)
}
...
type TrafficPolicyReconcilerFuncs struct {
	OnReconcileTrafficPolicy         func(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) (reconcile.Result, error)
	OnReconcileTrafficPolicyDeletion func(req reconcile.Request) error
}

func (f *TrafficPolicyReconcilerFuncs) ReconcileTrafficPolicy(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) (reconcile.Result, error) {
...
type TrafficPolicyFinalizer interface {
	...
	FinalizeTrafficPolicy(obj *networking_gloomesh_solo_io_v1alpha2.TrafficPolicy) error
}
...
func NewTrafficPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) TrafficPolicyReconcileLoop {
	return &trafficPolicyReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &networking_gloomesh_solo_io_v1alpha2.TrafficPolicy{}, options),
	}
}
...
type AccessPolicyReconciler interface {
	ReconcileAccessPolicy(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) (reconcile.Result, error)
}
...
type AccessPolicyReconcilerFuncs struct {
	OnReconcileAccessPolicy         func(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) (reconcile.Result, error)
	OnReconcileAccessPolicyDeletion func(req reconcile.Request) error
}

func (f *AccessPolicyReconcilerFuncs) ReconcileAccessPolicy(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) (reconcile.Result, error) {
...
type AccessPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeAccessPolicy(obj *networking_gloomesh_solo_io_v1alpha2.AccessPolicy) error
}
...
func NewAccessPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) AccessPolicyReconcileLoop {
	return &accessPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &networking_gloomesh_solo_io_v1alpha2.AccessPolicy{}, options),
	}
}
...
type VirtualMeshReconciler interface {
	ReconcileVirtualMesh(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) (reconcile.Result, error)
}
...
type VirtualMeshReconcilerFuncs struct {
	OnReconcileVirtualMesh         func(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) (reconcile.Result, error)
	OnReconcileVirtualMeshDeletion func(req reconcile.Request) error
}

func (f *VirtualMeshReconcilerFuncs) ReconcileVirtualMesh(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) (reconcile.Result, error) {
...
type VirtualMeshFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeVirtualMesh(obj *networking_gloomesh_solo_io_v1alpha2.VirtualMesh) error
}
...
func NewVirtualMeshReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) VirtualMeshReconcileLoop {
	return &virtualMeshReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &networking_gloomesh_solo_io_v1alpha2.VirtualMesh{}, options),
	}
}
...
type FailoverServiceReconciler interface {
	ReconcileFailoverService(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) (reconcile.Result, error)
}
...
type FailoverServiceReconcilerFuncs struct {
	OnReconcileFailoverService         func(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) (reconcile.Result, error)
	OnReconcileFailoverServiceDeletion func(req reconcile.Request) error
}

func (f *FailoverServiceReconcilerFuncs) ReconcileFailoverService(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) (reconcile.Result, error) {
...
type FailoverServiceFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeFailoverService(obj *networking_gloomesh_solo_io_v1alpha2.FailoverService) error
}
...
func NewFailoverServiceReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) FailoverServiceReconcileLoop {
	return &failoverServiceReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &networking_gloomesh_solo_io_v1alpha2.FailoverService{}, options),
	}
}
