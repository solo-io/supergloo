...
import (
	...
	settings_gloomesh_solo_io_v1alpha2 "github.com/solo-io/gloo-mesh/pkg/api/settings.gloomesh.solo.io/v1alpha2"
	settings_gloomesh_solo_io_v1alpha2_sets "github.com/solo-io/gloo-mesh/pkg/api/settings.gloomesh.solo.io/v1alpha2/sets"

	discovery_gloomesh_solo_io_v1alpha2 "github.com/solo-io/gloo-mesh/pkg/api/discovery.gloomesh.solo.io/v1alpha2"
	discovery_gloomesh_solo_io_v1alpha2_sets "github.com/solo-io/gloo-mesh/pkg/api/discovery.gloomesh.solo.io/v1alpha2/sets"

	networking_gloomesh_solo_io_v1alpha2 "github.com/solo-io/gloo-mesh/pkg/api/networking.gloomesh.solo.io/v1alpha2"
	networking_gloomesh_solo_io_v1alpha2_sets "github.com/solo-io/gloo-mesh/pkg/api/networking.gloomesh.solo.io/v1alpha2/sets"
...
type Snapshot interface {
	...
	Settings() settings_gloomesh_solo_io_v1alpha2_sets.SettingsSet

	// return the set of input TrafficTargets
	TrafficTargets() discovery_gloomesh_solo_io_v1alpha2_sets.TrafficTargetSet
	// return the set of input Workloads
	Workloads() discovery_gloomesh_solo_io_v1alpha2_sets.WorkloadSet
	// return the set of input Meshes
	Meshes() discovery_gloomesh_solo_io_v1alpha2_sets.MeshSet

	// return the set of input TrafficPolicies
	TrafficPolicies() networking_gloomesh_solo_io_v1alpha2_sets.TrafficPolicySet
	// return the set of input AccessPolicies
	AccessPolicies() networking_gloomesh_solo_io_v1alpha2_sets.AccessPolicySet
	// return the set of input VirtualMeshes
	VirtualMeshes() networking_gloomesh_solo_io_v1alpha2_sets.VirtualMeshSet
	// return the set of input FailoverServices
	FailoverServices() networking_gloomesh_solo_io_v1alpha2_sets.FailoverServiceSet
...
func (s snapshot) Settings() settings_gloomesh_solo_io_v1alpha2_sets.SettingsSet {
	return s.settings
}

func (s snapshot) TrafficTargets() discovery_gloomesh_solo_io_v1alpha2_sets.TrafficTargetSet {
	return s.trafficTargets
}

func (s snapshot) Workloads() discovery_gloomesh_solo_io_v1alpha2_sets.WorkloadSet {
	return s.workloads
}

func (s snapshot) Meshes() discovery_gloomesh_solo_io_v1alpha2_sets.MeshSet {
	return s.meshes
}

func (s snapshot) TrafficPolicies() networking_gloomesh_solo_io_v1alpha2_sets.TrafficPolicySet {
	return s.trafficPolicies
}

func (s snapshot) AccessPolicies() networking_gloomesh_solo_io_v1alpha2_sets.AccessPolicySet {
	return s.accessPolicies
}

func (s snapshot) VirtualMeshes() networking_gloomesh_solo_io_v1alpha2_sets.VirtualMeshSet {
	return s.virtualMeshes
}

func (s snapshot) FailoverServices() networking_gloomesh_solo_io_v1alpha2_sets.FailoverServiceSet {
...
func (b *multiClusterBuilder) BuildSnapshot(ctx context.Context, name string, opts BuildOptions) (Snapshot, error) {
	...
	settings := settings_gloomesh_solo_io_v1alpha2_sets.NewSettingsSet()

	trafficTargets := discovery_gloomesh_solo_io_v1alpha2_sets.NewTrafficTargetSet()
	workloads := discovery_gloomesh_solo_io_v1alpha2_sets.NewWorkloadSet()
	meshes := discovery_gloomesh_solo_io_v1alpha2_sets.NewMeshSet()

	trafficPolicies := networking_gloomesh_solo_io_v1alpha2_sets.NewTrafficPolicySet()
	accessPolicies := networking_gloomesh_solo_io_v1alpha2_sets.NewAccessPolicySet()
	virtualMeshes := networking_gloomesh_solo_io_v1alpha2_sets.NewVirtualMeshSet()
	failoverServices := networking_gloomesh_solo_io_v1alpha2_sets.NewFailoverServiceSet()
...
func (b *multiClusterBuilder) insertSettingsFromCluster(ctx context.Context, cluster string, settings settings_gloomesh_solo_io_v1alpha2_sets.SettingsSet, opts ResourceBuildOptions) error {
	settingsClient, err := settings_gloomesh_solo_io_v1alpha2.NewMulticlusterSettingsClient(b.client).Cluster(cluster)
	if err != nil {
		return err
	}
	...
	if opts.Verifier != nil {
		...
		gvk := schema.GroupVersionKind{
			Group:   "settings.gloomesh.solo.io",
			Version: "v1alpha2",
			Kind:    "Settings",
		}
...
func (b *multiClusterBuilder) insertTrafficTargetsFromCluster(ctx context.Context, cluster string, trafficTargets discovery_gloomesh_solo_io_v1alpha2_sets.TrafficTargetSet, opts ResourceBuildOptions) error {
	trafficTargetClient, err := discovery_gloomesh_solo_io_v1alpha2.NewMulticlusterTrafficTargetClient(b.client).Cluster(cluster)
	if err != nil {
		return err
	}
	...
	if opts.Verifier != nil {
		...
		gvk := schema.GroupVersionKind{
			Group:   "discovery.gloomesh.solo.io",
			Version: "v1alpha2",
			Kind:    "TrafficTarget",
		}
...
func (b *multiClusterBuilder) insertWorkloadsFromCluster(ctx context.Context, cluster string, workloads discovery_gloomesh_solo_io_v1alpha2_sets.WorkloadSet, opts ResourceBuildOptions) error {
	workloadClient, err := discovery_gloomesh_solo_io_v1alpha2.NewMulticlusterWorkloadClient(b.client).Cluster(cluster)
	if err != nil {
		return err
	}
...
func (b *multiClusterBuilder) insertMeshesFromCluster(ctx context.Context, cluster string, meshes discovery_gloomesh_solo_io_v1alpha2_sets.MeshSet, opts ResourceBuildOptions) error {
	meshClient, err := discovery_gloomesh_solo_io_v1alpha2.NewMulticlusterMeshClient(b.client).Cluster(cluster)
	if err != nil {
		return err
	}
...
func (b *multiClusterBuilder) insertTrafficPoliciesFromCluster(ctx context.Context, cluster string, trafficPolicies networking_gloomesh_solo_io_v1alpha2_sets.TrafficPolicySet, opts ResourceBuildOptions) error {
	trafficPolicyClient, err := networking_gloomesh_solo_io_v1alpha2.NewMulticlusterTrafficPolicyClient(b.client).Cluster(cluster)
	if err != nil {
		return err
	}
	...
	if opts.Verifier != nil {
		...
		gvk := schema.GroupVersionKind{
			Group:   "networking.gloomesh.solo.io",
			Version: "v1alpha2",
			Kind:    "TrafficPolicy",
		}
...
func (b *multiClusterBuilder) insertAccessPoliciesFromCluster(ctx context.Context, cluster string, accessPolicies networking_gloomesh_solo_io_v1alpha2_sets.AccessPolicySet, opts ResourceBuildOptions) error {
	accessPolicyClient, err := networking_gloomesh_solo_io_v1alpha2.NewMulticlusterAccessPolicyClient(b.client).Cluster(cluster)
	if err != nil {
		return err
	}
...
func (b *multiClusterBuilder) insertVirtualMeshesFromCluster(ctx context.Context, cluster string, virtualMeshes networking_gloomesh_solo_io_v1alpha2_sets.VirtualMeshSet, opts ResourceBuildOptions) error {
	virtualMeshClient, err := networking_gloomesh_solo_io_v1alpha2.NewMulticlusterVirtualMeshClient(b.client).Cluster(cluster)
	if err != nil {
		return err
	}
...
func (b *multiClusterBuilder) insertFailoverServicesFromCluster(ctx context.Context, cluster string, failoverServices networking_gloomesh_solo_io_v1alpha2_sets.FailoverServiceSet, opts ResourceBuildOptions) error {
	failoverServiceClient, err := networking_gloomesh_solo_io_v1alpha2.NewMulticlusterFailoverServiceClient(b.client).Cluster(cluster)
	if err != nil {
		return err
	}
...
func (b *singleClusterBuilder) insertSettings(ctx context.Context, settings settings_gloomesh_solo_io_v1alpha2_sets.SettingsSet, opts ResourceBuildOptions) error {
	...
	settingsList, err := settings_gloomesh_solo_io_v1alpha2.NewSettingsClient(b.mgr.GetClient()).ListSettings(ctx, opts.ListOptions...)
	if err != nil {
		return err
	}
...
func (b *singleClusterBuilder) insertTrafficTargets(ctx context.Context, trafficTargets discovery_gloomesh_solo_io_v1alpha2_sets.TrafficTargetSet, opts ResourceBuildOptions) error {
	...
	trafficTargetList, err := discovery_gloomesh_solo_io_v1alpha2.NewTrafficTargetClient(b.mgr.GetClient()).ListTrafficTarget(ctx, opts.ListOptions...)
	if err != nil {
		return err
	}
...
func (b *singleClusterBuilder) insertWorkloads(ctx context.Context, workloads discovery_gloomesh_solo_io_v1alpha2_sets.WorkloadSet, opts ResourceBuildOptions) error {
	...
	workloadList, err := discovery_gloomesh_solo_io_v1alpha2.NewWorkloadClient(b.mgr.GetClient()).ListWorkload(ctx, opts.ListOptions...)
	if err != nil {
		return err
	}
...
func (b *singleClusterBuilder) insertMeshes(ctx context.Context, meshes discovery_gloomesh_solo_io_v1alpha2_sets.MeshSet, opts ResourceBuildOptions) error {
	...
	meshList, err := discovery_gloomesh_solo_io_v1alpha2.NewMeshClient(b.mgr.GetClient()).ListMesh(ctx, opts.ListOptions...)
	if err != nil {
		return err
	}
...
func (b *singleClusterBuilder) insertTrafficPolicies(ctx context.Context, trafficPolicies networking_gloomesh_solo_io_v1alpha2_sets.TrafficPolicySet, opts ResourceBuildOptions) error {
	...
	trafficPolicyList, err := networking_gloomesh_solo_io_v1alpha2.NewTrafficPolicyClient(b.mgr.GetClient()).ListTrafficPolicy(ctx, opts.ListOptions...)
	if err != nil {
		return err
	}
...
func (b *singleClusterBuilder) insertAccessPolicies(ctx context.Context, accessPolicies networking_gloomesh_solo_io_v1alpha2_sets.AccessPolicySet, opts ResourceBuildOptions) error {
	...
	accessPolicyList, err := networking_gloomesh_solo_io_v1alpha2.NewAccessPolicyClient(b.mgr.GetClient()).ListAccessPolicy(ctx, opts.ListOptions...)
	if err != nil {
		return err
	}
...
func (b *singleClusterBuilder) insertVirtualMeshes(ctx context.Context, virtualMeshes networking_gloomesh_solo_io_v1alpha2_sets.VirtualMeshSet, opts ResourceBuildOptions) error {
	...
	virtualMeshList, err := networking_gloomesh_solo_io_v1alpha2.NewVirtualMeshClient(b.mgr.GetClient()).ListVirtualMesh(ctx, opts.ListOptions...)
	if err != nil {
		return err
	}
...
func (b *singleClusterBuilder) insertFailoverServices(ctx context.Context, failoverServices networking_gloomesh_solo_io_v1alpha2_sets.FailoverServiceSet, opts ResourceBuildOptions) error {
	...
	failoverServiceList, err := networking_gloomesh_solo_io_v1alpha2.NewFailoverServiceClient(b.mgr.GetClient()).ListFailoverService(ctx, opts.ListOptions...)
	if err != nil {
		return err
	}
