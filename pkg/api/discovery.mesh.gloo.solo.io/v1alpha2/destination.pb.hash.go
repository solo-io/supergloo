...
func (m *DestinationSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("discovery.mesh.gloo.solo.io.github.com/solo-io/gloo-mesh/pkg/api/discovery.mesh.gloo.solo.io/v1alpha2.DestinationSpec")); err != nil {
		return 0, err
	}
	...
	case *DestinationSpec_KubeService_:
		...
		if h, ok := interface{}(m.GetKubeService()).(safe_hasher.SafeHasher); ok {
			...
			if val, err := hashstructure.Hash(m.GetKubeService(), nil); err != nil {
				return 0, err
			} else {
				if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
					return 0, err
...
func (m *DestinationStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("discovery.mesh.gloo.solo.io.github.com/solo-io/gloo-mesh/pkg/api/discovery.mesh.gloo.solo.io/v1alpha2.DestinationStatus")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetAppliedFederation()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetAppliedFederation(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
...
func (m *DestinationSpec_KubeService) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("discovery.mesh.gloo.solo.io.github.com/solo-io/gloo-mesh/pkg/api/discovery.mesh.gloo.solo.io/v1alpha2.DestinationSpec_KubeService")); err != nil {
		return 0, err
	}
...
func (m *DestinationSpec_KubeService_KubeServicePort) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("discovery.mesh.gloo.solo.io.github.com/solo-io/gloo-mesh/pkg/api/discovery.mesh.gloo.solo.io/v1alpha2.DestinationSpec_KubeService_KubeServicePort")); err != nil {
		return 0, err
	}
...
func (m *DestinationSpec_KubeService_Subset) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("discovery.mesh.gloo.solo.io.github.com/solo-io/gloo-mesh/pkg/api/discovery.mesh.gloo.solo.io/v1alpha2.DestinationSpec_KubeService_Subset")); err != nil {
		return 0, err
	}
...
func (m *DestinationSpec_KubeService_EndpointsSubset) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("discovery.mesh.gloo.solo.io.github.com/solo-io/gloo-mesh/pkg/api/discovery.mesh.gloo.solo.io/v1alpha2.DestinationSpec_KubeService_EndpointsSubset")); err != nil {
		return 0, err
	}
...
func (m *DestinationSpec_KubeService_EndpointsSubset_Endpoint) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("discovery.mesh.gloo.solo.io.github.com/solo-io/gloo-mesh/pkg/api/discovery.mesh.gloo.solo.io/v1alpha2.DestinationSpec_KubeService_EndpointsSubset_Endpoint")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetSubLocality()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetSubLocality(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
...
func (m *DestinationStatus_AppliedTrafficPolicy) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("discovery.mesh.gloo.solo.io.github.com/solo-io/gloo-mesh/pkg/api/discovery.mesh.gloo.solo.io/v1alpha2.DestinationStatus_AppliedTrafficPolicy")); err != nil {
		return 0, err
	}
...
func (m *DestinationStatus_AppliedAccessPolicy) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("discovery.mesh.gloo.solo.io.github.com/solo-io/gloo-mesh/pkg/api/discovery.mesh.gloo.solo.io/v1alpha2.DestinationStatus_AppliedAccessPolicy")); err != nil {
		return 0, err
	}
...
func (m *DestinationStatus_AppliedFederation) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("discovery.mesh.gloo.solo.io.github.com/solo-io/gloo-mesh/pkg/api/discovery.mesh.gloo.solo.io/v1alpha2.DestinationStatus_AppliedFederation")); err != nil {
		return 0, err
	}
