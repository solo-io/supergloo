...
type MulticlusterWorkloadReconcilerFuncs struct {
	OnReconcileWorkload         func(clusterName string, obj *discovery_mesh_gloo_solo_io_v1alpha2.Workload) (reconcile.Result, error)
...
func NewMulticlusterWorkloadReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterWorkloadReconcileLoop {
	return &multiclusterWorkloadReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &discovery_mesh_gloo_solo_io_v1alpha2.Workload{}, options)}
}
...
type MulticlusterMeshReconcilerFuncs struct {
	OnReconcileMesh         func(clusterName string, obj *discovery_mesh_gloo_solo_io_v1alpha2.Mesh) (reconcile.Result, error)
...
func NewMulticlusterMeshReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterMeshReconcileLoop {
	return &multiclusterMeshReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &discovery_mesh_gloo_solo_io_v1alpha2.Mesh{}, options)}
}
