...
var file_github_com_solo_io_gloo_mesh_api_discovery_v1alpha2_traffic_target_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x70, 0x65, 0x22, 0xe4, 0x07, 0x0a, 0x13, 0x54, 0x72, 0x61, 0x66, 0x66, 0x69, 0x63,
	...
	0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x1a, 0x90, 0x01, 0x0a, 0x11, 0x41, 0x70, 0x70,
...
var file_github_com_solo_io_gloo_mesh_api_discovery_v1alpha2_traffic_target_proto_depIdxs = []int32{
	...
	11, // 4: discovery.mesh.gloo.solo.io.TrafficTargetStatus.applied_federation:type_name -> discovery.mesh.gloo.solo.io.TrafficTargetStatus.AppliedFederation
	13, // 5: discovery.mesh.gloo.solo.io.TrafficTargetSpec.KubeService.ref:type_name -> core.skv2.solo.io.ClusterObjectRef
	...
	3,  // 12: discovery.mesh.gloo.solo.io.TrafficTargetSpec.KubeService.EndpointsSubset.ports:type_name -> discovery.mesh.gloo.solo.io.TrafficTargetSpec.KubeService.KubeServicePort
	12, // 13: discovery.mesh.gloo.solo.io.TrafficTargetStatus.AppliedTrafficPolicy.ref:type_name -> core.skv2.solo.io.ObjectRef
	14, // 14: discovery.mesh.gloo.solo.io.TrafficTargetStatus.AppliedTrafficPolicy.spec:type_name -> networking.mesh.gloo.solo.io.TrafficPolicySpec
	12, // 15: discovery.mesh.gloo.solo.io.TrafficTargetStatus.AppliedAccessPolicy.ref:type_name -> core.skv2.solo.io.ObjectRef
	15, // 16: discovery.mesh.gloo.solo.io.TrafficTargetStatus.AppliedAccessPolicy.spec:type_name -> networking.mesh.gloo.solo.io.AccessPolicySpec
	12, // 17: discovery.mesh.gloo.solo.io.TrafficTargetStatus.AppliedFederation.federated_to_meshes:type_name -> core.skv2.solo.io.ObjectRef
