...
type WorkloadSet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*discovery_mesh_gloo_solo_io_v1alpha2.Workload) bool) []*discovery_mesh_gloo_solo_io_v1alpha2.Workload
	// Return the Set as a map of key to resource.
	Map() map[string]*discovery_mesh_gloo_solo_io_v1alpha2.Workload
	// Insert a resource into the set.
	Insert(workload ...*discovery_mesh_gloo_solo_io_v1alpha2.Workload)
	// Compare the equality of the keys in two sets (not the resources themselves)
...
func NewWorkloadSetFromList(workloadList *discovery_mesh_gloo_solo_io_v1alpha2.WorkloadList) WorkloadSet {
	list := make([]*discovery_mesh_gloo_solo_io_v1alpha2.Workload, 0, len(workloadList.Items))
...
func (s *workloadSet) List(filterResource ...func(*discovery_mesh_gloo_solo_io_v1alpha2.Workload) bool) []*discovery_mesh_gloo_solo_io_v1alpha2.Workload {
	...
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*discovery_mesh_gloo_solo_io_v1alpha2.Workload))
		})
	}
...
func (s *workloadSet) Map() map[string]*discovery_mesh_gloo_solo_io_v1alpha2.Workload {
	if s == nil {
		return nil
	}
...
func (s *workloadSet) Insert(
	workloadList ...*discovery_mesh_gloo_solo_io_v1alpha2.Workload,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *workloadSet) Find(id ezkube.ResourceId) (*discovery_mesh_gloo_solo_io_v1alpha2.Workload, error) {
	if s == nil {
	...
	return obj.(*discovery_mesh_gloo_solo_io_v1alpha2.Workload), nil
}
...
type MeshSet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*discovery_mesh_gloo_solo_io_v1alpha2.Mesh) bool) []*discovery_mesh_gloo_solo_io_v1alpha2.Mesh
	// Return the Set as a map of key to resource.
	Map() map[string]*discovery_mesh_gloo_solo_io_v1alpha2.Mesh
	// Insert a resource into the set.
	Insert(mesh ...*discovery_mesh_gloo_solo_io_v1alpha2.Mesh)
	// Compare the equality of the keys in two sets (not the resources themselves)
...
func NewMeshSetFromList(meshList *discovery_mesh_gloo_solo_io_v1alpha2.MeshList) MeshSet {
	list := make([]*discovery_mesh_gloo_solo_io_v1alpha2.Mesh, 0, len(meshList.Items))
...
func (s *meshSet) List(filterResource ...func(*discovery_mesh_gloo_solo_io_v1alpha2.Mesh) bool) []*discovery_mesh_gloo_solo_io_v1alpha2.Mesh {
	...
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*discovery_mesh_gloo_solo_io_v1alpha2.Mesh))
		})
	}
...
func (s *meshSet) Map() map[string]*discovery_mesh_gloo_solo_io_v1alpha2.Mesh {
	if s == nil {
		return nil
	}
...
func (s *meshSet) Insert(
	meshList ...*discovery_mesh_gloo_solo_io_v1alpha2.Mesh,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *meshSet) Find(id ezkube.ResourceId) (*discovery_mesh_gloo_solo_io_v1alpha2.Mesh, error) {
	if s == nil {
	...
	return obj.(*discovery_mesh_gloo_solo_io_v1alpha2.Mesh), nil
}
