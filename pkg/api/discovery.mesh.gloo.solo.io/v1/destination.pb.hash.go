...
func (m *DestinationSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	case *DestinationSpec_ExternalService_:
		...
		if h, ok := interface{}(m.GetExternalService()).(safe_hasher.SafeHasher); ok {
			...
			if val, err := hashstructure.Hash(m.GetExternalService(), nil); err != nil {
				return 0, err
			} else {
				if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
					return 0, err
...
func (m *DestinationStatus_AppliedFederation) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetVirtualMeshRef()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetVirtualMeshRef(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
...
// Hash function
func (m *DestinationStatus_RequiredSubsets) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("discovery.mesh.gloo.solo.io.github.com/solo-io/gloo-mesh/pkg/api/discovery.mesh.gloo.solo.io/v1.DestinationStatus_RequiredSubsets")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetTrafficPolicyRef()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetTrafficPolicyRef(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
	...
	if h, ok := interface{}(m.GetTrafficShift()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetTrafficShift(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
