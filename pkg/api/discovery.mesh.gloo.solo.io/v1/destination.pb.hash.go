...
func (m *DestinationStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	for _, v := range m.GetAppliedSubsets() {
...
// Hash function
func (m *DestinationStatus_AppliedSubsets) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("discovery.mesh.gloo.solo.io.github.com/solo-io/gloo-mesh/pkg/api/discovery.mesh.gloo.solo.io/v1.DestinationStatus_AppliedSubsets")); err != nil {
		return 0, err
	}
