...
type DestinationStatus_AppliedFederation struct {
	...
	FederatedHostname string `protobuf:"bytes,2,opt,name=federated_hostname,json=federatedHostname,proto3" json:"federated_hostname,omitempty"`
	// The list of Meshes which are able to resolve this Destination's `multicluster_dns_name`.
	FederatedToMeshes []*v1.ObjectRef `protobuf:"bytes,3,rep,name=federated_to_meshes,json=federatedToMeshes,proto3" json:"federated_to_meshes,omitempty"`
	...
	// is true.
	FlatNetwork bool `protobuf:"varint,4,opt,name=flat_network,json=flatNetwork,proto3" json:"flat_network,omitempty"`
}
...
func (x *DestinationStatus_AppliedFederation) GetRef() *v1.ObjectRef {
	if x != nil {
		return x.Ref
	}
	return nil
...
var file_github_com_solo_io_gloo_mesh_api_discovery_v1_destination_proto_rawDesc = []byte{
	...
	0x79, 0x70, 0x65, 0x22, 0xaf, 0x08, 0x0a, 0x11, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74,
	...
	0xe3, 0x01, 0x0a, 0x11, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x64, 0x46, 0x65, 0x64, 0x65, 0x72,
	...
	0x52, 0x03, 0x72, 0x65, 0x66, 0x12, 0x2d, 0x0a, 0x12, 0x66, 0x65, 0x64, 0x65, 0x72, 0x61, 0x74,
	0x65, 0x64, 0x5f, 0x68, 0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x64, 0x5f, 0x74, 0x6f, 0x5f, 0x6d, 0x65, 0x73, 0x68, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	...
	0x72, 0x6b, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x66, 0x6c, 0x61, 0x74, 0x4e, 0x65,
	0x74, 0x77, 0x6f, 0x72, 0x6b, 0x42, 0x4d, 0x5a, 0x43, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_github_com_solo_io_gloo_mesh_api_discovery_v1_destination_proto_depIdxs = []int32{
	...
	19, // 24: discovery.mesh.gloo.solo.io.DestinationStatus.AppliedFederation.ref:type_name -> core.skv2.solo.io.ObjectRef
	19, // 25: discovery.mesh.gloo.solo.io.DestinationStatus.AppliedFederation.federated_to_meshes:type_name -> core.skv2.solo.io.ObjectRef
