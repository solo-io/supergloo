...
type MeshSpec_Istio_IngressGatewayInfo struct {
	...
	// DEPRECATED: in favor of `workload_label_sets` which can represent multiple backing workloads.
	...
	// Can be empty if ingress gateway is exposed through an external load balancer.
	...
	// A list of label sets matching the workloads backing the gateway.
	// [Defaults to a single label set](https://github.com/istio/istio/blob/ab6cc48134a698d7ad218a83390fe27e8098919f/pkg/config/constants/constants.go#L73) `{"istio": "ingressgateway"}`.
	// Can be empty if ingress gateway is exposed through an external load balancer.
	WorkloadLabelSets []*v1.LabelSet `protobuf:"bytes,8,rep,name=workload_label_sets,json=workloadLabelSets,proto3" json:"workload_label_sets,omitempty"`
	// DEPRECATED: in favor of external_addresses
	...
	// The externally-reachable addresses on which the gateway is listening for TLS connections.
	// These will be the address used for cross-cluster connectivity.
	// Defaults to the LoadBalancer Address (or NodeIP) of the Kubernetes service (depending on its type).
	ExternalAddresses []*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress `protobuf:"bytes,7,rep,name=external_addresses,json=externalAddresses,proto3" json:"external_addresses,omitempty"`
}
...
func (x *MeshSpec_Istio_IngressGatewayInfo) GetWorkloadLabelSets() []*v1.LabelSet {
	if x != nil {
		return x.WorkloadLabelSets
	}
	return nil
}
...
func (x *MeshSpec_Istio_IngressGatewayInfo) GetExternalAddresses() []*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress {
	if x != nil {
...
type MeshSpec_Istio_IngressGatewayInfo_ExternalAddress struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//	*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress_DnsName
	//	*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress_Ip
	ExternalAddressType isMeshSpec_Istio_IngressGatewayInfo_ExternalAddress_ExternalAddressType `protobuf_oneof:"external_address_type"`
}

func (x *MeshSpec_Istio_IngressGatewayInfo_ExternalAddress) Reset() {
	*x = MeshSpec_Istio_IngressGatewayInfo_ExternalAddress{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_api_discovery_v1_mesh_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *MeshSpec_Istio_IngressGatewayInfo_ExternalAddress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress) ProtoMessage() {}

func (x *MeshSpec_Istio_IngressGatewayInfo_ExternalAddress) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_mesh_api_discovery_v1_mesh_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MeshSpec_Istio_IngressGatewayInfo_ExternalAddress.ProtoReflect.Descriptor instead.
func (*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_api_discovery_v1_mesh_proto_rawDescGZIP(), []int{0, 0, 0, 1}
}

func (m *MeshSpec_Istio_IngressGatewayInfo_ExternalAddress) GetExternalAddressType() isMeshSpec_Istio_IngressGatewayInfo_ExternalAddress_ExternalAddressType {
	if m != nil {
...
func (x *MeshSpec_Istio_IngressGatewayInfo_ExternalAddress) GetDnsName() string {
	if x, ok := x.GetExternalAddressType().(*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress_DnsName); ok {
		return x.DnsName
	}
	return ""
}

func (x *MeshSpec_Istio_IngressGatewayInfo_ExternalAddress) GetIp() string {
	if x, ok := x.GetExternalAddressType().(*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress_Ip); ok {
		return x.Ip
	}
	return ""
}

type isMeshSpec_Istio_IngressGatewayInfo_ExternalAddress_ExternalAddressType interface {
	isMeshSpec_Istio_IngressGatewayInfo_ExternalAddress_ExternalAddressType()
}

type MeshSpec_Istio_IngressGatewayInfo_ExternalAddress_DnsName struct {
...
type MeshSpec_Istio_IngressGatewayInfo_ExternalAddress_Ip struct {
	// Will be populated if the LoadBalancer Address is an IP
	Ip string `protobuf:"bytes,2,opt,name=ip,proto3,oneof"`
}

func (*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress_DnsName) isMeshSpec_Istio_IngressGatewayInfo_ExternalAddress_ExternalAddressType() {
}

func (*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress_Ip) isMeshSpec_Istio_IngressGatewayInfo_ExternalAddress_ExternalAddressType() {
}
...
var file_github_com_solo_io_gloo_mesh_api_discovery_v1_mesh_proto_rawDesc = []byte{
	...
	,
	...
	0x68, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x4f, 0x53, 0x4d, 0x48, 0x00, 0x52, 0x03, 0x6f, 0x73, 0x6d,
	0x12, 0x4e, 0x0a, 0x0a, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79,
	0x2e, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e,
	0x69, 0x6f, 0x2e, 0x4d, 0x65, 0x73, 0x68, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x41, 0x67, 0x65, 0x6e,
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x09, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f,
	0x1a, 0xee, 0x07, 0x0a, 0x05, 0x49, 0x73, 0x74, 0x69, 0x6f, 0x12, 0x5a, 0x0a, 0x0c, 0x69, 0x6e,
	...
	,
	...
	0x74, 0x65, 0x77, 0x61, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0f, 0x69, 0x6e, 0x67, 0x72, 0x65,
	0x73, 0x73, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x73, 0x12, 0x3b, 0x0a, 0x1a, 0x73, 0x6d,
	...
	0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x1a, 0x87, 0x05, 0x0a, 0x12, 0x49, 0x6e, 0x67, 0x72,
	0x65, 0x73, 0x73, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x7b,
	...
	0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x12, 0x52, 0x0a, 0x13, 0x77,
	0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x5f, 0x73, 0x65,
	0x74, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x2e, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f,
	0x2e, 0x69, 0x6f, 0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x53, 0x65, 0x74, 0x52, 0x11, 0x77, 0x6f,
	0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x53, 0x65, 0x74, 0x73, 0x12,
	...
	0x6c, 0x73, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x2c, 0x0a, 0x12, 0x74, 0x6c, 0x73, 0x5f, 0x63, 0x6f,
	...
	0x50, 0x6f, 0x72, 0x74, 0x12, 0x7d, 0x0a, 0x12, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x4e, 0x2e, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x2e, 0x6d, 0x65, 0x73,
	0x68, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x4d,
	...
	,
	...
	0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x1a, 0x90, 0x01, 0x0a, 0x0b, 0x4c, 0x69, 0x6e, 0x6b,
	0x65, 0x72, 0x64, 0x4d, 0x65, 0x73, 0x68, 0x12, 0x5a, 0x0a, 0x0c, 0x69, 0x6e, 0x73, 0x74, 0x61,
	...
	0x69, 0x6f, 0x6e, 0x12, 0x25, 0x0a, 0x0e, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x64,
	0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x63, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x1a, 0x6f, 0x0a, 0x11, 0x43, 0x6f,
	0x6e, 0x73, 0x75, 0x6c, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x4d, 0x65, 0x73, 0x68, 0x12,
	...
	0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x61, 0x0a, 0x03, 0x4f,
	0x53, 0x4d, 0x12, 0x5a, 0x0a, 0x0c, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x61, 0x74, 0x69,
	...
	0x52, 0x0c, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0xa0,
	...
	0x28, 0x09, 0x52, 0x07, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x12, 0x64, 0x0a, 0x0a, 0x70,
	...
	0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22,
	0x81, 0x05, 0x0a, 0x0a, 0x4d, 0x65, 0x73, 0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2f,
	...
	,
	...
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x1a, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x64,
	0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x1a, 0xb7, 0x01, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x64, 0x56,
	...
	0x65, 0x73, 0x68, 0x53, 0x70, 0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x1a, 0x93, 0x01,
	0x0a, 0x19, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x64, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c,
	0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2e, 0x0a, 0x03, 0x72,
	...
	0x6f, 0x72, 0x73, 0x42, 0x49, 0x5a, 0x43, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_github_com_solo_io_gloo_mesh_api_discovery_v1_mesh_proto_goTypes = []interface{}{
	...
	(*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress)(nil), // 11: discovery.mesh.gloo.solo.io.MeshSpec.Istio.IngressGatewayInfo.ExternalAddress
	...
	(*v1.LabelSet)(nil),                          // 15: common.mesh.gloo.solo.io.LabelSet
...
var file_github_com_solo_io_gloo_mesh_api_discovery_v1_mesh_proto_depIdxs = []int32{
	...
	12, // 13: discovery.mesh.gloo.solo.io.MeshSpec.MeshInstallation.pod_labels:type_name -> discovery.mesh.gloo.solo.io.MeshSpec.MeshInstallation.PodLabelsEntry
	...
	15, // 15: discovery.mesh.gloo.solo.io.MeshSpec.Istio.IngressGatewayInfo.workload_label_sets:type_name -> common.mesh.gloo.solo.io.LabelSet
	11, // 16: discovery.mesh.gloo.solo.io.MeshSpec.Istio.IngressGatewayInfo.external_addresses:type_name -> discovery.mesh.gloo.solo.io.MeshSpec.Istio.IngressGatewayInfo.ExternalAddress
...
func file_github_com_solo_io_gloo_mesh_api_discovery_v1_mesh_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_mesh_api_discovery_v1_mesh_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_solo_io_gloo_mesh_api_discovery_v1_mesh_proto_msgTypes[11].OneofWrappers = []interface{}{
		(*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress_DnsName)(nil),
		(*MeshSpec_Istio_IngressGatewayInfo_ExternalAddress_Ip)(nil),
	}
	type x struct{}
