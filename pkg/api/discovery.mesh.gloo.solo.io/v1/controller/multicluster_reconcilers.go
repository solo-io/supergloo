...
type MulticlusterDestinationReconcilerFuncs struct {
	OnReconcileDestination         func(clusterName string, obj *discovery_mesh_gloo_solo_io_v1.Destination) (reconcile.Result, error)
...
func NewMulticlusterDestinationReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterDestinationReconcileLoop {
	return &multiclusterDestinationReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &discovery_mesh_gloo_solo_io_v1.Destination{}, options)}
}
...
type MulticlusterWorkloadReconcilerFuncs struct {
	OnReconcileWorkload         func(clusterName string, obj *discovery_mesh_gloo_solo_io_v1.Workload) (reconcile.Result, error)
...
func NewMulticlusterWorkloadReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterWorkloadReconcileLoop {
	return &multiclusterWorkloadReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &discovery_mesh_gloo_solo_io_v1.Workload{}, options)}
}
...
type MulticlusterMeshReconcilerFuncs struct {
	OnReconcileMesh         func(clusterName string, obj *discovery_mesh_gloo_solo_io_v1.Mesh) (reconcile.Result, error)
...
func NewMulticlusterMeshReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterMeshReconcileLoop {
	return &multiclusterMeshReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &discovery_mesh_gloo_solo_io_v1.Mesh{}, options)}
}
