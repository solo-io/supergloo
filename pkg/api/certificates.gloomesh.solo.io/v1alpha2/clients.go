...
// MulticlusterClientset for the certificates.gloomesh.solo.io/v1alpha2 APIs
...
// clienset for the certificates.gloomesh.solo.io/v1alpha2 APIs
type Clientset interface {
	// clienset for the certificates.gloomesh.solo.io/v1alpha2/v1alpha2 APIs
