...
type IssuedCertificateReconciler interface {
	ReconcileIssuedCertificate(obj *certificates_gloomesh_solo_io_v1alpha2.IssuedCertificate) (reconcile.Result, error)
}
...
type IssuedCertificateReconcilerFuncs struct {
	OnReconcileIssuedCertificate         func(obj *certificates_gloomesh_solo_io_v1alpha2.IssuedCertificate) (reconcile.Result, error)
	OnReconcileIssuedCertificateDeletion func(req reconcile.Request) error
}

func (f *IssuedCertificateReconcilerFuncs) ReconcileIssuedCertificate(obj *certificates_gloomesh_solo_io_v1alpha2.IssuedCertificate) (reconcile.Result, error) {
...
type IssuedCertificateFinalizer interface {
	...
	FinalizeIssuedCertificate(obj *certificates_gloomesh_solo_io_v1alpha2.IssuedCertificate) error
}
...
func NewIssuedCertificateReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) IssuedCertificateReconcileLoop {
	return &issuedCertificateReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &certificates_gloomesh_solo_io_v1alpha2.IssuedCertificate{}, options),
	}
}
...
type CertificateRequestReconciler interface {
	ReconcileCertificateRequest(obj *certificates_gloomesh_solo_io_v1alpha2.CertificateRequest) (reconcile.Result, error)
}
...
type CertificateRequestReconcilerFuncs struct {
	OnReconcileCertificateRequest         func(obj *certificates_gloomesh_solo_io_v1alpha2.CertificateRequest) (reconcile.Result, error)
	OnReconcileCertificateRequestDeletion func(req reconcile.Request) error
}

func (f *CertificateRequestReconcilerFuncs) ReconcileCertificateRequest(obj *certificates_gloomesh_solo_io_v1alpha2.CertificateRequest) (reconcile.Result, error) {
...
type CertificateRequestFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeCertificateRequest(obj *certificates_gloomesh_solo_io_v1alpha2.CertificateRequest) error
}
...
func NewCertificateRequestReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) CertificateRequestReconcileLoop {
	return &certificateRequestReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &certificates_gloomesh_solo_io_v1alpha2.CertificateRequest{}, options),
	}
}
...
type PodBounceDirectiveReconciler interface {
	ReconcilePodBounceDirective(obj *certificates_gloomesh_solo_io_v1alpha2.PodBounceDirective) (reconcile.Result, error)
}
...
type PodBounceDirectiveReconcilerFuncs struct {
	OnReconcilePodBounceDirective         func(obj *certificates_gloomesh_solo_io_v1alpha2.PodBounceDirective) (reconcile.Result, error)
	OnReconcilePodBounceDirectiveDeletion func(req reconcile.Request) error
}

func (f *PodBounceDirectiveReconcilerFuncs) ReconcilePodBounceDirective(obj *certificates_gloomesh_solo_io_v1alpha2.PodBounceDirective) (reconcile.Result, error) {
...
type PodBounceDirectiveFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizePodBounceDirective(obj *certificates_gloomesh_solo_io_v1alpha2.PodBounceDirective) error
}
...
func NewPodBounceDirectiveReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) PodBounceDirectiveReconcileLoop {
	return &podBounceDirectiveReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &certificates_gloomesh_solo_io_v1alpha2.PodBounceDirective{}, options),
	}
}
