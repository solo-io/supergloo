...
func partitionCertificateRequestsByLabel(labelKey string, set certificates_gloomesh_solo_io_v1alpha2_sets.CertificateRequestSet) ([]LabeledCertificateRequestSet, error) {
	setsByLabel := map[string]certificates_gloomesh_solo_io_v1alpha2_sets.CertificateRequestSet{}
	...
	for _, obj := range set.List() {
		...
		if !ok {
			setForValue = certificates_gloomesh_solo_io_v1alpha2_sets.NewCertificateRequestSet()
...
func (s snapshot) MarshalJSON() ([]byte, error) {
	...
	certificateRequestSet := certificates_gloomesh_solo_io_v1alpha2_sets.NewCertificateRequestSet()
...
type LabeledCertificateRequestSet interface {
	...
	Set() certificates_gloomesh_solo_io_v1alpha2_sets.CertificateRequestSet
...
func NewLabeledCertificateRequestSet(set certificates_gloomesh_solo_io_v1alpha2_sets.CertificateRequestSet, labels map[string]string) (LabeledCertificateRequestSet, error) {
...
func (l *labeledCertificateRequestSet) Set() certificates_gloomesh_solo_io_v1alpha2_sets.CertificateRequestSet {
	return l.set
}
...
func (l labeledCertificateRequestSet) Generic() output.ResourceList {
	...
	listFunc := func(ctx context.Context, cli client.Client) ([]ezkube.Object, error) {
		var list certificates_gloomesh_solo_io_v1alpha2.CertificateRequestList
...
type Builder interface {
	...
	AddCertificateRequests(certificateRequests ...*certificates_gloomesh_solo_io_v1alpha2.CertificateRequest)

	// get the collected CertificateRequests
	GetCertificateRequests() certificates_gloomesh_solo_io_v1alpha2_sets.CertificateRequestSet
...
func (b *builder) AddCertificateRequests(certificateRequests ...*certificates_gloomesh_solo_io_v1alpha2.CertificateRequest) {
...
func (b *builder) GetCertificateRequests() certificates_gloomesh_solo_io_v1alpha2_sets.CertificateRequestSet {
