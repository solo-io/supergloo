...
import (
	...
	certificates_gloomesh_solo_io_v1alpha2_sets "github.com/solo-io/gloo-mesh/pkg/api/certificates.gloomesh.solo.io/v1alpha2/sets"
...
type Snapshot interface {
	...
	IssuedCertificates() certificates_gloomesh_solo_io_v1alpha2_sets.IssuedCertificateSet
	// return the set of input CertificateRequests
	CertificateRequests() certificates_gloomesh_solo_io_v1alpha2_sets.CertificateRequestSet
	// return the set of input PodBounceDirectives
	PodBounceDirectives() certificates_gloomesh_solo_io_v1alpha2_sets.PodBounceDirectiveSet
...
func (s snapshot) IssuedCertificates() certificates_gloomesh_solo_io_v1alpha2_sets.IssuedCertificateSet {
	return s.issuedCertificates
}

func (s snapshot) CertificateRequests() certificates_gloomesh_solo_io_v1alpha2_sets.CertificateRequestSet {
	return s.certificateRequests
}

func (s snapshot) PodBounceDirectives() certificates_gloomesh_solo_io_v1alpha2_sets.PodBounceDirectiveSet {
...
func (b *multiClusterBuilder) BuildSnapshot(ctx context.Context, name string, opts BuildOptions) (Snapshot, error) {
	...
	issuedCertificates := certificates_gloomesh_solo_io_v1alpha2_sets.NewIssuedCertificateSet()
	certificateRequests := certificates_gloomesh_solo_io_v1alpha2_sets.NewCertificateRequestSet()
	podBounceDirectives := certificates_gloomesh_solo_io_v1alpha2_sets.NewPodBounceDirectiveSet()
...
func (b *multiClusterBuilder) insertIssuedCertificatesFromCluster(ctx context.Context, cluster string, issuedCertificates certificates_gloomesh_solo_io_v1alpha2_sets.IssuedCertificateSet, opts ResourceBuildOptions) error {
	issuedCertificateClient, err := certificates_gloomesh_solo_io_v1alpha2.NewMulticlusterIssuedCertificateClient(b.client).Cluster(cluster)
	if err != nil {
		return err
	}
	...
	if opts.Verifier != nil {
		...
		gvk := schema.GroupVersionKind{
			Group:   "certificates.gloomesh.solo.io",
			Version: "v1alpha2",
...
func (b *multiClusterBuilder) insertCertificateRequestsFromCluster(ctx context.Context, cluster string, certificateRequests certificates_gloomesh_solo_io_v1alpha2_sets.CertificateRequestSet, opts ResourceBuildOptions) error {
	certificateRequestClient, err := certificates_gloomesh_solo_io_v1alpha2.NewMulticlusterCertificateRequestClient(b.client).Cluster(cluster)
	if err != nil {
		return err
	}
...
func (b *multiClusterBuilder) insertPodBounceDirectivesFromCluster(ctx context.Context, cluster string, podBounceDirectives certificates_gloomesh_solo_io_v1alpha2_sets.PodBounceDirectiveSet, opts ResourceBuildOptions) error {
	podBounceDirectiveClient, err := certificates_gloomesh_solo_io_v1alpha2.NewMulticlusterPodBounceDirectiveClient(b.client).Cluster(cluster)
	if err != nil {
		return err
	}
...
func (b *singleClusterBuilder) insertIssuedCertificates(ctx context.Context, issuedCertificates certificates_gloomesh_solo_io_v1alpha2_sets.IssuedCertificateSet, opts ResourceBuildOptions) error {
	...
	issuedCertificateList, err := certificates_gloomesh_solo_io_v1alpha2.NewIssuedCertificateClient(b.mgr.GetClient()).ListIssuedCertificate(ctx, opts.ListOptions...)
	if err != nil {
		return err
	}
...
func (b *singleClusterBuilder) insertCertificateRequests(ctx context.Context, certificateRequests certificates_gloomesh_solo_io_v1alpha2_sets.CertificateRequestSet, opts ResourceBuildOptions) error {
	...
	certificateRequestList, err := certificates_gloomesh_solo_io_v1alpha2.NewCertificateRequestClient(b.mgr.GetClient()).ListCertificateRequest(ctx, opts.ListOptions...)
	if err != nil {
		return err
	}
...
func (b *singleClusterBuilder) insertPodBounceDirectives(ctx context.Context, podBounceDirectives certificates_gloomesh_solo_io_v1alpha2_sets.PodBounceDirectiveSet, opts ResourceBuildOptions) error {
	...
	podBounceDirectiveList, err := certificates_gloomesh_solo_io_v1alpha2.NewPodBounceDirectiveClient(b.mgr.GetClient()).ListPodBounceDirective(ctx, opts.ListOptions...)
	if err != nil {
		return err
	}
