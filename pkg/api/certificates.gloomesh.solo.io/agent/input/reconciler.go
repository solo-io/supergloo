...
import (
	...
	certificates_gloomesh_solo_io_v1alpha2_controllers "github.com/solo-io/gloo-mesh/pkg/api/certificates.gloomesh.solo.io/v1alpha2/controller"
...
type multiClusterReconciler interface {
	certificates_gloomesh_solo_io_v1alpha2_controllers.MulticlusterIssuedCertificateReconciler
	certificates_gloomesh_solo_io_v1alpha2_controllers.MulticlusterCertificateRequestReconciler
	certificates_gloomesh_solo_io_v1alpha2_controllers.MulticlusterPodBounceDirectiveReconciler
...
func RegisterMultiClusterReconciler(
	...
	certificates_gloomesh_solo_io_v1alpha2_controllers.NewMulticlusterIssuedCertificateReconcileLoop("IssuedCertificate", clusters, options.IssuedCertificates).AddMulticlusterIssuedCertificateReconciler(ctx, r, predicates...)

	certificates_gloomesh_solo_io_v1alpha2_controllers.NewMulticlusterCertificateRequestReconcileLoop("CertificateRequest", clusters, options.CertificateRequests).AddMulticlusterCertificateRequestReconciler(ctx, r, predicates...)

	certificates_gloomesh_solo_io_v1alpha2_controllers.NewMulticlusterPodBounceDirectiveReconcileLoop("PodBounceDirective", clusters, options.PodBounceDirectives).AddMulticlusterPodBounceDirectiveReconciler(ctx, r, predicates...)
...
func (r *multiClusterReconcilerImpl) ReconcileIssuedCertificate(clusterName string, obj *certificates_gloomesh_solo_io_v1alpha2.IssuedCertificate) (reconcile.Result, error) {
...
func (r *multiClusterReconcilerImpl) ReconcileCertificateRequest(clusterName string, obj *certificates_gloomesh_solo_io_v1alpha2.CertificateRequest) (reconcile.Result, error) {
	obj.ClusterName = clusterName
	return r.base.ReconcileClusterGeneric(obj)
}
...
func (r *multiClusterReconcilerImpl) ReconcilePodBounceDirective(clusterName string, obj *certificates_gloomesh_solo_io_v1alpha2.PodBounceDirective) (reconcile.Result, error) {
	obj.ClusterName = clusterName
	return r.base.ReconcileClusterGeneric(obj)
}
...
type singleClusterReconciler interface {
	certificates_gloomesh_solo_io_v1alpha2_controllers.IssuedCertificateReconciler
	certificates_gloomesh_solo_io_v1alpha2_controllers.CertificateRequestReconciler
	certificates_gloomesh_solo_io_v1alpha2_controllers.PodBounceDirectiveReconciler
...
func RegisterSingleClusterReconciler(
	...
	if err := certificates_gloomesh_solo_io_v1alpha2_controllers.NewIssuedCertificateReconcileLoop("IssuedCertificate", mgr, options).RunIssuedCertificateReconciler(ctx, r, predicates...); err != nil {
		return nil, err
	}
	if err := certificates_gloomesh_solo_io_v1alpha2_controllers.NewCertificateRequestReconcileLoop("CertificateRequest", mgr, options).RunCertificateRequestReconciler(ctx, r, predicates...); err != nil {
		return nil, err
	}
	if err := certificates_gloomesh_solo_io_v1alpha2_controllers.NewPodBounceDirectiveReconcileLoop("PodBounceDirective", mgr, options).RunPodBounceDirectiveReconciler(ctx, r, predicates...); err != nil {
		return nil, err
	}
...
func (r *singleClusterReconcilerImpl) ReconcileIssuedCertificate(obj *certificates_gloomesh_solo_io_v1alpha2.IssuedCertificate) (reconcile.Result, error) {
...
func (r *singleClusterReconcilerImpl) ReconcileCertificateRequest(obj *certificates_gloomesh_solo_io_v1alpha2.CertificateRequest) (reconcile.Result, error) {
	return r.base.ReconcileGeneric(obj)
}
...
func (r *singleClusterReconcilerImpl) ReconcilePodBounceDirective(obj *certificates_gloomesh_solo_io_v1alpha2.PodBounceDirective) (reconcile.Result, error) {
	return r.base.ReconcileGeneric(obj)
}
