...
func GetSubLocality(clusterName string, nodeName string, allNodes corev1sets.NodeSet) (*v1alpha2.TrafficTargetSpec_KubeService_EndpointsSubset_SubLocality, error) {
	node, err := allNodes.Find(&skv1.ClusterObjectRef{
