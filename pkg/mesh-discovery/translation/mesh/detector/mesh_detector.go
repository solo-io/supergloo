...
type MeshDetector interface {
	DetectMeshes(in input.RemoteSnapshot, settings *settingsv1alpha2.Settings) (v1alpha2.MeshSlice, error)
}
...
func (d MeshDetectors) DetectMeshes(in input.RemoteSnapshot, settings *settingsv1alpha2.Settings) (v1alpha2.MeshSlice, error) {
