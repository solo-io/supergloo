...
func (m *MockTranslator) TranslateTrafficTargets(ctx context.Context, services v1sets.ServiceSet, workloads v1alpha2sets.WorkloadSet, meshes v1alpha2sets.MeshSet) v1alpha2sets.TrafficTargetSet {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TranslateTrafficTargets", ctx, services, workloads, meshes)
	ret0, _ := ret[0].(v1alpha2sets.TrafficTargetSet)
	return ret0
}

// TranslateTrafficTargets indicates an expected call of TranslateTrafficTargets
func (mr *MockTranslatorMockRecorder) TranslateTrafficTargets(ctx, services, workloads, meshes interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TranslateTrafficTargets", reflect.TypeOf((*MockTranslator)(nil).TranslateTrafficTargets), ctx, services, workloads, meshes)
}
