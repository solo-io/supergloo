...
//go:generate mockgen -package mock_zephyr_core -destination ./test/mocks/zephyr/core/mock_mesh_workload_controller.go github.com/solo-io/mesh-projects/pkg/api/discovery.zephyr.solo.io/v1alpha1/controller MeshWorkloadController
